use crate::abi::opaque::{_xmlBuf, _xmlDict, _xmlLink, _xmlList};
...
extern "C" {
    ...
    fn xmlGetCompressMode() -> ::core::ffi::c_int;
    fn __xmlRaiseError(
    ...
    fn xmlListInsert(l: xmlListPtr, data: *mut ::core::ffi::c_void) -> ::core::ffi::c_int;
    ...
    fn xmlOutputBufferFlush(out: xmlOutputBufferPtr) -> ::core::ffi::c_int;
    fn xmlOutputBufferClose(out: xmlOutputBufferPtr) -> ::core::ffi::c_int;
    ...
    fn xmlXPathNodeSetContains(cur: xmlNodeSetPtr, val: xmlNodePtr) -> ::core::ffi::c_int;
...
pub type xmlC14NMode = ::core::ffi::c_uint;
...
pub type xmlC14NIsVisibleCallback = Option<
    unsafe extern "C" fn(*mut ::core::ffi::c_void, xmlNodePtr, xmlNodePtr) -> ::core::ffi::c_int,
>;
...
pub struct _xmlC14NCtx {
    ...
    pub with_comments: ::core::ffi::c_int,
    pub buf: xmlOutputBufferPtr,
    pub pos: xmlC14NPosition,
    pub parent_is_doc: ::core::ffi::c_int,
...
pub struct _xmlC14NVisibleNsStack {
    pub nsCurEnd: ::core::ffi::c_int,
    pub nsPrevStart: ::core::ffi::c_int,
    pub nsPrevEnd: ::core::ffi::c_int,
    pub nsMax: ::core::ffi::c_int,
    pub nsTab: *mut xmlNsPtr,
    pub nodeTab: *mut xmlNodePtr,
}
pub type xmlC14NPosition = ::core::ffi::c_uint;
...
pub type xmlC14NNormalizationMode = ::core::ffi::c_uint;
...
unsafe extern "C" fn xmlC14NErrMemory(mut extra: *const ::core::ffi::c_char) {
    __xmlRaiseError(
        None,
        None,
        NULL,
        NULL,
        NULL,
        XML_FROM_C14N as ::core::ffi::c_int,
...
unsafe extern "C" fn xmlC14NErrParam(mut extra: *const ::core::ffi::c_char) {
    __xmlRaiseError(
        None,
        None,
        NULL,
...
unsafe extern "C" fn xmlC14NErrInternal(mut extra: *const ::core::ffi::c_char) {
    __xmlRaiseError(
        None,
        None,
        NULL,
...
unsafe extern "C" fn xmlC14NErrInvalidNode(
    mut node_type: *const ::core::ffi::c_char,
    ...
    __xmlRaiseError(
        ...
        NULL,
        XML_FROM_C14N as ::core::ffi::c_int,
        XML_C14N_INVALID_NODE as ::core::ffi::c_int,
        XML_ERR_ERROR,
        ::core::ptr::null::<::core::ffi::c_char>(),
        0 as ::core::ffi::c_int,
        extra,
...
unsafe extern "C" fn xmlC14NErrUnknownNode(
    ...
    __xmlRaiseError(
        ...
        NULL,
        XML_FROM_C14N as ::core::ffi::c_int,
        XML_C14N_UNKNOW_NODE as ::core::ffi::c_int,
        XML_ERR_ERROR,
        ::core::ptr::null::<::core::ffi::c_char>(),
        0 as ::core::ffi::c_int,
        extra,
...
unsafe extern "C" fn xmlC14NErrRelativeNamespace(mut ns_uri: *const ::core::ffi::c_char) {
    __xmlRaiseError(
        None,
        None,
        NULL,
        ...
        NULL,
        XML_FROM_C14N as ::core::ffi::c_int,
        XML_C14N_RELATIVE_NAMESPACE as ::core::ffi::c_int,
        XML_ERR_ERROR,
        ::core::ptr::null::<::core::ffi::c_char>(),
        0 as ::core::ffi::c_int,
        ::core::ptr::null::<::core::ffi::c_char>(),
...
pub const XML_NAMESPACES_DEFAULT: ::core::ffi::c_int = 16 as ::core::ffi::c_int;
unsafe extern "C" fn xmlC14NIsNodeInNodeset(
    ...
    if !nodes.is_null() && !node.is_null() {
            ...
            != XML_NAMESPACE_DECL as ::core::ffi::c_int as ::core::ffi::c_uint
        {
            ...
            memcpy(
                &raw mut ns as *mut ::core::ffi::c_void,
...
unsafe extern "C" fn xmlC14NVisibleNsStackCreate() -> xmlC14NVisibleNsStackPtr {
    ...
    if ret.is_null() {
        xmlC14NErrMemory(b"creating namespaces stack\0" as *const u8 as *const ::core::ffi::c_char);
        return ::core::ptr::null_mut::<_xmlC14NVisibleNsStack>();
    }
    memset(
        ret as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<xmlC14NVisibleNsStack>(),
    );
    return ret;
}
unsafe extern "C" fn xmlC14NVisibleNsStackDestroy(mut cur: xmlC14NVisibleNsStackPtr) {
    if cur.is_null() {
        xmlC14NErrParam(
            b"destroying namespaces stack\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return;
    }
    if !(*cur).nsTab.is_null() {
        memset(
            (*cur).nsTab as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ((*cur).nsMax as size_t).wrapping_mul(::core::mem::size_of::<xmlNsPtr>() as size_t),
        );
        xmlFree.expect("non-null function pointer")((*cur).nsTab as *mut ::core::ffi::c_void);
    }
...
unsafe extern "C" fn xmlC14NVisibleNsStackAdd(
    ...
    if cur.is_null()
        ...
        || !(*cur).nsTab.is_null() && (*cur).nodeTab.is_null()
    {
        xmlC14NErrParam(b"adding namespace to stack\0" as *const u8 as *const ::core::ffi::c_char);
        return;
    }
    if (*cur).nsTab.is_null() && (*cur).nodeTab.is_null() {
        ...
        if (*cur).nsTab.is_null() || (*cur).nodeTab.is_null() {
            xmlC14NErrMemory(b"adding node to stack\0" as *const u8 as *const ::core::ffi::c_char);
            return;
        }
        memset(
            (*cur).nsTab as *mut ::core::ffi::c_void,
        ...
        let mut tmpSize: ::core::ffi::c_int = 0;
        tmpSize = 2 as ::core::ffi::c_int * (*cur).nsMax;
...
unsafe extern "C" fn xmlC14NVisibleNsStackSave(
    ...
    if cur.is_null() || state.is_null() {
        xmlC14NErrParam(b"saving namespaces stack\0" as *const u8 as *const ::core::ffi::c_char);
        return;
    }
...
unsafe extern "C" fn xmlC14NVisibleNsStackRestore(
    ...
    if cur.is_null() || state.is_null() {
        xmlC14NErrParam(b"restoring namespaces stack\0" as *const u8 as *const ::core::ffi::c_char);
        return;
    }
...
unsafe extern "C" fn xmlC14NVisibleNsStackShift(mut cur: xmlC14NVisibleNsStackPtr) {
    if cur.is_null() {
        xmlC14NErrParam(b"shifting namespaces stack\0" as *const u8 as *const ::core::ffi::c_char);
        return;
    }
...
unsafe extern "C" fn xmlC14NStrEqual(
    ...
    if str1.is_null() {
        return (*str2 as ::core::ffi::c_int == '\0' as i32) as ::core::ffi::c_int;
    }
    if str2.is_null() {
        return (*str1 as ::core::ffi::c_int == '\0' as i32) as ::core::ffi::c_int;
    }
    loop {
        let fresh35 = str1;
        str1 = str1.offset(1);
        if *fresh35 as ::core::ffi::c_int != *str2 as ::core::ffi::c_int {
...
unsafe extern "C" fn xmlC14NVisibleNsStackFind(
    ...
    let mut has_empty_ns: ::core::ffi::c_int = 0;
    if cur.is_null() {
        xmlC14NErrParam(
            b"searching namespaces stack (c14n)\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return 0 as ::core::ffi::c_int;
    }
    prefix = if ns.is_null() || (*ns).prefix.is_null() {
        b"\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar as *const xmlChar
    } else {
        (*ns).prefix
    };
    ...
    has_empty_ns = (xmlC14NStrEqual(prefix, ::core::ptr::null::<xmlChar>()) != 0
        ...
        as ::core::ffi::c_int;
    if !(*cur).nsTab.is_null() {
        let mut start: ::core::ffi::c_int = if has_empty_ns != 0 {
            0 as ::core::ffi::c_int
        } else {
            (*cur).nsPrevStart
        };
        i = (*cur).nsCurEnd - 1 as ::core::ffi::c_int;
        while i >= start {
...
unsafe extern "C" fn xmlExcC14NVisibleNsStackFind(
    ...
    if cur.is_null() {
        xmlC14NErrParam(
            b"searching namespaces stack (exc c14n)\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return 0 as ::core::ffi::c_int;
    }
    prefix = if ns.is_null() || (*ns).prefix.is_null() {
...
unsafe extern "C" fn xmlC14NIsXmlNs(mut ns: xmlNsPtr) -> ::core::ffi::c_int {
    return (!ns.is_null()
        && xmlStrEqual(
            (*ns).prefix,
            b"xml\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
        ) != 0
        && xmlStrEqual((*ns).href, XML_XML_NAMESPACE) != 0) as ::core::ffi::c_int;
}
...
unsafe extern "C" fn xmlC14NPrintNamespaces(
    ...
    if ns.is_null() || ctx.is_null() {
        xmlC14NErrParam(b"writing namespaces\0" as *const u8 as *const ::core::ffi::c_char);
        return 0 as ::core::ffi::c_int;
    }
    if !(*ns).prefix.is_null() {
        ...
        xmlOutputBufferWriteString((*ctx).buf, (*ns).prefix as *const ::core::ffi::c_char);
        xmlOutputBufferWriteString(
            (*ctx).buf,
...
unsafe extern "C" fn xmlC14NProcessNamespacesAxis(
    ...
    let mut already_rendered: ::core::ffi::c_int = 0;
    let mut has_empty_ns: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    if ctx.is_null()
        || cur.is_null()
    ...
    {
        xmlC14NErrParam(
            b"processing namespaces axis (c14n)\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int);
    }
    list = xmlListCreate(
    ...
    if list.is_null() {
        xmlC14NErrInternal(
            b"creating namespaces list (c14n)\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int);
    }
    n = cur;
        ...
        while !ns.is_null() {
                ...
                }) != 0
            {
                ...
                if already_rendered == 0 {
                    xmlListInsert(list, ns as *mut ::core::ffi::c_void);
                }
                if xmlStrlen((*ns).prefix) == 0 as ::core::ffi::c_int {
                    has_empty_ns = 1 as ::core::ffi::c_int;
                }
            }
    ...
    if visible != 0 && has_empty_ns == 0 {
        ...
        memset(
            &raw mut ns_default as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<xmlNs>() as size_t,
        );
...
unsafe extern "C" fn xmlExcC14NProcessNamespacesAxis(
    ...
    let mut already_rendered: ::core::ffi::c_int = 0;
    let mut has_empty_ns: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut has_visibly_utilized_empty_ns: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut has_empty_ns_in_inclusive_list: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    if ctx.is_null()
        || cur.is_null()
        || (*cur).type_0 as ::core::ffi::c_uint
            != XML_ELEMENT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        xmlC14NErrParam(
            b"processing namespaces axis (exc c14n)\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int);
    }
    if !((*ctx).mode as ::core::ffi::c_uint
        == XML_C14N_EXCLUSIVE_1_0 as ::core::ffi::c_int as ::core::ffi::c_uint)
    {
        xmlC14NErrParam(
            b"processing namespaces axis (exc c14n)\0" as *const u8 as *const ::core::ffi::c_char,
        );
    ...
    if list.is_null() {
        xmlC14NErrInternal(
            b"creating namespaces list (exc c14n)\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int);
    }
    if !(*ctx).inclusive_ns_prefixes.is_null() {
        ...
        while !(*(*ctx).inclusive_ns_prefixes.offset(i as isize)).is_null() {
                ...
                ) != 0
            {
                ...
                has_empty_ns_in_inclusive_list = 1 as ::core::ffi::c_int;
            }
    ...
    if !(*cur).ns.is_null() {
        ...
        has_visibly_utilized_empty_ns = 1 as ::core::ffi::c_int;
    }
    ...
    while !attr.is_null() {
            ...
            }) != 0
        {
            ...
            if already_rendered == 0 && visible != 0 {
                xmlListInsert(list, (*attr).ns as *mut ::core::ffi::c_void);
            }
            if xmlStrlen((*(*attr).ns).prefix) == 0 as ::core::ffi::c_int {
                has_empty_ns = 1 as ::core::ffi::c_int;
            }
        } else if !(*attr).ns.is_null()
            && xmlStrlen((*(*attr).ns).prefix) == 0 as ::core::ffi::c_int
            && xmlStrlen((*(*attr).ns).href) == 0 as ::core::ffi::c_int
        {
            has_visibly_utilized_empty_ns = 1 as ::core::ffi::c_int;
        }
        ...
        && has_empty_ns_in_inclusive_list == 0
    {
        ...
        memset(
            &raw mut ns_default_0 as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<xmlNs>() as size_t,
        );
...
unsafe extern "C" fn xmlC14NIsXmlAttr(mut attr: xmlAttrPtr) -> ::core::ffi::c_int {
    return (!(*attr).ns.is_null()
        && xmlC14NIsXmlNs((*attr).ns as xmlNsPtr) != 0 as ::core::ffi::c_int)
        as ::core::ffi::c_int;
}
...
unsafe extern "C" fn xmlC14NPrintAttrs(
    ...
    if attr.is_null() || ctx.is_null() {
        xmlC14NErrParam(b"writing attributes\0" as *const u8 as *const ::core::ffi::c_char);
        return 0 as ::core::ffi::c_int;
    }
    xmlOutputBufferWriteString(
        (*ctx).buf,
    ...
    if !(*attr).ns.is_null() && xmlStrlen((*(*attr).ns).prefix) > 0 as ::core::ffi::c_int {
        xmlOutputBufferWriteString(
            (*ctx).buf,
            (*(*attr).ns).prefix as *const ::core::ffi::c_char,
        );
        xmlOutputBufferWriteString(
            (*ctx).buf,
            b":\0" as *const u8 as *const ::core::ffi::c_char,
    ...
    xmlOutputBufferWriteString((*ctx).buf, (*attr).name as *const ::core::ffi::c_char);
    xmlOutputBufferWriteString(
        (*ctx).buf,
        b"=\"\0" as *const u8 as *const ::core::ffi::c_char,
    );
    value = xmlNodeListGetString((*ctx).doc, (*attr).children, 1 as ::core::ffi::c_int);
    if !value.is_null() {
        ...
        if !buffer.is_null() {
            xmlOutputBufferWriteString((*ctx).buf, buffer as *const ::core::ffi::c_char);
            xmlFree.expect("non-null function pointer")(buffer as *mut ::core::ffi::c_void);
        } else {
            xmlC14NErrInternal(
                b"normalizing attributes axis\0" as *const u8 as *const ::core::ffi::c_char,
            );
            return 0 as ::core::ffi::c_int;
        }
    }
...
unsafe extern "C" fn xmlC14NFixupBaseAttr(
    ...
    let mut tmp_str_len: ::core::ffi::c_int = 0;
    if ctx.is_null() || xml_base_attr.is_null() || (*xml_base_attr).parent.is_null() {
        xmlC14NErrParam(
            b"processing xml:base attribute\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return ::core::ptr::null_mut::<xmlAttr>();
    }
        ...
        }) == 0
    {
        ...
        if !attr.is_null() {
            tmp_str = xmlNodeListGetString((*ctx).doc, (*attr).children, 1 as ::core::ffi::c_int);
            if tmp_str.is_null() {
                xmlFree.expect("non-null function pointer")(res as *mut ::core::ffi::c_void);
                xmlC14NErrInternal(
                    b"processing xml:base attribute - can't get attr value\0" as *const u8
                        as *const ::core::ffi::c_char,
                );
            ...
            if tmp_str_len > 1 as ::core::ffi::c_int
                && *tmp_str.offset((tmp_str_len - 2 as ::core::ffi::c_int) as isize)
                    as ::core::ffi::c_int
                    == '.' as i32
            {
                tmp_str2 = xmlStrcat(
                ...
                if tmp_str2.is_null() {
                    xmlFree.expect("non-null function pointer")(
                        tmp_str as *mut ::core::ffi::c_void,
                    );
                    xmlFree.expect("non-null function pointer")(res as *mut ::core::ffi::c_void);
                    xmlC14NErrInternal(
            ...
            if tmp_str2.is_null() {
                xmlFree.expect("non-null function pointer")(tmp_str as *mut ::core::ffi::c_void);
                xmlFree.expect("non-null function pointer")(res as *mut ::core::ffi::c_void);
                xmlC14NErrInternal(
...
unsafe extern "C" fn xmlC14NProcessAttrsAxis(
    mut ctx: xmlC14NCtxPtr,
    mut cur: xmlNodePtr,
    mut parent_visible: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    let mut attr: xmlAttrPtr = ::core::ptr::null_mut::<xmlAttr>();
    let mut list: xmlListPtr = ::core::ptr::null_mut::<xmlList>();
    ...
    if ctx.is_null()
        ...
        || (*cur).type_0 as ::core::ffi::c_uint
            != XML_ELEMENT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        xmlC14NErrParam(b"processing attributes axis\0" as *const u8 as *const ::core::ffi::c_char);
        return -(1 as ::core::ffi::c_int);
    }
    list = xmlListCreate(
        None,
    ...
    if list.is_null() {
        xmlC14NErrInternal(
            b"creating attributes list\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int);
    }
    match (*ctx).mode as ::core::ffi::c_uint {
        0 => {
            attr = (*cur).properties as xmlAttrPtr;
            while !attr.is_null() {
                ...
                {
                    xmlListInsert(list, attr as *mut ::core::ffi::c_void);
                }
                attr = (*attr).next as xmlAttrPtr;
            }
            if parent_visible != 0
                ...
                }) == 0
            {
                ...
                while !tmp.is_null() {
                    ...
                    while !attr.is_null() {
                        if xmlC14NIsXmlAttr(attr) != 0 as ::core::ffi::c_int {
                            if xmlListSearch(list, attr as *mut ::core::ffi::c_void).is_null() {
                                xmlListInsert(list, attr as *mut ::core::ffi::c_void);
                            }
                        }
                        attr = (*attr).next as xmlAttrPtr;
        ...
        2 => {
            attr = (*cur).properties as xmlAttrPtr;
            while !attr.is_null() {
                if parent_visible == 0 || xmlC14NIsXmlAttr(attr) == 0 as ::core::ffi::c_int {
                    if if (*ctx).is_visible_callback.is_some() {
                        (*ctx)
                            .is_visible_callback
                            .expect("non-null function pointer")(
            ...
            if parent_visible != 0 {
                ...
                if !xml_lang_attr.is_null() {
                    xmlListInsert(list, xml_lang_attr as *mut ::core::ffi::c_void);
                }
                ...
                if !xml_space_attr.is_null() {
                    xmlListInsert(list, xml_space_attr as *mut ::core::ffi::c_void);
                }
                ...
                if !xml_base_attr.is_null() {
                    ...
                    if !xml_base_attr.is_null() {
                        xmlListInsert(list, xml_base_attr as *mut ::core::ffi::c_void);
...
unsafe extern "C" fn xmlC14NCheckForRelativeNamespaces(
    ...
    {
        xmlC14NErrParam(
            b"checking for relative namespaces\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int);
    }
    ns = (*cur).nsDef as xmlNsPtr;
    while !ns.is_null() {
        if xmlStrlen((*ns).href) > 0 as ::core::ffi::c_int {
            let mut uri: xmlURIPtr = ::core::ptr::null_mut::<xmlURI>();
            uri = xmlParseURI((*ns).href as *const ::core::ffi::c_char);
            if uri.is_null() {
                xmlC14NErrInternal(
                    b"parsing namespace uri\0" as *const u8 as *const ::core::ffi::c_char,
                );
                return -(1 as ::core::ffi::c_int);
            }
            if xmlStrlen((*uri).scheme as *const xmlChar) == 0 as ::core::ffi::c_int {
...
unsafe extern "C" fn xmlC14NProcessElementNode(
    ...
    let mut parent_is_doc: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    if ctx.is_null()
        || cur.is_null()
        || (*cur).type_0 as ::core::ffi::c_uint
            != XML_ELEMENT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        xmlC14NErrParam(b"processing element node\0" as *const u8 as *const ::core::ffi::c_char);
        return -(1 as ::core::ffi::c_int);
    }
    if xmlC14NCheckForRelativeNamespaces(ctx, cur) < 0 as ::core::ffi::c_int {
        xmlC14NErrInternal(
            b"checking for relative namespaces\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int);
    ...
    if visible != 0 {
        if (*ctx).parent_is_doc != 0 {
            ...
            (*ctx).parent_is_doc = 0 as ::core::ffi::c_int;
        ...
        if !(*cur).ns.is_null() && xmlStrlen((*(*cur).ns).prefix) > 0 as ::core::ffi::c_int {
            xmlOutputBufferWriteString(
                (*ctx).buf,
        ...
        xmlOutputBufferWriteString((*ctx).buf, (*cur).name as *const ::core::ffi::c_char);
    }
    if !((*ctx).mode as ::core::ffi::c_uint
        == XML_C14N_EXCLUSIVE_1_0 as ::core::ffi::c_int as ::core::ffi::c_uint)
    {
    ...
    if ret < 0 as ::core::ffi::c_int {
        xmlC14NErrInternal(
            b"processing namespaces axis\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int);
    }
    if visible != 0 {
    ...
    if ret < 0 as ::core::ffi::c_int {
        xmlC14NErrInternal(
            b"processing attributes axis\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int);
    }
    if visible != 0 {
    ...
    if !(*cur).children.is_null() {
        ...
        if ret < 0 as ::core::ffi::c_int {
            xmlC14NErrInternal(
                b"processing childrens list\0" as *const u8 as *const ::core::ffi::c_char,
            );
            return -(1 as ::core::ffi::c_int);
        }
    }
...
unsafe extern "C" fn xmlC14NProcessNode(
    ...
    if ctx.is_null() || cur.is_null() {
        xmlC14NErrParam(b"processing node\0" as *const u8 as *const ::core::ffi::c_char);
        return -(1 as ::core::ffi::c_int);
    }
    ...
    match (*cur).type_0 as ::core::ffi::c_uint {
        ...
        4 | 3 => {
            if visible != 0 && !(*cur).content.is_null() {
                ...
                if !buffer.is_null() {
                    ...
                    xmlC14NErrInternal(
                        b"normalizing text node\0" as *const u8 as *const ::core::ffi::c_char,
                    );
                    return -(1 as ::core::ffi::c_int);
                }
            }
        ...
        7 => {
            if visible != 0 {
                if (*ctx).pos as ::core::ffi::c_uint
                    == XMLC14N_AFTER_DOCUMENT_ELEMENT as ::core::ffi::c_int as ::core::ffi::c_uint
                {
                    xmlOutputBufferWriteString(
                        (*ctx).buf,
                        b"\n<?\0" as *const u8 as *const ::core::ffi::c_char,
                ...
                if !(*cur).content.is_null() && *(*cur).content as ::core::ffi::c_int != '\0' as i32
                {
                    ...
                    if !buffer_0.is_null() {
                        xmlOutputBufferWriteString(
                            (*ctx).buf,
                            buffer_0 as *const ::core::ffi::c_char,
                        );
                        xmlFree.expect("non-null function pointer")(
                        ...
                        xmlC14NErrInternal(
                            b"normalizing pi node\0" as *const u8 as *const ::core::ffi::c_char,
                        );
                        return -(1 as ::core::ffi::c_int);
                    }
                }
                if (*ctx).pos as ::core::ffi::c_uint
                    == XMLC14N_BEFORE_DOCUMENT_ELEMENT as ::core::ffi::c_int as ::core::ffi::c_uint
                {
                    xmlOutputBufferWriteString(
                        (*ctx).buf,
                        b"?>\n\0" as *const u8 as *const ::core::ffi::c_char,
            ...
            if visible != 0 && (*ctx).with_comments != 0 {
                ...
                if !(*cur).content.is_null() {
                    ...
                    if !buffer_1.is_null() {
                        xmlOutputBufferWriteString(
                            (*ctx).buf,
                            buffer_1 as *const ::core::ffi::c_char,
                        );
                        xmlFree.expect("non-null function pointer")(
                            buffer_1 as *mut ::core::ffi::c_void,
                        );
                    } else {
                        xmlC14NErrInternal(
        ...
        9 | 11 | 21 | 13 => {
            if !(*cur).children.is_null() {
                ...
                (*ctx).parent_is_doc = 1 as ::core::ffi::c_int;
                ret = xmlC14NProcessNodeList(ctx, (*cur).children as xmlNodePtr);
            }
        }
        2 => {
            xmlC14NErrInvalidNode(
                b"XML_ATTRIBUTE_NODE\0" as *const u8 as *const ::core::ffi::c_char,
                b"processing node\0" as *const u8 as *const ::core::ffi::c_char,
            );
            return -(1 as ::core::ffi::c_int);
        }
        18 => {
            xmlC14NErrInvalidNode(
                b"XML_NAMESPACE_DECL\0" as *const u8 as *const ::core::ffi::c_char,
                b"processing node\0" as *const u8 as *const ::core::ffi::c_char,
            );
            return -(1 as ::core::ffi::c_int);
        }
        5 => {
            xmlC14NErrInvalidNode(
                b"XML_ENTITY_REF_NODE\0" as *const u8 as *const ::core::ffi::c_char,
                b"processing node\0" as *const u8 as *const ::core::ffi::c_char,
            );
            return -(1 as ::core::ffi::c_int);
        }
        6 => {
            xmlC14NErrInvalidNode(
                b"XML_ENTITY_NODE\0" as *const u8 as *const ::core::ffi::c_char,
                b"processing node\0" as *const u8 as *const ::core::ffi::c_char,
            );
            return -(1 as ::core::ffi::c_int);
        }
...
unsafe extern "C" fn xmlC14NProcessNodeList(
    ...
    let mut ret: ::core::ffi::c_int = 0;
    if ctx.is_null() {
        xmlC14NErrParam(b"processing node list\0" as *const u8 as *const ::core::ffi::c_char);
        return -(1 as ::core::ffi::c_int);
    }
    ret = 0 as ::core::ffi::c_int;
    while !cur.is_null() && ret >= 0 as ::core::ffi::c_int {
...
unsafe extern "C" fn xmlC14NFreeCtx(mut ctx: xmlC14NCtxPtr) {
    if ctx.is_null() {
        xmlC14NErrParam(b"freeing context\0" as *const u8 as *const ::core::ffi::c_char);
        return;
    }
    if !(*ctx).ns_rendered.is_null() {
        xmlC14NVisibleNsStackDestroy((*ctx).ns_rendered);
    }
    xmlFree.expect("non-null function pointer")(ctx as *mut ::core::ffi::c_void);
}
unsafe extern "C" fn xmlC14NNewCtx(
    ...
    mut with_comments: ::core::ffi::c_int,
    mut buf: xmlOutputBufferPtr,
) -> xmlC14NCtxPtr {
    let mut ctx: xmlC14NCtxPtr = ::core::ptr::null_mut::<_xmlC14NCtx>();
    if doc.is_null() || buf.is_null() {
        xmlC14NErrParam(b"creating new context\0" as *const u8 as *const ::core::ffi::c_char);
    ...
    if !(*buf).encoder.is_null() {
        xmlC14NErr(
            ctx,
            doc as xmlNodePtr,
            XML_C14N_REQUIRES_UTF8 as ::core::ffi::c_int,
    ...
    if ctx.is_null() {
        xmlC14NErrMemory(b"creating context\0" as *const u8 as *const ::core::ffi::c_char);
        return ::core::ptr::null_mut::<_xmlC14NCtx>();
    }
    memset(
        ctx as *mut ::core::ffi::c_void,
    ...
    if (*ctx).ns_rendered.is_null() {
        xmlC14NErr(
            ctx,
            doc as xmlNodePtr,
            XML_C14N_CREATE_STACK as ::core::ffi::c_int,
...
pub unsafe extern "C" fn xmlC14NExecute(
    ...
    if buf.is_null() || doc.is_null() {
        xmlC14NErrParam(b"executing c14n\0" as *const u8 as *const ::core::ffi::c_char);
        return -(1 as ::core::ffi::c_int);
    }
    match mode {
        0 | 1 | 2 => {
        ...
        _ => {
            xmlC14NErrParam(
                b"invalid mode for executing c14n\0" as *const u8 as *const ::core::ffi::c_char,
            );
            return -(1 as ::core::ffi::c_int);
        }
    }
    ...
    if ctx.is_null() {
        xmlC14NErr(
            ::core::ptr::null_mut::<_xmlC14NCtx>(),
            doc as xmlNodePtr,
            XML_C14N_CREATE_CTXT as ::core::ffi::c_int,
    ...
    if !(*doc).children.is_null() {
        ...
        if ret < 0 as ::core::ffi::c_int {
            xmlC14NErrInternal(
                b"processing docs children list\0" as *const u8 as *const ::core::ffi::c_char,
            );
            xmlC14NFreeCtx(ctx);
            return -(1 as ::core::ffi::c_int);
        }
    ...
    if ret < 0 as ::core::ffi::c_int {
        xmlC14NErrInternal(b"flushing output buffer\0" as *const u8 as *const ::core::ffi::c_char);
        xmlC14NFreeCtx(ctx);
        return -(1 as ::core::ffi::c_int);
    }
    xmlC14NFreeCtx(ctx);
...
pub unsafe extern "C" fn xmlC14NDocDumpMemory(
    ...
    if doc_txt_ptr.is_null() {
        xmlC14NErrParam(b"dumping doc to memory\0" as *const u8 as *const ::core::ffi::c_char);
        return -(1 as ::core::ffi::c_int);
    }
    *doc_txt_ptr = ::core::ptr::null_mut::<xmlChar>();
    buf = xmlAllocOutputBuffer(::core::ptr::null_mut::<xmlCharEncodingHandler>());
    if buf.is_null() {
        xmlC14NErrMemory(b"creating output buffer\0" as *const u8 as *const ::core::ffi::c_char);
        return -(1 as ::core::ffi::c_int);
    }
    ret = xmlC14NDocSaveTo(doc, nodes, mode, inclusive_ns_prefixes, with_comments, buf);
    if ret < 0 as ::core::ffi::c_int {
        xmlC14NErrInternal(
            b"saving doc to output buffer\0" as *const u8 as *const ::core::ffi::c_char,
        );
        xmlOutputBufferClose(buf);
        return -(1 as ::core::ffi::c_int);
    }
    ret = xmlBufUse((*buf).buffer) as ::core::ffi::c_int;
    if ret >= 0 as ::core::ffi::c_int {
        *doc_txt_ptr = xmlStrndup(xmlBufContent((*buf).buffer as *const xmlBuf), ret);
    }
    xmlOutputBufferClose(buf);
    if (*doc_txt_ptr).is_null() && ret >= 0 as ::core::ffi::c_int {
        xmlC14NErrMemory(
            b"copying canonicalized document\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int);
    }
    return ret;
...
pub unsafe extern "C" fn xmlC14NDocSave(
    ...
    let mut ret: ::core::ffi::c_int = 0;
    if filename.is_null() {
        xmlC14NErrParam(b"saving doc\0" as *const u8 as *const ::core::ffi::c_char);
        return -(1 as ::core::ffi::c_int);
    }
    ...
    if buf.is_null() {
        xmlC14NErrInternal(
            b"creating temporary filename\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int);
    }
    ret = xmlC14NDocSaveTo(doc, nodes, mode, inclusive_ns_prefixes, with_comments, buf);
    if ret < 0 as ::core::ffi::c_int {
        xmlC14NErrInternal(
            b"canonize document to buffer\0" as *const u8 as *const ::core::ffi::c_char,
        );
        xmlOutputBufferClose(buf);
        return -(1 as ::core::ffi::c_int);
    }
...
unsafe extern "C" fn xmlC11NNormalizeString(
    ...
    buffer_size = 1000 as ::core::ffi::c_int;
    ...
    if buffer.is_null() {
        xmlC14NErrMemory(b"allocating buffer\0" as *const u8 as *const ::core::ffi::c_char);
        return ::core::ptr::null_mut::<xmlChar>();
    }
    out = buffer;
    while *cur as ::core::ffi::c_int != '\0' as i32 {
        if out.offset_from(buffer) as ::core::ffi::c_long
            > (buffer_size - 10 as ::core::ffi::c_int) as ::core::ffi::c_long
        {
            ...
            if buffer.is_null() {
                xmlC14NErrMemory(b"growing buffer\0" as *const u8 as *const ::core::ffi::c_char);
                return ::core::ptr::null_mut::<xmlChar>();
            }
        ...
        if *cur as ::core::ffi::c_int == '<' as i32
            && (mode as ::core::ffi::c_uint
                == XMLC14N_NORMALIZE_ATTR as ::core::ffi::c_int as ::core::ffi::c_uint
                || mode as ::core::ffi::c_uint
                    == XMLC14N_NORMALIZE_TEXT as ::core::ffi::c_int as ::core::ffi::c_uint)
        {
            let fresh0 = out;
            out = out.offset(1);
        ...
        } else if *cur as ::core::ffi::c_int == '\r' as i32
            && (mode as ::core::ffi::c_uint
                == XMLC14N_NORMALIZE_ATTR as ::core::ffi::c_int as ::core::ffi::c_uint
                || mode as ::core::ffi::c_uint
                    == XMLC14N_NORMALIZE_TEXT as ::core::ffi::c_int as ::core::ffi::c_uint
                || mode as ::core::ffi::c_uint
                    == XMLC14N_NORMALIZE_COMMENT as ::core::ffi::c_int as ::core::ffi::c_uint
                || mode as ::core::ffi::c_uint
                    == XMLC14N_NORMALIZE_PI as ::core::ffi::c_int as ::core::ffi::c_uint)
        {
            let fresh29 = out;
            out = out.offset(1);
