...
unsafe extern "C" fn xmlModuleErrMemory(
    ...
    if !module.is_null() {
        name = (*module).name as *const ::core::ffi::c_char;
    }
    __xmlRaiseError(
        None,
        None,
        ...
        NULL,
        NULL,
        XML_FROM_MODULE as ::core::ffi::c_int,
...
pub unsafe extern "C" fn xmlModuleOpen(
    ...
    let mut module: xmlModulePtr = ::core::ptr::null_mut::<xmlModule>();
    module = xmlMalloc.expect("non-null function pointer")(
        ::core::mem::size_of::<xmlModule>() as size_t
    ) as xmlModulePtr;
    if module.is_null() {
        xmlModuleErrMemory(
            ::core::ptr::null_mut::<xmlModule>(),
            b"creating module\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return ::core::ptr::null_mut::<xmlModule>();
    }
    memset(
        module as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<xmlModule>() as size_t,
    );
    (*module).handle = xmlModulePlatformOpen(name);
    if (*module).handle.is_null() {
        xmlFree.expect("non-null function pointer")(module as *mut ::core::ffi::c_void);
        __xmlRaiseError(
            None,
            None,
            NULL,
            ...
            NULL,
            XML_FROM_MODULE as ::core::ffi::c_int,
            XML_MODULE_OPEN as ::core::ffi::c_int,
            XML_ERR_FATAL,
            ::core::ptr::null::<::core::ffi::c_char>(),
            0 as ::core::ffi::c_int,
            ::core::ptr::null::<::core::ffi::c_char>(),
    ...
    (*module).name = xmlStrdup(name as *const xmlChar) as *mut ::core::ffi::c_uchar;
    return module;
}
#[no_mangle]
pub unsafe extern "C" fn xmlModuleSymbol(
    mut module: xmlModulePtr,
    mut name: *const ::core::ffi::c_char,
    mut symbol: *mut *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xmlModuleClose(mut module: xmlModulePtr) -> ::core::ffi::c_int {
    ...
    if module.is_null() {
        __xmlRaiseError(
            ...
            NULL,
            XML_FROM_MODULE as ::core::ffi::c_int,
            XML_MODULE_CLOSE as ::core::ffi::c_int,
            XML_ERR_FATAL,
            ::core::ptr::null::<::core::ffi::c_char>(),
            0 as ::core::ffi::c_int,
            ::core::ptr::null::<::core::ffi::c_char>(),
    ...
    if rc != 0 as ::core::ffi::c_int {
        __xmlRaiseError(
            ...
            0 as ::core::ffi::c_int,
            ::core::ptr::null::<::core::ffi::c_char>(),
            (*module).name as *const ::core::ffi::c_char,
            ::core::ptr::null::<::core::ffi::c_char>(),
            0 as ::core::ffi::c_int,
            0 as ::core::ffi::c_int,
            b"failed to close: %s\n\0" as *const u8 as *const ::core::ffi::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn xmlModuleFree(mut module: xmlModulePtr) -> ::core::ffi::c_int {
    if module.is_null() {
        __xmlRaiseError(
            None,
            None,
    ...
    xmlFree.expect("non-null function pointer")((*module).name as *mut ::core::ffi::c_void);
    xmlFree.expect("non-null function pointer")(module as *mut ::core::ffi::c_void);
