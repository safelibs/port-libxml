...
extern "C" {
    ...
    fn xmlBufferShrink(buf: xmlBufferPtr, len: ::core::ffi::c_uint) -> ::core::ffi::c_int;
    fn xmlBufferGrow(buf: xmlBufferPtr, len: ::core::ffi::c_uint) -> ::core::ffi::c_int;
    fn __xmlRaiseError(
...
static mut xmlUTF16LEHandler: xmlCharEncodingHandlerPtr =
    ::core::ptr::null::<xmlCharEncodingHandler>() as *mut xmlCharEncodingHandler;
...
static mut xmlCharEncodingAliasesNb: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
static mut xmlCharEncodingAliasesMax: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
static mut xmlLittleEndian: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
unsafe extern "C" fn xmlEncodingErrMemory(mut extra: *const ::core::ffi::c_char) {
    __xmlSimpleError(
        XML_FROM_I18N as ::core::ffi::c_int,
...
unsafe extern "C" fn asciiToUTF8(
    ...
    let mut base: *const ::core::ffi::c_uchar = in_0;
    ...
    while in_0 < inend
        && (out.offset_from(outstart) as ::core::ffi::c_long + 5 as ::core::ffi::c_long)
            < *outlen as ::core::ffi::c_long
    {
        let fresh5 = in_0;
        in_0 = in_0.offset(1);
        c = *fresh5 as ::core::ffi::c_uint;
        if out >= outend {
            break;
        }
        if c < 0x80 as ::core::ffi::c_uint {
            let fresh6 = out;
            out = out.offset(1);
            *fresh6 = c as ::core::ffi::c_uchar;
        } else {
            *outlen = out.offset_from(outstart) as ::core::ffi::c_long as ::core::ffi::c_int;
            *inlen = processed.offset_from(base) as ::core::ffi::c_long as ::core::ffi::c_int;
...
pub unsafe extern "C" fn isolat1ToUTF8(
    ...
    let mut outstart: *mut ::core::ffi::c_uchar = out;
    let mut base: *const ::core::ffi::c_uchar = in_0;
    let mut outend: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<::core::ffi::c_uchar>();
    let mut inend: *const ::core::ffi::c_uchar = ::core::ptr::null::<::core::ffi::c_uchar>();
    let mut instop: *const ::core::ffi::c_uchar = ::core::ptr::null::<::core::ffi::c_uchar>();
    ...
    inend = in_0.offset(*inlen as isize);
    instop = inend;
    while in_0 < inend && out < outend.offset(-(1 as ::core::ffi::c_int as isize)) {
        if *in_0 as ::core::ffi::c_int >= 0x80 as ::core::ffi::c_int {
            let fresh10 = out;
            out = out.offset(1);
            *fresh10 = (*in_0 as ::core::ffi::c_int >> 6 as ::core::ffi::c_int
                & 0x1f as ::core::ffi::c_int
                | 0xc0 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
            let fresh11 = out;
            out = out.offset(1);
            *fresh11 = (*in_0 as ::core::ffi::c_int & 0x3f as ::core::ffi::c_int
                | 0x80 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
            in_0 = in_0.offset(1);
        }
        if instop.offset_from(in_0) as ::core::ffi::c_long
            > outend.offset_from(out) as ::core::ffi::c_long
        {
            instop = in_0.offset(outend.offset_from(out) as ::core::ffi::c_long as isize);
        }
        while in_0 < instop && (*in_0 as ::core::ffi::c_int) < 0x80 as ::core::ffi::c_int {
            let fresh12 = in_0;
            in_0 = in_0.offset(1);
            let fresh13 = out;
            out = out.offset(1);
    ...
    if in_0 < inend && out < outend && (*in_0 as ::core::ffi::c_int) < 0x80 as ::core::ffi::c_int {
        let fresh14 = in_0;
        in_0 = in_0.offset(1);
        let fresh15 = out;
        out = out.offset(1);
...
unsafe extern "C" fn UTF8ToUTF8(
    mut out: *mut ::core::ffi::c_uchar,
    mut outlen: *mut ::core::ffi::c_int,
    mut inb: *const ::core::ffi::c_uchar,
    mut inlenb: *mut ::core::ffi::c_int,
) -> ::core::ffi::c_int {
...
pub unsafe extern "C" fn UTF8Toisolat1(
    ...
    while in_0 < inend {
        ...
        if c <= 0xff as ::core::ffi::c_uint {
            if out >= outend as *mut ::core::ffi::c_uchar {
                break;
            }
            let fresh9 = out;
            out = out.offset(1);
            *fresh9 = c as ::core::ffi::c_uchar;
            processed = in_0;
        } else {
            *outlen = out.offset_from(outstart) as ::core::ffi::c_long as ::core::ffi::c_int;
            *inlen = processed.offset_from(instart) as ::core::ffi::c_long as ::core::ffi::c_int;
...
unsafe extern "C" fn UTF16LEToUTF8(
    ...
    let mut outstart: *mut ::core::ffi::c_uchar = out;
    let mut processed: *const ::core::ffi::c_uchar = inb;
    let mut outend: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<::core::ffi::c_uchar>();
    let mut in_0: *mut ::core::ffi::c_ushort = inb as *mut ::core::ffi::c_ushort;
    let mut inend: *mut ::core::ffi::c_ushort = ::core::ptr::null_mut::<::core::ffi::c_ushort>();
    let mut c: ::core::ffi::c_uint = 0;
    let mut d: ::core::ffi::c_uint = 0;
    let mut inlen: ::core::ffi::c_uint = 0;
    let mut tmp: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<::core::ffi::c_uchar>();
    ...
    inlen = (*inlenb / 2 as ::core::ffi::c_int) as ::core::ffi::c_uint;
    inend = in_0.offset(inlen as isize);
    while in_0 < inend
        && (out.offset_from(outstart) as ::core::ffi::c_long + 5 as ::core::ffi::c_long)
            < *outlen as ::core::ffi::c_long
    {
        if xmlLittleEndian != 0 {
            ...
            tmp = in_0 as *mut ::core::ffi::c_uchar;
            let fresh22 = tmp;
            tmp = tmp.offset(1);
            c = *fresh22 as ::core::ffi::c_uint;
            c = c | (*tmp as ::core::ffi::c_uint) << 8 as ::core::ffi::c_int;
            in_0 = in_0.offset(1);
        }
        if c & 0xfc00 as ::core::ffi::c_uint == 0xd800 as ::core::ffi::c_uint {
            if in_0 >= inend {
                break;
            }
            if xmlLittleEndian != 0 {
                let fresh23 = in_0;
                in_0 = in_0.offset(1);
                d = *fresh23 as ::core::ffi::c_uint;
            } else {
                tmp = in_0 as *mut ::core::ffi::c_uchar;
                let fresh24 = tmp;
                tmp = tmp.offset(1);
                d = *fresh24 as ::core::ffi::c_uint;
                d = d | (*tmp as ::core::ffi::c_uint) << 8 as ::core::ffi::c_int;
                in_0 = in_0.offset(1);
            }
            if d & 0xfc00 as ::core::ffi::c_uint == 0xdc00 as ::core::ffi::c_uint {
                c &= 0x3ff as ::core::ffi::c_uint;
                c <<= 10 as ::core::ffi::c_int;
                c |= d & 0x3ff as ::core::ffi::c_uint;
                c = c.wrapping_add(0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint);
            } else {
                *outlen = out.offset_from(outstart) as ::core::ffi::c_long as ::core::ffi::c_int;
                *inlenb = processed.offset_from(inb) as ::core::ffi::c_long as ::core::ffi::c_int;
                return -(2 as ::core::ffi::c_int);
            }
        }
        if out >= outend {
        ...
        if c < 0x80 as ::core::ffi::c_uint {
            let fresh25 = out;
            out = out.offset(1);
            *fresh25 = c as ::core::ffi::c_uchar;
            bits = -(6 as ::core::ffi::c_int);
        } else if c < 0x800 as ::core::ffi::c_uint {
            let fresh26 = out;
            out = out.offset(1);
            *fresh26 = (c >> 6 as ::core::ffi::c_int & 0x1f as ::core::ffi::c_uint
                | 0xc0 as ::core::ffi::c_uint) as ::core::ffi::c_uchar;
            bits = 0 as ::core::ffi::c_int;
        } else if c < 0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint {
            let fresh27 = out;
            out = out.offset(1);
            *fresh27 = (c >> 12 as ::core::ffi::c_int & 0xf as ::core::ffi::c_uint
                | 0xe0 as ::core::ffi::c_uint) as ::core::ffi::c_uchar;
            bits = 6 as ::core::ffi::c_int;
        } else {
            let fresh28 = out;
            out = out.offset(1);
            *fresh28 = (c >> 18 as ::core::ffi::c_int & 0x7 as ::core::ffi::c_uint
                | 0xf0 as ::core::ffi::c_uint) as ::core::ffi::c_uchar;
        ...
        while bits >= 0 as ::core::ffi::c_int {
            ...
            let fresh29 = out;
            out = out.offset(1);
            *fresh29 = (c >> bits & 0x3f as ::core::ffi::c_uint | 0x80 as ::core::ffi::c_uint)
                as ::core::ffi::c_uchar;
            bits -= 6 as ::core::ffi::c_int;
        }
        processed = in_0 as *const ::core::ffi::c_uchar;
    }
    *outlen = out.offset_from(outstart) as ::core::ffi::c_long as ::core::ffi::c_int;
    *inlenb = processed.offset_from(inb) as ::core::ffi::c_long as ::core::ffi::c_int;
    return *outlen;
...
unsafe extern "C" fn UTF8ToUTF16LE(
    mut outb: *mut ::core::ffi::c_uchar,
    mut outlen: *mut ::core::ffi::c_int,
    mut in_0: *const ::core::ffi::c_uchar,
    mut inlen: *mut ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    let mut out: *mut ::core::ffi::c_ushort = outb as *mut ::core::ffi::c_ushort;
    let mut processed: *const ::core::ffi::c_uchar = in_0;
    let instart: *const ::core::ffi::c_uchar = in_0;
    let mut outstart: *mut ::core::ffi::c_ushort = out;
    let mut outend: *mut ::core::ffi::c_ushort = ::core::ptr::null_mut::<::core::ffi::c_ushort>();
    let mut inend: *const ::core::ffi::c_uchar = ::core::ptr::null::<::core::ffi::c_uchar>();
    let mut c: ::core::ffi::c_uint = 0;
    let mut d: ::core::ffi::c_uint = 0;
    let mut trailing: ::core::ffi::c_int = 0;
    let mut tmp: *mut ::core::ffi::c_uchar = ::core::ptr::null_mut::<::core::ffi::c_uchar>();
    let mut tmp1: ::core::ffi::c_ushort = 0;
    let mut tmp2: ::core::ffi::c_ushort = 0;
    if out.is_null() || outlen.is_null() || inlen.is_null() {
        return -(1 as ::core::ffi::c_int);
    }
    if in_0.is_null() {
    ...
    inend = in_0.offset(*inlen as isize);
    outend = out.offset((*outlen / 2 as ::core::ffi::c_int) as isize);
    while in_0 < inend {
        let fresh16 = in_0;
        in_0 = in_0.offset(1);
        d = *fresh16 as ::core::ffi::c_uint;
        if d < 0x80 as ::core::ffi::c_uint {
            c = d;
            trailing = 0 as ::core::ffi::c_int;
        } else if d < 0xc0 as ::core::ffi::c_uint {
            *outlen = (out.offset_from(outstart) as ::core::ffi::c_long * 2 as ::core::ffi::c_long)
                as ::core::ffi::c_int;
            *inlen = processed.offset_from(instart) as ::core::ffi::c_long as ::core::ffi::c_int;
            return -(2 as ::core::ffi::c_int);
        } else if d < 0xe0 as ::core::ffi::c_uint {
        ...
        if c < 0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint {
            ...
            if xmlLittleEndian != 0 {
                let fresh18 = out;
                out = out.offset(1);
                *fresh18 = c as ::core::ffi::c_ushort;
            } else {
                tmp = out as *mut ::core::ffi::c_uchar;
                *tmp = c as ::core::ffi::c_uchar;
                *tmp.offset(1 as ::core::ffi::c_int as isize) =
                    (c >> 8 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                out = out.offset(1);
            }
        } else {
            if !(c < 0x110000 as ::core::ffi::c_int as ::core::ffi::c_uint) {
                break;
            }
            if out.offset(1 as ::core::ffi::c_int as isize) >= outend {
                break;
            }
            ...
            if xmlLittleEndian != 0 {
                let fresh19 = out;
                out = out.offset(1);
                *fresh19 = (0xd800 as ::core::ffi::c_uint | c >> 10 as ::core::ffi::c_int)
                    as ::core::ffi::c_ushort;
                let fresh20 = out;
                out = out.offset(1);
                *fresh20 = (0xdc00 as ::core::ffi::c_uint | c & 0x3ff as ::core::ffi::c_uint)
                    as ::core::ffi::c_ushort;
            } else {
                tmp1 = (0xd800 as ::core::ffi::c_uint | c >> 10 as ::core::ffi::c_int)
                    as ::core::ffi::c_ushort;
                tmp = out as *mut ::core::ffi::c_uchar;
                *tmp = tmp1 as ::core::ffi::c_uchar;
                *tmp.offset(1 as ::core::ffi::c_int as isize) =
                    (tmp1 as ::core::ffi::c_int >> 8 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                out = out.offset(1);
                tmp2 = (0xdc00 as ::core::ffi::c_uint | c & 0x3ff as ::core::ffi::c_uint)
                    as ::core::ffi::c_ushort;
                tmp = out as *mut ::core::ffi::c_uchar;
                *tmp = tmp2 as ::core::ffi::c_uchar;
                *tmp.offset(1 as ::core::ffi::c_int as isize) =
                    (tmp2 as ::core::ffi::c_int >> 8 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                out = out.offset(1);
            }
        }
        processed = in_0;
...
unsafe extern "C" fn UTF8ToUTF16(
    ...
    if in_0.is_null() {
        if *outlen >= 2 as ::core::ffi::c_int {
            *outb.offset(0 as ::core::ffi::c_int as isize) = 0xff as ::core::ffi::c_uchar;
            *outb.offset(1 as ::core::ffi::c_int as isize) = 0xfe as ::core::ffi::c_uchar;
            *outlen = 2 as ::core::ffi::c_int;
            *inlen = 0 as ::core::ffi::c_int;
            return 2 as ::core::ffi::c_int;
        }
        *outlen = 0 as ::core::ffi::c_int;
...
unsafe extern "C" fn UTF16BEToUTF8(
            ...
            < *outlen as ::core::ffi::c_long
    {
        if xmlLittleEndian != 0 {
            ...
            let fresh35 = tmp;
            tmp = tmp.offset(1);
            c = *fresh35 as ::core::ffi::c_uint;
            c = c << 8 as ::core::ffi::c_int | *tmp as ::core::ffi::c_uint;
            in_0 = in_0.offset(1);
        } else {
            let fresh36 = in_0;
            in_0 = in_0.offset(1);
            c = *fresh36 as ::core::ffi::c_uint;
        }
        if c & 0xfc00 as ::core::ffi::c_uint == 0xd800 as ::core::ffi::c_uint {
            if in_0 >= inend {
                break;
            ...
            if xmlLittleEndian != 0 {
                ...
                let fresh37 = tmp;
                tmp = tmp.offset(1);
                d = *fresh37 as ::core::ffi::c_uint;
                d = d << 8 as ::core::ffi::c_int | *tmp as ::core::ffi::c_uint;
                in_0 = in_0.offset(1);
            } else {
                let fresh38 = in_0;
                in_0 = in_0.offset(1);
                d = *fresh38 as ::core::ffi::c_uint;
            }
            if d & 0xfc00 as ::core::ffi::c_uint == 0xdc00 as ::core::ffi::c_uint {
                c &= 0x3ff as ::core::ffi::c_uint;
                c <<= 10 as ::core::ffi::c_int;
        ...
        if c < 0x80 as ::core::ffi::c_uint {
            let fresh39 = out;
            out = out.offset(1);
            *fresh39 = c as ::core::ffi::c_uchar;
            bits = -(6 as ::core::ffi::c_int);
        } else if c < 0x800 as ::core::ffi::c_uint {
            let fresh40 = out;
            out = out.offset(1);
            *fresh40 = (c >> 6 as ::core::ffi::c_int & 0x1f as ::core::ffi::c_uint
                | 0xc0 as ::core::ffi::c_uint) as ::core::ffi::c_uchar;
            bits = 0 as ::core::ffi::c_int;
        } else if c < 0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint {
            let fresh41 = out;
            out = out.offset(1);
            *fresh41 = (c >> 12 as ::core::ffi::c_int & 0xf as ::core::ffi::c_uint
                | 0xe0 as ::core::ffi::c_uint) as ::core::ffi::c_uchar;
            bits = 6 as ::core::ffi::c_int;
        } else {
            let fresh42 = out;
            out = out.offset(1);
            *fresh42 = (c >> 18 as ::core::ffi::c_int & 0x7 as ::core::ffi::c_uint
                | 0xf0 as ::core::ffi::c_uint) as ::core::ffi::c_uchar;
            bits = 12 as ::core::ffi::c_int;
        }
        while bits >= 0 as ::core::ffi::c_int {
            ...
            let fresh43 = out;
            out = out.offset(1);
            *fresh43 = (c >> bits & 0x3f as ::core::ffi::c_uint | 0x80 as ::core::ffi::c_uint)
                as ::core::ffi::c_uchar;
            bits -= 6 as ::core::ffi::c_int;
        }
        processed = in_0 as *const ::core::ffi::c_uchar;
...
unsafe extern "C" fn UTF8ToUTF16BE(
    ...
    while in_0 < inend {
        ...
        if c < 0x10000 as ::core::ffi::c_int as ::core::ffi::c_uint {
            ...
            if xmlLittleEndian != 0 {
                tmp = out as *mut ::core::ffi::c_uchar;
                *tmp = (c >> 8 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                *tmp.offset(1 as ::core::ffi::c_int as isize) = c as ::core::ffi::c_uchar;
                out = out.offset(1);
            } else {
                let fresh32 = out;
                out = out.offset(1);
                *fresh32 = c as ::core::ffi::c_ushort;
            }
        } else {
            if !(c < 0x110000 as ::core::ffi::c_int as ::core::ffi::c_uint) {
                break;
            ...
            if xmlLittleEndian != 0 {
                ...
                *tmp =
                    (tmp1 as ::core::ffi::c_int >> 8 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                *tmp.offset(1 as ::core::ffi::c_int as isize) = tmp1 as ::core::ffi::c_uchar;
                out = out.offset(1);
                tmp2 = (0xdc00 as ::core::ffi::c_uint | c & 0x3ff as ::core::ffi::c_uint)
                    as ::core::ffi::c_ushort;
                tmp = out as *mut ::core::ffi::c_uchar;
                *tmp =
                    (tmp2 as ::core::ffi::c_int >> 8 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
                *tmp.offset(1 as ::core::ffi::c_int as isize) = tmp2 as ::core::ffi::c_uchar;
                out = out.offset(1);
            } else {
                let fresh33 = out;
                out = out.offset(1);
                *fresh33 = (0xd800 as ::core::ffi::c_uint | c >> 10 as ::core::ffi::c_int)
                    as ::core::ffi::c_ushort;
                let fresh34 = out;
                out = out.offset(1);
                *fresh34 = (0xdc00 as ::core::ffi::c_uint | c & 0x3ff as ::core::ffi::c_uint)
                    as ::core::ffi::c_ushort;
            }
        }
        processed = in_0;
    ...
    while i < xmlCharEncodingAliasesNb {
        if !(*xmlCharEncodingAliases.offset(i as isize)).name.is_null() {
            xmlFree.expect("non-null function pointer")(
                (*xmlCharEncodingAliases.offset(i as isize)).name as *mut ::core::ffi::c_char
                    as *mut ::core::ffi::c_void,
            );
        }
        if !(*xmlCharEncodingAliases.offset(i as isize)).alias.is_null() {
            xmlFree.expect("non-null function pointer")(
                (*xmlCharEncodingAliases.offset(i as isize)).alias as *mut ::core::ffi::c_char
                    as *mut ::core::ffi::c_void,
            );
        }
        i += 1;
    }
    xmlCharEncodingAliasesNb = 0 as ::core::ffi::c_int;
    xmlCharEncodingAliasesMax = 0 as ::core::ffi::c_int;
    xmlFree.expect("non-null function pointer")(xmlCharEncodingAliases as *mut ::core::ffi::c_void);
...
pub unsafe extern "C" fn xmlGetEncodingAlias(
    ...
    let mut i: ::core::ffi::c_int = 0;
    let mut upper: [::core::ffi::c_char; 100] = [0; 100];
    if alias.is_null() {
    ...
    while i < 99 as ::core::ffi::c_int {
        upper[i as usize] =
            toupper(*alias.offset(i as isize) as ::core::ffi::c_int) as ::core::ffi::c_char;
        if upper[i as usize] as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            break;
        }
        i += 1;
    }
    upper[i as usize] = 0 as ::core::ffi::c_char;
    i = 0 as ::core::ffi::c_int;
    while i < xmlCharEncodingAliasesNb {
        if strcmp(
            (*xmlCharEncodingAliases.offset(i as isize)).alias,
            &raw mut upper as *mut ::core::ffi::c_char,
        ) == 0
        {
...
pub unsafe extern "C" fn xmlAddEncodingAlias(
    ...
    if xmlCharEncodingAliases.is_null() {
        xmlCharEncodingAliasesNb = 0 as ::core::ffi::c_int;
        xmlCharEncodingAliasesMax = 20 as ::core::ffi::c_int;
        xmlCharEncodingAliases = xmlMalloc.expect("non-null function pointer")(
            (xmlCharEncodingAliasesMax as size_t)
                .wrapping_mul(::core::mem::size_of::<xmlCharEncodingAlias>() as size_t),
        ) as xmlCharEncodingAliasPtr;
        if xmlCharEncodingAliases.is_null() {
            return -(1 as ::core::ffi::c_int);
        }
    } else if xmlCharEncodingAliasesNb >= xmlCharEncodingAliasesMax {
        xmlCharEncodingAliasesMax *= 2 as ::core::ffi::c_int;
        xmlCharEncodingAliases = xmlRealloc.expect("non-null function pointer")(
            xmlCharEncodingAliases as *mut ::core::ffi::c_void,
            (xmlCharEncodingAliasesMax as size_t)
                .wrapping_mul(::core::mem::size_of::<xmlCharEncodingAlias>() as size_t),
        ) as xmlCharEncodingAliasPtr;
    }
    ...
    while i < xmlCharEncodingAliasesNb {
        ...
        ) == 0
        {
            ...
            let ref mut fresh44 = (*xmlCharEncodingAliases.offset(i as isize)).name;
            *fresh44 = xmlMemStrdup.expect("non-null function pointer")(name);
            return 0 as ::core::ffi::c_int;
        }
        i += 1;
    }
    let ref mut fresh45 = (*xmlCharEncodingAliases.offset(xmlCharEncodingAliasesNb as isize)).name;
    *fresh45 = xmlMemStrdup.expect("non-null function pointer")(name);
    let ref mut fresh46 = (*xmlCharEncodingAliases.offset(xmlCharEncodingAliasesNb as isize)).alias;
    *fresh46 = xmlMemStrdup.expect("non-null function pointer")(
        &raw mut upper as *mut ::core::ffi::c_char,
    );
        ...
        if strcmp((*xmlCharEncodingAliases.offset(i as isize)).alias, alias) == 0 {
            ...
            memmove(
                xmlCharEncodingAliases.offset(i as isize) as *mut xmlCharEncodingAlias
                    as *mut ::core::ffi::c_void,
                xmlCharEncodingAliases.offset((i + 1 as ::core::ffi::c_int) as isize)
                    as *mut xmlCharEncodingAlias as *const ::core::ffi::c_void,
...
pub unsafe extern "C" fn xmlParseCharEncoding(
    ...
    let mut upper: [::core::ffi::c_char; 500] = [0; 500];
    let mut i: ::core::ffi::c_int = 0;
    if name.is_null() {
        return XML_CHAR_ENCODING_NONE;
    }
    ...
    i = 0 as ::core::ffi::c_int;
    while i < 499 as ::core::ffi::c_int {
        upper[i as usize] =
            toupper(*name.offset(i as isize) as ::core::ffi::c_int) as ::core::ffi::c_char;
        if upper[i as usize] as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            break;
        }
        i += 1;
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-10646-UCS-2\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"UCS-2\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
        return XML_CHAR_ENCODING_UCS2;
    }
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"UCS2\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
        return XML_CHAR_ENCODING_UCS2;
    }
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-10646-UCS-4\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
        return XML_CHAR_ENCODING_UCS4LE;
    }
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-8859-1\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-LATIN-1\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
        return XML_CHAR_ENCODING_8859_1;
    }
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-8859-2\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-LATIN-2\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
        return XML_CHAR_ENCODING_8859_2;
    }
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-8859-3\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-8859-4\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-8859-5\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-8859-6\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-8859-7\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-8859-8\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
    ...
    if strcmp(
        &raw mut upper as *mut ::core::ffi::c_char,
        b"ISO-8859-9\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
...
pub unsafe extern "C" fn xmlGetCharEncodingName(
    ...
    match enc as ::core::ffi::c_int {
        ...
        1 => return b"UTF-8\0" as *const u8 as *const ::core::ffi::c_char,
        2 => return b"UTF-16\0" as *const u8 as *const ::core::ffi::c_char,
        3 => return b"UTF-16\0" as *const u8 as *const ::core::ffi::c_char,
        6 => return b"EBCDIC\0" as *const u8 as *const ::core::ffi::c_char,
        4 => return b"ISO-10646-UCS-4\0" as *const u8 as *const ::core::ffi::c_char,
        5 => return b"ISO-10646-UCS-4\0" as *const u8 as *const ::core::ffi::c_char,
        7 => return b"ISO-10646-UCS-4\0" as *const u8 as *const ::core::ffi::c_char,
        8 => return b"ISO-10646-UCS-4\0" as *const u8 as *const ::core::ffi::c_char,
        9 => return b"ISO-10646-UCS-2\0" as *const u8 as *const ::core::ffi::c_char,
        10 => return b"ISO-8859-1\0" as *const u8 as *const ::core::ffi::c_char,
        11 => return b"ISO-8859-2\0" as *const u8 as *const ::core::ffi::c_char,
        12 => return b"ISO-8859-3\0" as *const u8 as *const ::core::ffi::c_char,
        13 => return b"ISO-8859-4\0" as *const u8 as *const ::core::ffi::c_char,
        14 => return b"ISO-8859-5\0" as *const u8 as *const ::core::ffi::c_char,
        15 => return b"ISO-8859-6\0" as *const u8 as *const ::core::ffi::c_char,
        16 => return b"ISO-8859-7\0" as *const u8 as *const ::core::ffi::c_char,
        17 => return b"ISO-8859-8\0" as *const u8 as *const ::core::ffi::c_char,
        18 => return b"ISO-8859-9\0" as *const u8 as *const ::core::ffi::c_char,
        19 => return b"ISO-2022-JP\0" as *const u8 as *const ::core::ffi::c_char,
        20 => return b"Shift-JIS\0" as *const u8 as *const ::core::ffi::c_char,
        21 => return b"EUC-JP\0" as *const u8 as *const ::core::ffi::c_char,
        22 => return ::core::ptr::null::<::core::ffi::c_char>(),
        _ => {}
    }
    return ::core::ptr::null::<::core::ffi::c_char>();
}
pub const MAX_ENCODING_HANDLERS: ::core::ffi::c_int = 50 as ::core::ffi::c_int;
...
static mut nbCharEncodingHandler: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
...
pub unsafe extern "C" fn xmlNewCharEncodingHandler(
    ...
    let mut upper: [::core::ffi::c_char; 500] = [0; 500];
    let mut i: ::core::ffi::c_int = 0;
    let mut up: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
    alias = xmlGetEncodingAlias(name);
    if !alias.is_null() {
        name = alias;
    }
    ...
    if handler.is_null() {
        xmlFree.expect("non-null function pointer")(up as *mut ::core::ffi::c_void);
        xmlEncodingErrMemory(
            b"xmlNewCharEncodingHandler : out of memory !\n\0" as *const u8
                as *const ::core::ffi::c_char,
        );
    ...
    memset(
        handler as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
    ...
    (*handler).name = up;
    (*handler).iconv_in = NULL as iconv_t;
    (*handler).iconv_out = NULL as iconv_t;
    xmlRegisterCharEncodingHandler(handler);
    return handler;
}
#[no_mangle]
pub unsafe extern "C" fn xmlInitCharEncodingHandlers() {
    let mut tst: ::core::ffi::c_ushort = 0x1234 as ::core::ffi::c_ushort;
    let mut ptr: *mut ::core::ffi::c_uchar = &raw mut tst as *mut ::core::ffi::c_uchar;
    if !handlers.is_null() {
        return;
    }
    ...
    if *ptr as ::core::ffi::c_int == 0x12 as ::core::ffi::c_int {
        xmlLittleEndian = 0 as ::core::ffi::c_int;
    } else if *ptr as ::core::ffi::c_int == 0x34 as ::core::ffi::c_int {
        xmlLittleEndian = 1 as ::core::ffi::c_int;
    } else {
        xmlEncodingErr(
    ...
    xmlNewCharEncodingHandler(
        b"US-ASCII\0" as *const u8 as *const ::core::ffi::c_char,
        Some(
            asciiToUTF8
                as unsafe extern "C" fn(
                    *mut ::core::ffi::c_uchar,
...
pub unsafe extern "C" fn xmlCleanupCharEncodingHandlers() {
    ...
    while nbCharEncodingHandler > 0 as ::core::ffi::c_int {
        ...
        if !(*handlers.offset(nbCharEncodingHandler as isize)).is_null() {
            ...
            xmlFree.expect("non-null function pointer")(
                *handlers.offset(nbCharEncodingHandler as isize) as *mut ::core::ffi::c_void,
            );
        }
    }
    xmlFree.expect("non-null function pointer")(handlers as *mut ::core::ffi::c_void);
    handlers = ::core::ptr::null_mut::<xmlCharEncodingHandlerPtr>();
    nbCharEncodingHandler = 0 as ::core::ffi::c_int;
    xmlDefaultCharEncodingHandler = ::core::ptr::null_mut::<xmlCharEncodingHandler>();
}
#[no_mangle]
pub unsafe extern "C" fn xmlRegisterCharEncodingHandler(mut handler: xmlCharEncodingHandlerPtr) {
    if handlers.is_null() {
    ...
    if handler.is_null() || handlers.is_null() {
        ...
        xmlEncodingErr(
            ...
            b"xmlRegisterCharEncodingHandler: Too many handler registered, see %s\n\0" as *const u8
                as *const ::core::ffi::c_char,
            b"MAX_ENCODING_HANDLERS\0" as *const u8 as *const ::core::ffi::c_char,
        );
    } else {
    ...
    if !handler.is_null() {
        if !(*handler).name.is_null() {
            xmlFree.expect("non-null function pointer")(
                (*handler).name as *mut ::core::ffi::c_void,
            );
        }
        xmlFree.expect("non-null function pointer")(handler as *mut ::core::ffi::c_void);
    }
}
#[no_mangle]
pub unsafe extern "C" fn xmlGetCharEncodingHandler(
    ...
    match enc as ::core::ffi::c_int {
        ...
        6 => {
            handler =
                xmlFindCharEncodingHandler(b"EBCDIC\0" as *const u8 as *const ::core::ffi::c_char);
            if !handler.is_null() {
                return handler;
            }
            handler =
            ...
            handler = xmlFindCharEncodingHandler(
                b"EBCDIC-US\0" as *const u8 as *const ::core::ffi::c_char,
            );
            if !handler.is_null() {
                return handler;
            }
            handler =
                xmlFindCharEncodingHandler(b"IBM-037\0" as *const u8 as *const ::core::ffi::c_char);
            if !handler.is_null() {
                return handler;
            }
        }
        5 => {
            ...
            handler =
                xmlFindCharEncodingHandler(b"UCS-4\0" as *const u8 as *const ::core::ffi::c_char);
            if !handler.is_null() {
                return handler;
            }
            handler =
                xmlFindCharEncodingHandler(b"UCS4\0" as *const u8 as *const ::core::ffi::c_char);
            if !handler.is_null() {
                return handler;
            }
        }
        ...
        9 => {
            ...
            handler =
                xmlFindCharEncodingHandler(b"UCS-2\0" as *const u8 as *const ::core::ffi::c_char);
            if !handler.is_null() {
                return handler;
            }
            handler =
                xmlFindCharEncodingHandler(b"UCS2\0" as *const u8 as *const ::core::ffi::c_char);
            if !handler.is_null() {
                return handler;
            }
        }
        ...
        20 => {
            handler = xmlFindCharEncodingHandler(
                b"SHIFT-JIS\0" as *const u8 as *const ::core::ffi::c_char,
            );
            if !handler.is_null() {
                return handler;
            }
        ...
        21 => {
            handler =
                xmlFindCharEncodingHandler(b"EUC-JP\0" as *const u8 as *const ::core::ffi::c_char);
            if !handler.is_null() {
                return handler;
            }
        }
...
pub unsafe extern "C" fn xmlFindCharEncodingHandler(
    ...
    let mut nalias: *const ::core::ffi::c_char = ::core::ptr::null::<::core::ffi::c_char>();
    let mut norig: *const ::core::ffi::c_char = ::core::ptr::null::<::core::ffi::c_char>();
    let mut alias: xmlCharEncoding = XML_CHAR_ENCODING_NONE;
    let mut enc: xmlCharEncodingHandlerPtr = ::core::ptr::null_mut::<xmlCharEncodingHandler>();
    let mut icv_in: iconv_t = ::core::ptr::null_mut::<::core::ffi::c_void>();
    let mut icv_out: iconv_t = ::core::ptr::null_mut::<::core::ffi::c_void>();
    let mut upper: [::core::ffi::c_char; 100] = [0; 100];
    let mut i: ::core::ffi::c_int = 0;
    if handlers.is_null() {
        xmlInitCharEncodingHandlers();
    ...
    icv_in = iconv_open(b"UTF-8\0" as *const u8 as *const ::core::ffi::c_char, name);
    icv_out = iconv_open(name, b"UTF-8\0" as *const u8 as *const ::core::ffi::c_char);
    if icv_in == -(1 as ::core::ffi::c_int) as iconv_t {
        icv_in = iconv_open(
            b"UTF-8\0" as *const u8 as *const ::core::ffi::c_char,
            &raw mut upper as *mut ::core::ffi::c_char,
        );
    }
    if icv_out == -(1 as ::core::ffi::c_int) as iconv_t {
        icv_out = iconv_open(
            &raw mut upper as *mut ::core::ffi::c_char,
            b"UTF-8\0" as *const u8 as *const ::core::ffi::c_char,
        );
    ...
    if icv_in != -(1 as ::core::ffi::c_int) as iconv_t
        && icv_out != -(1 as ::core::ffi::c_int) as iconv_t
    {
        enc = xmlMalloc.expect("non-null function pointer")(::core::mem::size_of::<
            xmlCharEncodingHandler,
        >() as size_t) as xmlCharEncodingHandlerPtr;
        if enc.is_null() {
            iconv_close(icv_in);
        ...
        return enc;
    } else if icv_in != -(1 as ::core::ffi::c_int) as iconv_t
        || icv_out != -(1 as ::core::ffi::c_int) as iconv_t
    {
        xmlEncodingErr(
            XML_ERR_INTERNAL_ERROR,
    ...
    if alias as ::core::ffi::c_int != XML_CHAR_ENCODING_ERROR as ::core::ffi::c_int {
        let mut canon: *const ::core::ffi::c_char = ::core::ptr::null::<::core::ffi::c_char>();
...
unsafe extern "C" fn xmlIconvWrapper(
    ...
    let mut icv_in: *const ::core::ffi::c_char = in_0 as *const ::core::ffi::c_char;
    let mut icv_out: *mut ::core::ffi::c_char = out as *mut ::core::ffi::c_char;
    ...
    ret = iconv(
        cd,
        &raw mut icv_in as *mut *mut ::core::ffi::c_char,
        &raw mut icv_inlen,
        &raw mut icv_out,
        &raw mut icv_outlen,
    );
    *inlen = (*inlen as size_t).wrapping_sub(icv_inlen) as ::core::ffi::c_int as ::core::ffi::c_int;
    *outlen =
        (*outlen as size_t).wrapping_sub(icv_outlen) as ::core::ffi::c_int as ::core::ffi::c_int;
    if icv_inlen != 0 as size_t || ret == -(1 as ::core::ffi::c_int) as size_t {
        if *__errno_location() == EILSEQ {
            return -(2 as ::core::ffi::c_int);
        } else if *__errno_location() == E2BIG {
            return -(1 as ::core::ffi::c_int);
...
unsafe extern "C" fn xmlEncInputChunk(
    ...
    if (*handler).input.is_some() {
        ret = (*handler).input.expect("non-null function pointer")(out, outlen, in_0, inlen);
...
unsafe extern "C" fn xmlEncOutputChunk(
    ...
    if (*handler).output.is_some() {
        ret = (*handler).output.expect("non-null function pointer")(out, outlen, in_0, inlen);
        if ret > 0 as ::core::ffi::c_int {
            ret = 0 as ::core::ffi::c_int;
        }
...
pub unsafe extern "C" fn xmlCharEncFirstLineInt(
    ...
    let mut toconv: ::core::ffi::c_int = 0;
    if handler.is_null() {
        return -(1 as ::core::ffi::c_int);
    }
    if out.is_null() {
    ...
    toconv = (*in_0).use_0 as ::core::ffi::c_int;
    if len >= 0 as ::core::ffi::c_int {
        if toconv > len {
            toconv = len;
        }
    } else if toconv > 180 as ::core::ffi::c_int {
        toconv = 180 as ::core::ffi::c_int;
    }
    if toconv * 2 as ::core::ffi::c_int >= written {
        xmlBufferGrow(
            out,
            (toconv * 2 as ::core::ffi::c_int) as ::core::ffi::c_uint,
        );
        written = (*out)
            .size
            .wrapping_sub((*out).use_0)
    ...
    ret = xmlEncInputChunk(
        handler,
        (*out).content.offset((*out).use_0 as isize) as *mut ::core::ffi::c_uchar,
        &raw mut written,
        (*in_0).content,
        &raw mut toconv,
        0 as ::core::ffi::c_int,
    );
    xmlBufferShrink(in_0, toconv as ::core::ffi::c_uint);
    (*out).use_0 = (*out).use_0.wrapping_add(written as ::core::ffi::c_uint);
...
pub unsafe extern "C" fn xmlCharEncFirstLine(
    ...
    return xmlCharEncFirstLineInt(handler, out, in_0, -(1 as ::core::ffi::c_int));
}
#[no_mangle]
pub unsafe extern "C" fn xmlCharEncFirstLineInput(
    ...
    let mut c_in: ::core::ffi::c_int = 0;
    let mut c_out: ::core::ffi::c_int = 0;
    ...
    written = xmlBufAvail(out).wrapping_sub(1 as size_t);
    if len >= 0 as ::core::ffi::c_int {
        if toconv > len as ::core::ffi::c_uint as size_t {
            toconv = len as size_t;
        }
    } else if toconv > 180 as size_t {
        toconv = 180 as size_t;
    }
    if toconv.wrapping_mul(2 as size_t) >= written {
        xmlBufGrow(out, toconv.wrapping_mul(2 as size_t) as ::core::ffi::c_int);
        written = xmlBufAvail(out).wrapping_sub(1 as size_t);
    }
    if written > 360 as size_t {
        written = 360 as size_t;
    }
    c_in = toconv as ::core::ffi::c_int;
    c_out = written as ::core::ffi::c_int;
    ret = xmlEncInputChunk(
        (*input).encoder as *mut xmlCharEncodingHandler,
        xmlBufEnd(out) as *mut ::core::ffi::c_uchar,
        &raw mut c_out,
    ...
    match ret {
        -2 => {
            ...
            snprintf(
                ...
                49 as size_t,
                b"0x%02X 0x%02X 0x%02X 0x%02X\0" as *const u8 as *const ::core::ffi::c_char,
                *content.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int,
                *content.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int,
                *content.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int,
                *content.offset(3 as ::core::ffi::c_int as isize) as ::core::ffi::c_int,
            );
            buf[49 as ::core::ffi::c_int as usize] = 0 as ::core::ffi::c_char;
            xmlEncodingErr(
...
pub unsafe extern "C" fn xmlCharEncInput(
    ...
    if toconv > (64 as ::core::ffi::c_int * 1024 as ::core::ffi::c_int) as size_t
        && flush == 0 as ::core::ffi::c_int
    {
        toconv = (64 as ::core::ffi::c_int * 1024 as ::core::ffi::c_int) as size_t;
    }
    ...
    if written > (128 as ::core::ffi::c_int * 1024 as ::core::ffi::c_int) as size_t
        && flush == 0 as ::core::ffi::c_int
    {
        written = (128 as ::core::ffi::c_int * 1024 as ::core::ffi::c_int) as size_t;
    }
    c_in = toconv as ::core::ffi::c_int;
    c_out = written as ::core::ffi::c_int;
    ret = xmlEncInputChunk(
...
pub unsafe extern "C" fn xmlCharEncInFunc(
    ...
    if toconv * 2 as ::core::ffi::c_int >= written {
        xmlBufferGrow(
            ...
            (*out)
                .size
                .wrapping_add((toconv * 2 as ::core::ffi::c_int) as ::core::ffi::c_uint),
        );
        written = (*out)
            .size
            .wrapping_sub((*out).use_0)
    ...
    match ret {
        -2 => {
            ...
            snprintf(
                ...
                49 as size_t,
                b"0x%02X 0x%02X 0x%02X 0x%02X\0" as *const u8 as *const ::core::ffi::c_char,
                *(*in_0).content.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int,
                *(*in_0).content.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int,
                *(*in_0).content.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int,
                *(*in_0).content.offset(3 as ::core::ffi::c_int as isize) as ::core::ffi::c_int,
            );
            buf[49 as ::core::ffi::c_int as usize] = 0 as ::core::ffi::c_char;
            xmlEncodingErr(
                XML_I18N_CONV_FAILED,
...
pub unsafe extern "C" fn xmlCharEncOutput(
    ...
    mut init: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0;
    let mut written: size_t = 0;
    let mut writtentot: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut toconv: size_t = 0;
    let mut c_in: ::core::ffi::c_int = 0;
    let mut c_out: ::core::ffi::c_int = 0;
    let mut in_0: xmlBufPtr = ::core::ptr::null_mut::<xmlBuf>();
    ...
    loop {
        ...
        if toconv.wrapping_mul(4 as size_t) >= written {
            xmlBufGrow(out, toconv.wrapping_mul(4 as size_t) as ::core::ffi::c_int);
            written = xmlBufAvail(out).wrapping_sub(1 as size_t);
        }
        if written > (256 as ::core::ffi::c_int * 1024 as ::core::ffi::c_int) as size_t {
            written = (256 as ::core::ffi::c_int * 1024 as ::core::ffi::c_int) as size_t;
        }
        c_in = toconv as ::core::ffi::c_int;
        c_out = written as ::core::ffi::c_int;
        ...
        match ret {
            ...
            -2 => {
                ...
                let mut len: ::core::ffi::c_int = xmlBufUse(in_0) as ::core::ffi::c_int;
                let mut content: *mut xmlChar = xmlBufContent(in_0 as *const xmlBuf);
                let mut cur: ::core::ffi::c_int = 0;
                let mut charrefLen: ::core::ffi::c_int = 0;
                cur = xmlGetUTF8Char(content, &raw mut len);
                if cur <= 0 as ::core::ffi::c_int {
                    break;
                }
                charrefLen = snprintf(
                    (&raw mut charref as *mut xmlChar).offset(0 as ::core::ffi::c_int as isize)
                        as *mut xmlChar as *mut ::core::ffi::c_char,
                    ::core::mem::size_of::<[xmlChar; 20]>() as size_t,
                    b"&#%d;\0" as *const u8 as *const ::core::ffi::c_char,
                    cur,
                );
                xmlBufShrink(in_0, len as size_t);
                xmlBufGrow(out, charrefLen * 4 as ::core::ffi::c_int);
                c_out = xmlBufAvail(out).wrapping_sub(1 as size_t) as ::core::ffi::c_int;
                c_in = charrefLen;
                ret = xmlEncOutputChunk(
                    (*output).encoder as *mut xmlCharEncodingHandler,
                    xmlBufEnd(out) as *mut ::core::ffi::c_uchar,
                ...
                if ret < 0 as ::core::ffi::c_int || c_in != charrefLen {
                    let mut buf: [::core::ffi::c_char; 50] = [0; 50];
                    snprintf(
                        (&raw mut buf as *mut ::core::ffi::c_char)
                    ...
                    {
                        *content.offset(0 as ::core::ffi::c_int as isize) = ' ' as i32 as xmlChar;
                    }
                    break;
                } else {
                    xmlBufAddLen(out, c_out as size_t);
...
pub unsafe extern "C" fn xmlCharEncOutFunc(
    ...
    loop {
        written = (*out).size.wrapping_sub((*out).use_0) as ::core::ffi::c_int;
        if written > 0 as ::core::ffi::c_int {
            written -= 1;
        }
        if in_0.is_null() {
            toconv = 0 as ::core::ffi::c_int;
            xmlEncOutputChunk(
                handler,
                (*out).content.offset((*out).use_0 as isize) as *mut ::core::ffi::c_uchar,
                &raw mut written,
        ...
        if toconv * 4 as ::core::ffi::c_int >= written {
            xmlBufferGrow(
                out,
                (toconv * 4 as ::core::ffi::c_int) as ::core::ffi::c_uint,
            );
            written = (*out)
                .size
                .wrapping_sub((*out).use_0)
        ...
        *(*out).content.offset((*out).use_0 as isize) = 0 as xmlChar;
        ...
        match ret {
            ...
            -2 => {
                let mut charref: [xmlChar; 20] = [0; 20];
                let mut len: ::core::ffi::c_int = (*in_0).use_0 as ::core::ffi::c_int;
                let mut utf: *const xmlChar = (*in_0).content as *const xmlChar;
                let mut cur: ::core::ffi::c_int = 0;
                let mut charrefLen: ::core::ffi::c_int = 0;
                cur = xmlGetUTF8Char(utf as *const ::core::ffi::c_uchar, &raw mut len);
                if cur <= 0 as ::core::ffi::c_int {
                    break;
                }
                charrefLen = snprintf(
                ...
                xmlBufferShrink(in_0, len as ::core::ffi::c_uint);
                xmlBufferGrow(
                    out,
                    (charrefLen * 4 as ::core::ffi::c_int) as ::core::ffi::c_uint,
                );
                written = (*out)
                    .size
                    .wrapping_sub((*out).use_0)
                ...
                if ret < 0 as ::core::ffi::c_int || toconv != charrefLen {
                    let mut buf: [::core::ffi::c_char; 50] = [0; 50];
                    snprintf(
                        (&raw mut buf as *mut ::core::ffi::c_char)
                            .offset(0 as ::core::ffi::c_int as isize)
                        ...
                        49 as size_t,
                        b"0x%02X 0x%02X 0x%02X 0x%02X\0" as *const u8 as *const ::core::ffi::c_char,
                        *(*in_0).content.offset(0 as ::core::ffi::c_int as isize)
                            as ::core::ffi::c_int,
                        *(*in_0).content.offset(1 as ::core::ffi::c_int as isize)
                            as ::core::ffi::c_int,
                        *(*in_0).content.offset(2 as ::core::ffi::c_int as isize)
                            as ::core::ffi::c_int,
                        *(*in_0).content.offset(3 as ::core::ffi::c_int as isize)
                            as ::core::ffi::c_int,
                    );
                    buf[49 as ::core::ffi::c_int as usize] = 0 as ::core::ffi::c_char;
                    xmlEncodingErr(
                    ...
                    if (*in_0).alloc as ::core::ffi::c_uint
...
pub unsafe extern "C" fn xmlCharEncCloseFunc(
    ...
    let mut tofree: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut i: ::core::ffi::c_int = 0;
    let mut handler_in_list: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    if handler.is_null() {
        return -(1 as ::core::ffi::c_int);
    }
    if (*handler).name.is_null() {
    ...
    if !handlers.is_null() {
        ...
        while i < nbCharEncodingHandler {
            if handler == *handlers.offset(i as isize) {
                handler_in_list = 1 as ::core::ffi::c_int;
                break;
            } else {
                i += 1;
            }
    ...
    if handler_in_list == 0 as ::core::ffi::c_int
        && (!(*handler).iconv_out.is_null() || !(*handler).iconv_in.is_null())
    {
        tofree = 1 as ::core::ffi::c_int;
    ...
    if tofree != 0 {
        ...
        (*handler).name = ::core::ptr::null_mut::<::core::ffi::c_char>();
        xmlFree.expect("non-null function pointer")(handler as *mut ::core::ffi::c_void);
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn xmlByteConsumed(mut ctxt: xmlParserCtxtPtr) -> ::core::ffi::c_long {
    ...
    if !(*in_0).buf.is_null() && !(*(*in_0).buf).encoder.is_null() {
        let mut unused: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
        let mut handler: *mut xmlCharEncodingHandler =
            (*(*in_0).buf).encoder as *mut xmlCharEncodingHandler;
        if (*in_0).end.offset_from((*in_0).cur) as ::core::ffi::c_long > 0 as ::core::ffi::c_long {
            let mut convbuf: [::core::ffi::c_uchar; 32000] = [0; 32000];
            let mut cur: *const ::core::ffi::c_uchar = (*in_0).cur as *const ::core::ffi::c_uchar;
            let mut toconv: ::core::ffi::c_int =
                (*in_0).end.offset_from((*in_0).cur) as ::core::ffi::c_long as ::core::ffi::c_int;
            let mut written: ::core::ffi::c_int = 32000 as ::core::ffi::c_int;
            let mut ret: ::core::ffi::c_int = 0;
            loop {
                toconv = (*in_0).end.offset_from(cur) as ::core::ffi::c_long as ::core::ffi::c_int;
                written = 32000 as ::core::ffi::c_int;
                ret = xmlEncOutputChunk(
                    handler,
                    (&raw mut convbuf as *mut ::core::ffi::c_uchar)
                        .offset(0 as ::core::ffi::c_int as isize)
                ...
                unused = unused.wrapping_add(written as ::core::ffi::c_uint);
        ...
        if (*(*in_0).buf).rawconsumed < unused as ::core::ffi::c_ulong {
            return -(1 as ::core::ffi::c_int) as ::core::ffi::c_long;
        }
        return (*(*in_0).buf)
            .rawconsumed
            .wrapping_sub(unused as ::core::ffi::c_ulong) as ::core::ffi::c_long;
    }
    return (*in_0).consumed.wrapping_add(
        (*in_0).cur.offset_from((*in_0).base) as ::core::ffi::c_long as ::core::ffi::c_ulong
    ) as ::core::ffi::c_long;
}
