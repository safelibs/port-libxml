...
pub const HTML_COMMENT_NODE: ::core::ffi::c_uint = 8 as ::core::ffi::c_uint;
pub const HTML_PRESERVE_NODE: ::core::ffi::c_uint = 4 as ::core::ffi::c_uint;
pub const HTML_PI_NODE: ::core::ffi::c_uint = 7 as ::core::ffi::c_uint;
#[no_mangle]
pub unsafe extern "C" fn htmlGetMetaEncoding(mut doc: htmlDocPtr) -> *const xmlChar {
    ...
    loop {
            ...
            && !(*cur).name.is_null()
        {
            ...
            {
                current_block = 11473733126343057201;
                break;
            }
            if xmlStrEqual(
                (*cur).name,
            ...
            ) != 0
            {
                ...
                while !attr.is_null() {
                        ...
                        && (*(*attr).children).next.is_null()
                    {
                        ...
                        if http != 0 as ::core::ffi::c_int && !content.is_null() {
                            current_block = 16254291768974263149;
                            break 's_100;
                        }
                    }
    ...
    match current_block {
        ...
        _ => {
            ...
            if !encoding.is_null() {
                encoding = encoding.offset(8 as ::core::ffi::c_int as isize);
            } else {
                encoding = xmlStrstr(
                    content,
                    b"charset =\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
                ...
                if !encoding.is_null() {
                    encoding = encoding.offset(9 as ::core::ffi::c_int as isize);
                }
            }
            if !encoding.is_null() {
...
pub unsafe extern "C" fn htmlSetMetaEncoding(
    ...
    let mut content: *const xmlChar = ::core::ptr::null::<xmlChar>();
    let mut newcontent: [::core::ffi::c_char; 100] = [0; 100];
    newcontent[0 as ::core::ffi::c_int as usize] = 0 as ::core::ffi::c_char;
    if doc.is_null() {
    ...
    if !encoding.is_null() {
        snprintf(
            &raw mut newcontent as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 100]>() as size_t,
            b"text/html; charset=%s\0" as *const u8 as *const ::core::ffi::c_char,
            encoding as *mut ::core::ffi::c_char,
        );
        newcontent[(::core::mem::size_of::<[::core::ffi::c_char; 100]>() as usize)
    ...
    loop {
            ...
            && !(*cur).name.is_null()
        {
            ...
            {
                current_block = 17607783353835167575;
                break;
            }
            if xmlStrcasecmp(
                (*cur).name,
            ...
            {
                current_block = 10339663808807549383;
                break;
            }
        }
        cur = (*cur).next as htmlNodePtr;
    ...
    match current_block {
        17607783353835167575 => {
            head = cur;
            if (*cur).children.is_null() {
                current_block = 5455602836600377690;
            } else {
                cur = (*cur).children as htmlNodePtr;
                current_block = 10339663808807549383;
            }
    ...
    if meta.is_null() {
        if !encoding.is_null() && !head.is_null() {
            ...
            xmlNewProp(
                ...
                &raw mut newcontent as *mut ::core::ffi::c_char as *mut xmlChar,
            );
        }
...
static mut htmlBooleanAttrs: [*const ::core::ffi::c_char; 14] = [
...
#[no_mangle]
pub unsafe extern "C" fn htmlIsBooleanAttr(mut name: *const xmlChar) -> ::core::ffi::c_int {
...
unsafe extern "C" fn htmlSaveErrMemory(mut extra: *const ::core::ffi::c_char) {
    __xmlSimpleError(
...
unsafe extern "C" fn htmlBufNodeDumpFormat(
    ...
    if outbuf.is_null() {
        htmlSaveErrMemory(
            b"allocating HTML output buffer\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return -(1 as ::core::ffi::c_int) as size_t;
    }
    memset(
...
pub unsafe extern "C" fn htmlNodeDump(
    ...
    ret = htmlBufNodeDumpFormat(buffer, doc, cur, 1 as ::core::ffi::c_int);
...
pub unsafe extern "C" fn htmlNodeDumpFileFormat(
    ...
    if !encoding.is_null() {
        ...
        if handler.is_null() {
            handler =
                xmlFindCharEncodingHandler(b"HTML\0" as *const u8 as *const ::core::ffi::c_char);
        }
        if handler.is_null() {
            handler =
                xmlFindCharEncodingHandler(b"ascii\0" as *const u8 as *const ::core::ffi::c_char);
        }
    }
...
pub unsafe extern "C" fn htmlDocDumpMemoryFormat(
    ...
    encoding = htmlGetMetaEncoding(cur as htmlDocPtr) as *const ::core::ffi::c_char;
    if !encoding.is_null() {
        let mut enc: xmlCharEncoding = XML_CHAR_ENCODING_NONE;
        enc = xmlParseCharEncoding(encoding);
        if enc as ::core::ffi::c_int != XML_CHAR_ENCODING_UTF8 as ::core::ffi::c_int {
    ...
    htmlDocContentDumpFormatOutput(buf, cur, ::core::ptr::null::<::core::ffi::c_char>(), format);
    xmlOutputBufferFlush(buf);
    if !(*buf).conv.is_null() {
        *size = xmlBufUse((*buf).conv) as ::core::ffi::c_int;
        *mem = xmlStrndup(xmlBufContent((*buf).conv as *const xmlBuf), *size);
    } else {
        *size = xmlBufUse((*buf).buffer) as ::core::ffi::c_int;
...
pub unsafe extern "C" fn htmlDocDumpMemory(
    ...
    htmlDocDumpMemoryFormat(cur, mem, size, 1 as ::core::ffi::c_int);
}
unsafe extern "C" fn htmlDtdDumpOutput(
    ...
    if cur.is_null() {
        htmlSaveErr(
            XML_SAVE_NO_DOCTYPE as ::core::ffi::c_int,
            doc as xmlNodePtr,
            ::core::ptr::null::<::core::ffi::c_char>(),
        );
        return;
    ...
    if !(*cur).ExternalID.is_null() {
        ...
        if !(*cur).SystemID.is_null() {
            xmlOutputBufferWriteString(buf, b" \0" as *const u8 as *const ::core::ffi::c_char);
            xmlBufWriteQuotedString((*buf).buffer, (*cur).SystemID);
        }
    } else if !(*cur).SystemID.is_null()
        && xmlStrcmp(
            (*cur).SystemID,
            b"about:legacy-compat\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
        ) != 0
    {
        xmlOutputBufferWriteString(
            buf,
...
unsafe extern "C" fn htmlAttrDumpOutput(
    ...
    if !(*cur).children.is_null() && htmlIsBooleanAttr((*cur).name) == 0 {
        value = xmlNodeListGetString(doc, (*cur).children, 0 as ::core::ffi::c_int);
        if !value.is_null() {
            xmlOutputBufferWriteString(buf, b"=\0" as *const u8 as *const ::core::ffi::c_char);
            if (*cur).ns.is_null()
                && !(*cur).parent.is_null()
                ...
                && (xmlStrcasecmp(
                    ...
                    || xmlStrcasecmp(
                        (*cur).name,
                        b"action\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
                    ) == 0
                    || xmlStrcasecmp(
                        (*cur).name,
                        b"src\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
                    ) == 0
                    || xmlStrcasecmp(
                        (*cur).name,
                        ...
                        ) == 0)
            {
                ...
                if !escaped.is_null() {
                    ...
                    xmlFree.expect("non-null function pointer")(
                        escaped as *mut ::core::ffi::c_void,
                    );
                } else {
            ...
            1 => {
                if (*cur).parent != parent && !(*cur).children.is_null() {
                    ...
                    if !info.is_null() && (*info).empty as ::core::ffi::c_int != 0 {
                        ...
                        if !info.is_null()
                            && (*info).saveEndTag as ::core::ffi::c_int != 0 as ::core::ffi::c_int
                            && xmlStrcmp(
                        ...
                        if format != 0
                            ...
                            && !(*cur).name.is_null()
                            && *(*cur).name.offset(0 as ::core::ffi::c_int as isize)
                                as ::core::ffi::c_int
                                != 'p' as i32
                        {
                            xmlOutputBufferWriteString(
                        ...
                        && (*info).isinline == 0
                    {
                        if (*(*cur).next).type_0 as ::core::ffi::c_uint
                            ...
                            && !parent.is_null()
                            && !(*parent).name.is_null()
                            && *(*parent).name.offset(0 as ::core::ffi::c_int as isize)
                                as ::core::ffi::c_int
                                != 'p' as i32
                        {
                            xmlOutputBufferWriteString(
            ...
            3 => {
                if !(*cur).content.is_null() {
                                ...
                                ) != 0)
                    {
                        ...
                        if !buffer.is_null() {
                            xmlOutputBufferWriteString(buf, buffer as *const ::core::ffi::c_char);
                            xmlFree.expect("non-null function pointer")(
            ...
            if !(*cur).next.is_null() {
                        ...
                        == XML_DOCUMENT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
                {
                    ...
                    if format != 0
                        && !info.is_null()
                        && (*info).isinline == 0
                        && (*(*cur).last).type_0 as ::core::ffi::c_uint
                            != XML_TEXT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
                        && (*(*cur).last).type_0 as ::core::ffi::c_uint
                            != XML_ENTITY_REF_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
                        && (*cur).children != (*cur).last
...
#[no_mangle]
pub unsafe extern "C" fn htmlDocDump(mut f: *mut FILE, mut cur: xmlDocPtr) -> ::core::ffi::c_int {
    let mut buf: xmlOutputBufferPtr = ::core::ptr::null_mut::<xmlOutputBuffer>();
    let mut handler: xmlCharEncodingHandlerPtr = ::core::ptr::null_mut::<xmlCharEncodingHandler>();
    let mut encoding: *const ::core::ffi::c_char = ::core::ptr::null::<::core::ffi::c_char>();
    let mut ret: ::core::ffi::c_int = 0;
    ...
    htmlDocContentDumpOutput(buf, cur, ::core::ptr::null::<::core::ffi::c_char>());
    ret = xmlOutputBufferClose(buf);
    return ret;
}
#[no_mangle]
...
pub unsafe extern "C" fn htmlSaveFileFormat(
    ...
    if !encoding.is_null() {
        ...
        htmlSetMetaEncoding(
            cur as htmlDocPtr,
            b"UTF-8\0" as *const u8 as *const ::core::ffi::c_char as *const xmlChar,
        );
        if handler.is_null() {
            handler =
                xmlFindCharEncodingHandler(b"HTML\0" as *const u8 as *const ::core::ffi::c_char);
    ...
    buf = xmlOutputBufferCreateFilename(filename, handler, 0 as ::core::ffi::c_int);
    if buf.is_null() {
        return 0 as ::core::ffi::c_int;
    }
...
pub unsafe extern "C" fn htmlSaveFileEnc(
    ...
    return htmlSaveFileFormat(filename, cur, encoding, 1 as ::core::ffi::c_int);
}
