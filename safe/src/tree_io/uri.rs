...
pub const MAX_URI_LENGTH: ::core::ffi::c_int =
    1024 as ::core::ffi::c_int * 1024 as ::core::ffi::c_int;
unsafe extern "C" fn xmlURIErrMemory(mut extra: *const ::core::ffi::c_char) {
    if !extra.is_null() {
        __xmlRaiseError(
            None,
            None,
            ...
            NULL,
            NULL,
            XML_FROM_URI as ::core::ffi::c_int,
...
unsafe extern "C" fn xmlParse3986Scheme(
    ...
    if !uri.is_null() {
        if !(*uri).scheme.is_null() {
            xmlFree.expect("non-null function pointer")((*uri).scheme as *mut ::core::ffi::c_void);
        }
        (*uri).scheme = xmlStrndup(
            *str as *const xmlChar,
            cur.offset_from(*str) as ::core::ffi::c_long as ::core::ffi::c_int,
...
unsafe extern "C" fn xmlParse3986Fragment(
    ...
    while *cur as ::core::ffi::c_int >= 'a' as i32 && *cur as ::core::ffi::c_int <= 'z' as i32
        ...
        || *cur as ::core::ffi::c_int == '%' as i32
            && (*cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int >= '0' as i32
                ...
                || *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                    ...
                    && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                        <= 'F' as i32)
            && (*cur.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int >= '0' as i32
        ...
        || *cur as ::core::ffi::c_int == ']' as i32
        || !uri.is_null()
            && (*uri).cleanup & 1 as ::core::ffi::c_int != 0
            && (*cur as ::core::ffi::c_int == '{' as i32
                || *cur as ::core::ffi::c_int == '}' as i32
                || *cur as ::core::ffi::c_int == '|' as i32
                || *cur as ::core::ffi::c_int == '\\' as i32
    ...
    if !uri.is_null() {
        ...
        if (*uri).cleanup & 2 as ::core::ffi::c_int != 0 {
            (*uri).fragment = xmlStrndup(
                *str as *const xmlChar,
                cur.offset_from(*str) as ::core::ffi::c_long as ::core::ffi::c_int,
            ) as *mut ::core::ffi::c_char;
        } else {
            (*uri).fragment = xmlURIUnescapeString(
                *str,
                cur.offset_from(*str) as ::core::ffi::c_long as ::core::ffi::c_int,
...
unsafe extern "C" fn xmlParse3986Query(
    ...
    if !uri.is_null() {
        if !(*uri).query.is_null() {
            xmlFree.expect("non-null function pointer")((*uri).query as *mut ::core::ffi::c_void);
        }
        if (*uri).cleanup & 2 as ::core::ffi::c_int != 0 {
            (*uri).query = xmlStrndup(
                *str as *const xmlChar,
                cur.offset_from(*str) as ::core::ffi::c_long as ::core::ffi::c_int,
            ) as *mut ::core::ffi::c_char;
        } else {
            (*uri).query = xmlURIUnescapeString(
                *str,
                cur.offset_from(*str) as ::core::ffi::c_long as ::core::ffi::c_int,
                ::core::ptr::null_mut::<::core::ffi::c_char>(),
            );
        ...
        if !(*uri).query_raw.is_null() {
            xmlFree.expect("non-null function pointer")(
                (*uri).query_raw as *mut ::core::ffi::c_void,
            );
        }
        (*uri).query_raw = xmlStrndup(
            *str as *const xmlChar,
            cur.offset_from(*str) as ::core::ffi::c_long as ::core::ffi::c_int,
        ) as *mut ::core::ffi::c_char;
    }
...
unsafe extern "C" fn xmlParse3986Port(
    ...
    let mut cur: *const ::core::ffi::c_char = *str;
    let mut port: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    if *cur as ::core::ffi::c_int >= '0' as i32 && *cur as ::core::ffi::c_int <= '9' as i32 {
        while *cur as ::core::ffi::c_int >= '0' as i32 && *cur as ::core::ffi::c_int <= '9' as i32 {
            ...
            if port > INT_MAX / 10 as ::core::ffi::c_int {
                return 1 as ::core::ffi::c_int;
            }
            port *= 10 as ::core::ffi::c_int;
...
unsafe extern "C" fn xmlParse3986Userinfo(
    ...
    if *cur as ::core::ffi::c_int == '@' as i32 {
        if !uri.is_null() {
            if !(*uri).user.is_null() {
                xmlFree.expect("non-null function pointer")(
                    (*uri).user as *mut ::core::ffi::c_void,
                );
            }
            if (*uri).cleanup & 2 as ::core::ffi::c_int != 0 {
                (*uri).user = xmlStrndup(
...
unsafe extern "C" fn xmlParse3986DecOctet(
    ...
    if !(*cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int >= '0' as i32
        && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int <= '9' as i32)
    {
        cur = cur.offset(1);
    } else if *cur as ::core::ffi::c_int != '0' as i32
        && (*cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int >= '0' as i32
            && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int <= '9' as i32)
        && !(*cur.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int >= '0' as i32
            && *cur.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int <= '9' as i32)
    {
        cur = cur.offset(2 as ::core::ffi::c_int as isize);
    } else if *cur as ::core::ffi::c_int == '1' as i32
        && (*cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int >= '0' as i32
            && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int <= '9' as i32)
        && (*cur.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int >= '0' as i32
            && *cur.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int <= '9' as i32)
    {
        cur = cur.offset(3 as ::core::ffi::c_int as isize);
    } else if *cur as ::core::ffi::c_int == '2' as i32
        && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int >= '0' as i32
        && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int <= '4' as i32
        && (*cur.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int >= '0' as i32
            && *cur.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int <= '9' as i32)
    {
        cur = cur.offset(3 as ::core::ffi::c_int as isize);
    } else if *cur as ::core::ffi::c_int == '2' as i32
        && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '5' as i32
        && *cur.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int >= '0' as i32
        && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int <= '5' as i32
    {
        cur = cur.offset(3 as ::core::ffi::c_int as isize);
...
unsafe extern "C" fn xmlParse3986Host(
    ...
    if *cur as ::core::ffi::c_int == '[' as i32 {
        ...
        if *cur as ::core::ffi::c_int >= '0' as i32 && *cur as ::core::ffi::c_int <= '9' as i32 {
            if xmlParse3986DecOctet(&raw mut cur) != 0 as ::core::ffi::c_int {
                current_block = 2569975446978665528;
                ...
                if xmlParse3986DecOctet(&raw mut cur) != 0 as ::core::ffi::c_int {
                    ...
                    current_block = 2569975446978665528;
                } else if xmlParse3986DecOctet(&raw mut cur) != 0 as ::core::ffi::c_int {
                    current_block = 2569975446978665528;
                } else if *cur as ::core::ffi::c_int != '.' as i32 {
                    current_block = 2569975446978665528;
                } else if xmlParse3986DecOctet(&raw mut cur) != 0 as ::core::ffi::c_int {
                    ...
                    current_block = 6501533435590958182;
                }
            }
            match current_block {
                6501533435590958182 => {}
    ...
    if !uri.is_null() {
        if !(*uri).authority.is_null() {
            xmlFree.expect("non-null function pointer")(
                (*uri).authority as *mut ::core::ffi::c_void,
            );
        }
        (*uri).authority = ::core::ptr::null_mut::<::core::ffi::c_char>();
        if !(*uri).server.is_null() {
            xmlFree.expect("non-null function pointer")((*uri).server as *mut ::core::ffi::c_void);
        }
        if cur != host {
            if (*uri).cleanup & 2 as ::core::ffi::c_int != 0 {
                (*uri).server = xmlStrndup(
                    host as *const xmlChar,
                    cur.offset_from(host) as ::core::ffi::c_long as ::core::ffi::c_int,
                ) as *mut ::core::ffi::c_char;
            } else {
                (*uri).server = xmlURIUnescapeString(
                    host,
                    cur.offset_from(host) as ::core::ffi::c_long as ::core::ffi::c_int,
                    ::core::ptr::null_mut::<::core::ffi::c_char>(),
                );
            ...
            (*uri).server = ::core::ptr::null_mut::<::core::ffi::c_char>();
        }
    }
    *str = cur;
    return 0 as ::core::ffi::c_int;
...
unsafe extern "C" fn xmlParse3986Authority(
    ...
    cur = *str;
    ret = xmlParse3986Userinfo(uri, &raw mut cur);
    if ret != 0 as ::core::ffi::c_int || *cur as ::core::ffi::c_int != '@' as i32 {
        cur = *str;
    } else {
        cur = cur.offset(1);
    }
    ret = xmlParse3986Host(uri, &raw mut cur);
    if ret != 0 as ::core::ffi::c_int {
        return ret;
    }
    if *cur as ::core::ffi::c_int == ':' as i32 {
        cur = cur.offset(1);
        ret = xmlParse3986Port(uri, &raw mut cur);
        if ret != 0 as ::core::ffi::c_int {
            return ret;
        }
    }
...
unsafe extern "C" fn xmlParse3986Segment(
    ...
    while (*cur as ::core::ffi::c_int >= 'a' as i32 && *cur as ::core::ffi::c_int <= 'z' as i32
        ...
        || *cur as ::core::ffi::c_int == ':' as i32
        || *cur as ::core::ffi::c_int == '@' as i32)
        && *cur as ::core::ffi::c_int != forbid as ::core::ffi::c_int
    {
        if *cur as ::core::ffi::c_int == '%' as i32 {
            cur = cur.offset(3 as ::core::ffi::c_int as isize);
        } else {
...
unsafe extern "C" fn xmlParse3986PathAbEmpty(
    ...
    if !uri.is_null() {
        if !(*uri).path.is_null() {
            xmlFree.expect("non-null function pointer")((*uri).path as *mut ::core::ffi::c_void);
        }
        if *str != cur {
            if (*uri).cleanup & 2 as ::core::ffi::c_int != 0 {
                (*uri).path = xmlStrndup(
            ...
            (*uri).path = ::core::ptr::null_mut::<::core::ffi::c_char>();
        }
    }
    *str = cur;
    return 0 as ::core::ffi::c_int;
...
unsafe extern "C" fn xmlParse3986HierPart(
    ...
    {
        cur = cur.offset(2 as ::core::ffi::c_int as isize);
        ret = xmlParse3986Authority(uri, &raw mut cur);
        if ret != 0 as ::core::ffi::c_int {
            return ret;
        }
        if (*uri).server.is_null() {
        ...
        ret = xmlParse3986PathAbEmpty(uri, &raw mut cur);
        if ret != 0 as ::core::ffi::c_int {
            return ret;
        }
        *str = cur;
        ...
        ret = xmlParse3986PathAbsolute(uri, &raw mut cur);
        if ret != 0 as ::core::ffi::c_int {
            return ret;
        }
    } else if *cur as ::core::ffi::c_int >= 'a' as i32 && *cur as ::core::ffi::c_int <= 'z' as i32
        || *cur as ::core::ffi::c_int >= 'A' as i32 && *cur as ::core::ffi::c_int <= 'Z' as i32
        || *cur as ::core::ffi::c_int >= '0' as i32 && *cur as ::core::ffi::c_int <= '9' as i32
        || *cur as ::core::ffi::c_int == '-' as i32
        || *cur as ::core::ffi::c_int == '.' as i32
        ...
        || *cur as ::core::ffi::c_int == '@' as i32
    {
        ret = xmlParse3986PathRootless(uri, &raw mut cur);
        if ret != 0 as ::core::ffi::c_int {
            return ret;
        }
    } else if !uri.is_null() {
...
unsafe extern "C" fn xmlParse3986RelativeRef(
        ...
        && *str.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '/' as i32
    {
        ...
        ret = xmlParse3986Authority(uri, &raw mut str);
        if ret != 0 as ::core::ffi::c_int {
            return ret;
        }
        ret = xmlParse3986PathAbEmpty(uri, &raw mut str);
        if ret != 0 as ::core::ffi::c_int {
            return ret;
        }
    } else if *str as ::core::ffi::c_int == '/' as i32 {
        ret = xmlParse3986PathAbsolute(uri, &raw mut str);
        if ret != 0 as ::core::ffi::c_int {
            return ret;
        }
    } else if *str as ::core::ffi::c_int >= 'a' as i32 && *str as ::core::ffi::c_int <= 'z' as i32
        || *str as ::core::ffi::c_int >= 'A' as i32 && *str as ::core::ffi::c_int <= 'Z' as i32
        || *str as ::core::ffi::c_int >= '0' as i32 && *str as ::core::ffi::c_int <= '9' as i32
        || *str as ::core::ffi::c_int == '-' as i32
        || *str as ::core::ffi::c_int == '.' as i32
        || *str as ::core::ffi::c_int == '_' as i32
        || *str as ::core::ffi::c_int == '~' as i32
        || *str as ::core::ffi::c_int == '%' as i32
            && (*str.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int >= '0' as i32
        ...
        || *str as ::core::ffi::c_int == '@' as i32
    {
        ret = xmlParse3986PathNoScheme(uri, &raw mut str);
        if ret != 0 as ::core::ffi::c_int {
            return ret;
        }
    } else if !uri.is_null() {
    ...
    if *str as ::core::ffi::c_int == '?' as i32 {
        str = str.offset(1);
        ret = xmlParse3986Query(uri, &raw mut str);
        if ret != 0 as ::core::ffi::c_int {
            return ret;
        }
    }
    if *str as ::core::ffi::c_int == '#' as i32 {
        str = str.offset(1);
        ret = xmlParse3986Fragment(uri, &raw mut str);
        if ret != 0 as ::core::ffi::c_int {
            return ret;
        }
    }
...
unsafe extern "C" fn xmlParse3986URI(
    ...
    let mut ret: ::core::ffi::c_int = 0;
    ret = xmlParse3986Scheme(uri, &raw mut str);
    if ret != 0 as ::core::ffi::c_int {
        return ret;
    }
    if *str as ::core::ffi::c_int != ':' as i32 {
    ...
    str = str.offset(1);
    ret = xmlParse3986HierPart(uri, &raw mut str);
    if ret != 0 as ::core::ffi::c_int {
        return ret;
    }
    if *str as ::core::ffi::c_int == '?' as i32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlParseURI(mut str: *const ::core::ffi::c_char) -> xmlURIPtr {
    let mut uri: xmlURIPtr = ::core::ptr::null_mut::<xmlURI>();
    let mut ret: ::core::ffi::c_int = 0;
    if str.is_null() {
        return ::core::ptr::null_mut::<xmlURI>();
    }
    uri = xmlCreateURI();
    if !uri.is_null() {
...
pub unsafe extern "C" fn xmlParseURIRaw(
    ...
    if !uri.is_null() {
        if raw != 0 {
            (*uri).cleanup |= 2 as ::core::ffi::c_int;
        }
...
pub unsafe extern "C" fn xmlCreateURI() -> xmlURIPtr {
    let mut ret: xmlURIPtr = ::core::ptr::null_mut::<xmlURI>();
    ret = xmlMalloc.expect("non-null function pointer")(::core::mem::size_of::<xmlURI>() as size_t)
        as xmlURIPtr;
    if ret.is_null() {
    ...
    memset(
        ...
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<xmlURI>() as size_t,
    );
    return ret;
}
unsafe extern "C" fn xmlSaveUriRealloc(
    mut ret: *mut xmlChar,
    mut max: *mut ::core::ffi::c_int,
) -> *mut xmlChar {
    ...
    tmp = *max * 2 as ::core::ffi::c_int;
    temp = xmlRealloc.expect("non-null function pointer")(
        ret as *mut ::core::ffi::c_void,
        (tmp + 1 as ::core::ffi::c_int) as size_t,
    ) as *mut xmlChar;
    if temp.is_null() {
...
pub unsafe extern "C" fn xmlSaveUri(mut uri: xmlURIPtr) -> *mut xmlChar {
    ...
    if !(*uri).scheme.is_null() {
        ...
        loop {
            ...
            if len >= max {
                temp = xmlSaveUriRealloc(ret, &raw mut max);
                if temp.is_null() {
                    current_block = 8617904776080546784;
                    break;
                }
                ret = temp;
            }
            ...
            _ => {
                ...
                match current_block {
                    ...
                    _ => {
                        let fresh5 = len;
                        len = len + 1;
                        *ret.offset(fresh5 as isize) = ':' as i32 as xmlChar;
        ...
        12124785117276362961 => {
            if !(*uri).opaque.is_null() {
                ...
                loop {
                    ...
                    if len + 3 as ::core::ffi::c_int >= max {
                        temp = xmlSaveUriRealloc(ret, &raw mut max);
                        if temp.is_null() {
                            current_block = 8617904776080546784;
                            break;
                                ...
                                || *p as ::core::ffi::c_int == ')' as i32))
                    {
                        ...
                        let fresh7 = len;
                        len = len + 1;
                        *ret.offset(fresh7 as isize) = *fresh6 as xmlChar;
                    } else {
                        let fresh8 = p;
                        p = p.offset(1);
                        let mut val: ::core::ffi::c_int =
                            *(fresh8 as *mut ::core::ffi::c_uchar) as ::core::ffi::c_int;
                        let mut hi: ::core::ffi::c_int = val / 0x10 as ::core::ffi::c_int;
                        let mut lo: ::core::ffi::c_int = val % 0x10 as ::core::ffi::c_int;
                        let fresh9 = len;
                        len = len + 1;
                        *ret.offset(fresh9 as isize) = '%' as i32 as xmlChar;
                        let fresh10 = len;
                        len = len + 1;
                        *ret.offset(fresh10 as isize) = (hi
                            + (if hi > 9 as ::core::ffi::c_int {
                        ...
                        let fresh11 = len;
                        len = len + 1;
                        *ret.offset(fresh11 as isize) = (lo
                            + (if lo > 9 as ::core::ffi::c_int {
                                'A' as i32 - 10 as ::core::ffi::c_int
                            } else {
                                '0' as i32
                            })) as xmlChar;
                ...
                if !(*uri).server.is_null() || (*uri).port == -(1 as ::core::ffi::c_int) {
                    if len + 3 as ::core::ffi::c_int >= max {
                        temp = xmlSaveUriRealloc(ret, &raw mut max);
                        if temp.is_null() {
                            current_block = 8617904776080546784;
                    ...
                    match current_block {
                        ...
                        _ => {
                            let fresh12 = len;
                            len = len + 1;
                            *ret.offset(fresh12 as isize) = '/' as i32 as xmlChar;
                            let fresh13 = len;
                            len = len + 1;
                            *ret.offset(fresh13 as isize) = '/' as i32 as xmlChar;
                            if !(*uri).user.is_null() {
                                p = (*uri).user;
                                loop {
                                    if !(*p as ::core::ffi::c_int != 0 as ::core::ffi::c_int) {
                                        ...
                                        || *p as ::core::ffi::c_int == ',' as i32
                                    {
                                        ...
                                        let fresh15 = len;
                                        len = len + 1;
                                        *ret.offset(fresh15 as isize) = *fresh14 as xmlChar;
                                    } else {
                                        let fresh16 = p;
                                        p = p.offset(1);
                                        let mut val_0: ::core::ffi::c_int = *(fresh16
                                            as *mut ::core::ffi::c_uchar)
                                            as ::core::ffi::c_int;
                                        let mut hi_0: ::core::ffi::c_int =
                                            val_0 / 0x10 as ::core::ffi::c_int;
                                        let mut lo_0: ::core::ffi::c_int =
                                            val_0 % 0x10 as ::core::ffi::c_int;
                                        let fresh17 = len;
                                        len = len + 1;
                                        *ret.offset(fresh17 as isize) = '%' as i32 as xmlChar;
                                        let fresh18 = len;
                                        len = len + 1;
                                        *ret.offset(fresh18 as isize) = (hi_0
                                            + (if hi_0 > 9 as ::core::ffi::c_int {
                                                'A' as i32 - 10 as ::core::ffi::c_int
                                            } else {
                                                '0' as i32
                                            }))
                                        ...
                                        let fresh19 = len;
                                        len = len + 1;
                                        *ret.offset(fresh19 as isize) = (lo_0
                                            + (if lo_0 > 9 as ::core::ffi::c_int {
                                                'A' as i32 - 10 as ::core::ffi::c_int
                                            } else {
                                                '0' as i32
                                            }))
                                ...
                                _ => {
                                    if !(*uri).server.is_null() {
                                        ...
                                        loop {
                                            ...
                                            let fresh22 = len;
                                            len = len + 1;
                                            *ret.offset(fresh22 as isize) = *fresh21 as xmlChar;
                                        }
                                        match current_block {
                                            8617904776080546784 => {}
                                            _ => {
                    ...
                    match current_block {
                        ...
                        _ => {
                            let fresh23 = len;
                            len = len + 1;
                            *ret.offset(fresh23 as isize) = '/' as i32 as xmlChar;
                            let fresh24 = len;
                            len = len + 1;
                            *ret.offset(fresh24 as isize) = '/' as i32 as xmlChar;
                            p = (*uri).authority;
                            loop {
                                if !(*p as ::core::ffi::c_int != 0 as ::core::ffi::c_int) {
                                    current_block = 496303045384785551;
                                    ...
                                    || *p as ::core::ffi::c_int == '+' as i32
                                {
                                    ...
                                    let fresh26 = len;
                                    len = len + 1;
                                    *ret.offset(fresh26 as isize) = *fresh25 as xmlChar;
                                } else {
                                    let fresh27 = p;
                                    p = p.offset(1);
                                    let mut val_1: ::core::ffi::c_int = *(fresh27
                                        as *mut ::core::ffi::c_uchar)
                                        as ::core::ffi::c_int;
                                    let mut hi_1: ::core::ffi::c_int =
                                        val_1 / 0x10 as ::core::ffi::c_int;
                                    let mut lo_1: ::core::ffi::c_int =
                                        val_1 % 0x10 as ::core::ffi::c_int;
                                    let fresh28 = len;
                                    len = len + 1;
                                    *ret.offset(fresh28 as isize) = '%' as i32 as xmlChar;
                                    let fresh29 = len;
                                    len = len + 1;
                                    *ret.offset(fresh29 as isize) = (hi_1
                                        + (if hi_1 > 9 as ::core::ffi::c_int {
                                            'A' as i32 - 10 as ::core::ffi::c_int
                                        } else {
                                            '0' as i32
                                        }))
                                    ...
                                    let fresh30 = len;
                                    len = len + 1;
                                    *ret.offset(fresh30 as isize) = (lo_1
                                        + (if lo_1 > 9 as ::core::ffi::c_int {
                                            'A' as i32 - 10 as ::core::ffi::c_int
                                        } else {
                                            '0' as i32
                                        }))
                ...
                match current_block {
                    ...
                    _ => {
                                ...
                                ) != 0
                            {
                                ...
                                match current_block {
                                    ...
                                    _ => {
                                        ...
                                        let fresh32 = len;
                                        len = len + 1;
                                        *ret.offset(fresh32 as isize) = *fresh31 as xmlChar;
                                        let fresh33 = p;
                                        p = p.offset(1);
                                        let fresh34 = len;
                                        len = len + 1;
                                        *ret.offset(fresh34 as isize) = *fresh33 as xmlChar;
                                        let fresh35 = p;
                                        p = p.offset(1);
                                        let fresh36 = len;
                                        len = len + 1;
                                        *ret.offset(fresh36 as isize) = *fresh35 as xmlChar;
                                ...
                                _ => loop {
                                        ...
                                        || *p as ::core::ffi::c_int == ',' as i32
                                    {
                                        ...
                                        *ret.offset(fresh38 as isize) = *fresh37 as xmlChar;
                                        ...
                                        let fresh39 = p;
                                        p = p.offset(1);
                                        let mut val_2: ::core::ffi::c_int = *(fresh39
                                            as *mut ::core::ffi::c_uchar)
                                            as ::core::ffi::c_int;
                                        let mut hi_2: ::core::ffi::c_int =
                                            val_2 / 0x10 as ::core::ffi::c_int;
                                        let mut lo_2: ::core::ffi::c_int =
                                            val_2 % 0x10 as ::core::ffi::c_int;
                                        let fresh40 = len;
                                        len = len + 1;
                                        *ret.offset(fresh40 as isize) = '%' as i32 as xmlChar;
                                        let fresh41 = len;
                                        len = len + 1;
                                        *ret.offset(fresh41 as isize) = (hi_2
                                            + (if hi_2 > 9 as ::core::ffi::c_int {
                                                'A' as i32 - 10 as ::core::ffi::c_int
                                            } else {
                                                '0' as i32
                                            }))
                                        ...
                                        let fresh42 = len;
                                        len = len + 1;
                                        *ret.offset(fresh42 as isize) = (lo_2
                                            + (if lo_2 > 9 as ::core::ffi::c_int {
                                                'A' as i32 - 10 as ::core::ffi::c_int
                                            } else {
                                                '0' as i32
                                            }))
                        ...
                        match current_block {
                            ...
                            _ => {
                                if !(*uri).query_raw.is_null() {
                                    if len + 1 as ::core::ffi::c_int >= max {
                                        temp = xmlSaveUriRealloc(ret, &raw mut max);
                                        if temp.is_null() {
                                            current_block = 8617904776080546784;
                                        } else {
                                            ...
                                            *ret.offset(fresh46 as isize) = '?' as i32 as xmlChar;
                                            ...
                                            loop {
                                                        ...
                                                        || *p as ::core::ffi::c_int == ']' as i32)
                                                {
                                                    ...
                                                    let fresh48 = len;
                                                    len = len + 1;
                                                    *ret.offset(fresh48 as isize) =
                                                        *fresh47 as xmlChar;
                                                } else {
                                                    let fresh49 = p;
                                                    p = p.offset(1);
                                                    let mut val_3: ::core::ffi::c_int = *(fresh49
                                                        as *mut ::core::ffi::c_uchar)
                                                        as ::core::ffi::c_int;
                                                    let mut hi_3: ::core::ffi::c_int =
                                                        val_3 / 0x10 as ::core::ffi::c_int;
                                                    let mut lo_3: ::core::ffi::c_int =
                                                        val_3 % 0x10 as ::core::ffi::c_int;
                                                    let fresh50 = len;
                                                    len = len + 1;
                                                    *ret.offset(fresh50 as isize) =
                                                    ...
                                                    let fresh51 = len;
                                                    len = len + 1;
                                                    *ret.offset(fresh51 as isize) = (hi_3
                                                        + (if hi_3 > 9 as ::core::ffi::c_int {
                                                            'A' as i32 - 10 as ::core::ffi::c_int
                                                        } else {
                                                            '0' as i32
                                                        }))
                                                    ...
                                                    let fresh52 = len;
                                                    len = len + 1;
                                                    *ret.offset(fresh52 as isize) = (lo_3
                                                        + (if lo_3 > 9 as ::core::ffi::c_int {
                                                            'A' as i32 - 10 as ::core::ffi::c_int
                                                        } else {
                                                            '0' as i32
                                                        }))
                    ...
                    if !(*uri).fragment.is_null() {
                        ...
                        match current_block {
                            ...
                            _ => {
                                let fresh53 = len;
                                len = len + 1;
                                *ret.offset(fresh53 as isize) = '#' as i32 as xmlChar;
                                p = (*uri).fragment;
                                loop {
                                    if !(*p as ::core::ffi::c_int != 0 as ::core::ffi::c_int) {
                                            ...
                                            || *p as ::core::ffi::c_int == ']' as i32)
                                    {
                                        ...
                                        *ret.offset(fresh55 as isize) = *fresh54 as xmlChar;
                                        ...
                                        let fresh56 = p;
                                        p = p.offset(1);
                                        let mut val_4: ::core::ffi::c_int = *(fresh56
                                            as *mut ::core::ffi::c_uchar)
                                            as ::core::ffi::c_int;
                                        let mut hi_4: ::core::ffi::c_int =
                                            val_4 / 0x10 as ::core::ffi::c_int;
                                        let mut lo_4: ::core::ffi::c_int =
                                            val_4 % 0x10 as ::core::ffi::c_int;
                                        let fresh57 = len;
                                        len = len + 1;
                                        *ret.offset(fresh57 as isize) = '%' as i32 as xmlChar;
                                        let fresh58 = len;
                                        len = len + 1;
                                        *ret.offset(fresh58 as isize) = (hi_4
                                            + (if hi_4 > 9 as ::core::ffi::c_int {
                                                'A' as i32 - 10 as ::core::ffi::c_int
                                            } else {
                                                '0' as i32
                                            }))
                                        ...
                                        let fresh59 = len;
                                        len = len + 1;
                                        *ret.offset(fresh59 as isize) = (lo_4
                                            + (if lo_4 > 9 as ::core::ffi::c_int {
                                                'A' as i32 - 10 as ::core::ffi::c_int
                                            } else {
                                                '0' as i32
                                            }))
...
unsafe extern "C" fn xmlCleanURI(mut uri: xmlURIPtr) {
    ...
    (*uri).scheme = ::core::ptr::null_mut::<::core::ffi::c_char>();
    if !(*uri).server.is_null() {
        xmlFree.expect("non-null function pointer")((*uri).server as *mut ::core::ffi::c_void);
    }
    (*uri).server = ::core::ptr::null_mut::<::core::ffi::c_char>();
    if !(*uri).user.is_null() {
        xmlFree.expect("non-null function pointer")((*uri).user as *mut ::core::ffi::c_void);
    }
    (*uri).user = ::core::ptr::null_mut::<::core::ffi::c_char>();
    if !(*uri).path.is_null() {
        xmlFree.expect("non-null function pointer")((*uri).path as *mut ::core::ffi::c_void);
    }
    (*uri).path = ::core::ptr::null_mut::<::core::ffi::c_char>();
    if !(*uri).fragment.is_null() {
        xmlFree.expect("non-null function pointer")((*uri).fragment as *mut ::core::ffi::c_void);
    }
    (*uri).fragment = ::core::ptr::null_mut::<::core::ffi::c_char>();
    if !(*uri).opaque.is_null() {
        xmlFree.expect("non-null function pointer")((*uri).opaque as *mut ::core::ffi::c_void);
    }
    (*uri).opaque = ::core::ptr::null_mut::<::core::ffi::c_char>();
    if !(*uri).authority.is_null() {
        xmlFree.expect("non-null function pointer")((*uri).authority as *mut ::core::ffi::c_void);
    }
    (*uri).authority = ::core::ptr::null_mut::<::core::ffi::c_char>();
    if !(*uri).query.is_null() {
        xmlFree.expect("non-null function pointer")((*uri).query as *mut ::core::ffi::c_void);
    }
    (*uri).query = ::core::ptr::null_mut::<::core::ffi::c_char>();
    if !(*uri).query_raw.is_null() {
        xmlFree.expect("non-null function pointer")((*uri).query_raw as *mut ::core::ffi::c_void);
    }
    (*uri).query_raw = ::core::ptr::null_mut::<::core::ffi::c_char>();
}
#[no_mangle]
...
pub unsafe extern "C" fn xmlNormalizeURIPath(
    ...
    cur = path;
    while *cur.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '/' as i32 {
        cur = cur.offset(1);
    }
    ...
    out = cur;
    's_32: while *cur.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int != '\0' as i32
    {
            ...
            && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '/' as i32
        {
            ...
            while *cur.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int != '/' as i32
            {
                ...
                let fresh61 = out;
                out = out.offset(1);
                *fresh61.offset(0 as ::core::ffi::c_int as isize) =
                    *fresh60.offset(0 as ::core::ffi::c_int as isize);
            }
            while *cur.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '/' as i32
                && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '/' as i32
            {
            ...
            let fresh63 = out;
            out = out.offset(1);
            *fresh63.offset(0 as ::core::ffi::c_int as isize) =
                *fresh62.offset(0 as ::core::ffi::c_int as isize);
        }
    }
    *out.offset(0 as ::core::ffi::c_int as isize) = '\0' as i32 as ::core::ffi::c_char;
    cur = path;
    while *cur.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '/' as i32 {
        cur = cur.offset(1);
    }
    ...
    loop {
        let mut segp: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        let mut tmp: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        segp = cur;
        while *segp.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int != '/' as i32
            && *segp.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int != '\0' as i32
        {
            segp = segp.offset(1);
        }
        if *segp.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '\0' as i32 {
            break;
        }
        segp = segp.offset(1);
        if *cur.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '.' as i32
            && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '.' as i32
            && segp == cur.offset(3 as ::core::ffi::c_int as isize)
            || (*segp.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int != '.' as i32
                || *segp.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                    != '.' as i32
                || *segp.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                    != '/' as i32
                    && *segp.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                        != '\0' as i32)
        {
            cur = segp;
        } else if *segp.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
            == '\0' as i32
        {
            *cur.offset(0 as ::core::ffi::c_int as isize) = '\0' as i32 as ::core::ffi::c_char;
            break;
        } else {
            tmp = cur;
            segp = segp.offset(3 as ::core::ffi::c_int as isize);
            loop {
                let fresh64 = segp;
                segp = segp.offset(1);
                let fresh65 = tmp;
    ...
    *out.offset(0 as ::core::ffi::c_int as isize) = '\0' as i32 as ::core::ffi::c_char;
    if *path.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '/' as i32 {
        ...
        if cur != path {
            out = path;
            while *cur.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int != '\0' as i32
            {
                let fresh66 = cur;
                cur = cur.offset(1);
                let fresh67 = out;
                out = out.offset(1);
                *fresh67.offset(0 as ::core::ffi::c_int as isize) =
                    *fresh66.offset(0 as ::core::ffi::c_int as isize);
            }
...
unsafe extern "C" fn is_hex(mut c: ::core::ffi::c_char) -> ::core::ffi::c_int {
...
pub unsafe extern "C" fn xmlURIUnescapeString(
    ...
    mut target: *mut ::core::ffi::c_char,
) -> *mut ::core::ffi::c_char {
    ...
    while len > 0 as ::core::ffi::c_int {
        if len > 2 as ::core::ffi::c_int
            ...
            && is_hex(*in_0.offset(1 as ::core::ffi::c_int as isize)) != 0
            && is_hex(*in_0.offset(2 as ::core::ffi::c_int as isize)) != 0
        {
            let mut c: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
            in_0 = in_0.offset(1);
            if *in_0 as ::core::ffi::c_int >= '0' as i32
                && *in_0 as ::core::ffi::c_int <= '9' as i32
            {
                c = *in_0 as ::core::ffi::c_int - '0' as i32;
            } else if *in_0 as ::core::ffi::c_int >= 'a' as i32
                && *in_0 as ::core::ffi::c_int <= 'f' as i32
            {
                c = *in_0 as ::core::ffi::c_int - 'a' as i32 + 10 as ::core::ffi::c_int;
            } else if *in_0 as ::core::ffi::c_int >= 'A' as i32
                && *in_0 as ::core::ffi::c_int <= 'F' as i32
            {
                c = *in_0 as ::core::ffi::c_int - 'A' as i32 + 10 as ::core::ffi::c_int;
            ...
            if *in_0 as ::core::ffi::c_int >= '0' as i32
                && *in_0 as ::core::ffi::c_int <= '9' as i32
            {
                c = c * 16 as ::core::ffi::c_int + (*in_0 as ::core::ffi::c_int - '0' as i32);
            } else if *in_0 as ::core::ffi::c_int >= 'a' as i32
                && *in_0 as ::core::ffi::c_int <= 'f' as i32
            {
                c = c * 16 as ::core::ffi::c_int
                    + (*in_0 as ::core::ffi::c_int - 'a' as i32)
...
pub unsafe extern "C" fn xmlURIEscapeStr(
    ...
    ret = xmlMallocAtomic.expect("non-null function pointer")(len as size_t) as *mut xmlChar;
    if ret.is_null() {
    ...
    while *in_0 as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
        if len - out <= 3 as ::core::ffi::c_int {
            temp = xmlSaveUriRealloc(ret, &raw mut len);
            if temp.is_null() {
                xmlURIErrMemory(
        ...
        if ch as ::core::ffi::c_int != '@' as i32
            && !(ch as ::core::ffi::c_int >= 'a' as i32 && ch as ::core::ffi::c_int <= 'z' as i32
                || ch as ::core::ffi::c_int >= 'A' as i32 && ch as ::core::ffi::c_int <= 'Z' as i32
                || ch as ::core::ffi::c_int >= '0' as i32 && ch as ::core::ffi::c_int <= '9' as i32
        ...
        {
            let mut val: ::core::ffi::c_uchar = 0;
            let fresh74 = out;
            out = out + 1;
            *ret.offset(fresh74 as isize) = '%' as i32 as xmlChar;
            val = (ch as ::core::ffi::c_int >> 4 as ::core::ffi::c_int) as ::core::ffi::c_uchar;
            if val as ::core::ffi::c_int <= 9 as ::core::ffi::c_int {
                let fresh75 = out;
                out = out + 1;
                *ret.offset(fresh75 as isize) = ('0' as i32 + val as ::core::ffi::c_int) as xmlChar;
            } else {
                let fresh76 = out;
                out = out + 1;
                *ret.offset(fresh76 as isize) =
                    ('A' as i32 + val as ::core::ffi::c_int - 0xa as ::core::ffi::c_int) as xmlChar;
            }
            val = (ch as ::core::ffi::c_int & 0xf as ::core::ffi::c_int) as ::core::ffi::c_uchar;
            if val as ::core::ffi::c_int <= 9 as ::core::ffi::c_int {
                let fresh77 = out;
                out = out + 1;
                *ret.offset(fresh77 as isize) = ('0' as i32 + val as ::core::ffi::c_int) as xmlChar;
            } else {
                let fresh78 = out;
                out = out + 1;
                *ret.offset(fresh78 as isize) =
                    ('A' as i32 + val as ::core::ffi::c_int - 0xa as ::core::ffi::c_int) as xmlChar;
            }
            in_0 = in_0.offset(1);
        } else {
            ...
            let fresh80 = out;
            out = out + 1;
            *ret.offset(fresh80 as isize) = *fresh79;
        }
    }
    *ret.offset(out as isize) = 0 as xmlChar;
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn xmlURIEscape(mut str: *const xmlChar) -> *mut xmlChar {
    let mut ret: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut segment: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut uri: xmlURIPtr = ::core::ptr::null_mut::<xmlURI>();
    ...
    uri = xmlCreateURI();
    if !uri.is_null() {
        (*uri).cleanup = 1 as ::core::ffi::c_int;
        ret2 = xmlParseURIReference(uri, str as *const ::core::ffi::c_char);
        if ret2 != 0 {
            xmlFreeURI(uri);
            return ::core::ptr::null_mut::<xmlChar>();
        }
    ...
    if !(*uri).scheme.is_null() {
        ...
        xmlFree.expect("non-null function pointer")(segment as *mut ::core::ffi::c_void);
    }
    if !(*uri).authority.is_null() {
        segment = xmlURIEscapeStr(
    ...
    if (*uri).port != 0 {
        ...
        snprintf(
            &raw mut port as *mut xmlChar as *mut ::core::ffi::c_char,
            10 as size_t,
        ...
        ret = xmlStrcat(ret, &raw mut port as *mut xmlChar);
    }
    if !(*uri).path.is_null() {
        segment = xmlURIEscapeStr(
...
pub unsafe extern "C" fn xmlBuildURI(
    ...
    let mut out: ::core::ffi::c_int = 0;
    let mut ref_0: xmlURIPtr = ::core::ptr::null_mut::<xmlURI>();
    let mut bas: xmlURIPtr = ::core::ptr::null_mut::<xmlURI>();
    let mut res: xmlURIPtr = ::core::ptr::null_mut::<xmlURI>();
    if URI.is_null() {
        ...
        ref_0 = xmlCreateURI();
        if ref_0.is_null() {
            current_block = 3351409986747844373;
        } else {
            ret = xmlParseURIReference(ref_0, URI as *const ::core::ffi::c_char);
            current_block = 17216689946888361452;
        }
    } else {
                ...
                if !ref_0.is_null() && !(*ref_0).scheme.is_null() {
                    ...
                    if base.is_null() {
                        ...
                        if bas.is_null() {
                            ...
                            ret = xmlParseURIReference(bas, base as *const ::core::ffi::c_char);
                            current_block = 13056961889198038528;
                        }
                    }
                    match current_block {
                        ...
                        _ => {
                            if ret != 0 as ::core::ffi::c_int {
                                ...
                                if !(*bas).fragment.is_null() {
                                    xmlFree.expect("non-null function pointer")(
                                        (*bas).fragment as *mut ::core::ffi::c_void,
                                    );
                                    (*bas).fragment =
                                        ::core::ptr::null_mut::<::core::ffi::c_char>();
                                }
                                ...
                                if !res.is_null() {
                                            ...
                                            && (*ref_0).server.is_null())
                                    {
                                        if !(*bas).scheme.is_null() {
                                            (*res).scheme = xmlMemStrdup
                                                .expect("non-null function pointer")(
                                                (*bas).scheme
                                            );
                                        }
                                        if !(*bas).authority.is_null() {
                                            (*res).authority = xmlMemStrdup
                                                .expect("non-null function pointer")(
                                                (*bas).authority,
                                            );
                                        } else if !(*bas).server.is_null()
                                            || (*bas).port == -(1 as ::core::ffi::c_int)
                                        {
                                            if !(*bas).server.is_null() {
                                                (*res).server = xmlMemStrdup
                                                    .expect("non-null function pointer")(
                                                    (*bas).server,
                                                );
                                            }
                                            if !(*bas).user.is_null() {
                                                (*res).user = xmlMemStrdup
                                                    .expect("non-null function pointer")(
                                                    (*bas).user,
                                                );
                                            }
                                        ...
                                        if !(*bas).path.is_null() {
                                            (*res).path = xmlMemStrdup
                                                .expect("non-null function pointer")(
                                                (*bas).path
                                            );
                                        }
                                        if !(*ref_0).query_raw.is_null() {
                                            (*res).query_raw = xmlMemStrdup
                                                .expect("non-null function pointer")(
                                                (*ref_0).query_raw,
                                            );
                                        } else if !(*ref_0).query.is_null() {
                                            (*res).query = xmlMemStrdup
                                                .expect("non-null function pointer")(
                                                (*ref_0).query,
                                            );
                                        ...
                                        if !(*ref_0).fragment.is_null() {
                                            (*res).fragment = xmlMemStrdup
                                                .expect("non-null function pointer")(
                                                (*ref_0).fragment,
                                            );
                                        }
                                        current_block = 11971158220057855935;
                                            ...
                                            || !(*ref_0).server.is_null()
                                        {
                                                    ...
                                                    == '/' as i32
                                            {
                                                ...
                                                if !(*ref_0).path.is_null() {
                                                    len = (len as size_t)
                                                        .wrapping_add(strlen((*ref_0).path))
                                                        as ::core::ffi::c_int
                                                        as ::core::ffi::c_int;
                                                }
                                                if !(*bas).path.is_null() {
                                                    len = (len as size_t)
                                                        .wrapping_add(strlen((*bas).path))
                                                        as ::core::ffi::c_int
                                                        as ::core::ffi::c_int;
                                                }
                                                (*res).path = xmlMallocAtomic
                                                    .expect("non-null function pointer")(
                                                    len as size_t,
                                                )
                                                    as *mut ::core::ffi::c_char;
                                                if (*res).path.is_null() {
                                                    ...
                                                    *(*res)
                                                    ...
                                                    out = 0 as ::core::ffi::c_int;
                                                    if !(*bas).path.is_null() {
                                                        while *(*bas).path.offset(cur as isize)
                                                            as ::core::ffi::c_int
                                                            != 0 as ::core::ffi::c_int
                                                        {
                                                            while *(*bas).path.offset(cur as isize)
                                                                as ::core::ffi::c_int
                                                                != 0 as ::core::ffi::c_int
                                                                && *(*bas).path.offset(cur as isize)
                                                                    as ::core::ffi::c_int
                                                                    != '/' as i32
                                                            {
                                                                cur += 1;
                                                            }
                                                            if *(*bas).path.offset(cur as isize)
                                                                as ::core::ffi::c_int
                                                                == 0 as ::core::ffi::c_int
                                                            {
                                                                break;
                                                    ...
                                                    *(*res).path.offset(out as isize) =
                                                            ...
                                                            != 0 as ::core::ffi::c_int
                                                    {
                                                            ...
                                                            && !(*bas).server.is_null()
                                                        {
                                                            let fresh0 = out;
                                                            out = out + 1;
                                                            *(*res).path.offset(fresh0 as isize) =
                                                                '/' as i32 as ::core::ffi::c_char;
                                                        }
                                                        while *(*ref_0).path.offset(indx as isize)
                                                            as ::core::ffi::c_int
                                                            != 0 as ::core::ffi::c_int
                                                        {
                                                            let fresh1 = indx;
                                                            ...
                                                            let fresh2 = out;
                                                            out = out + 1;
                                                            *(*res).path.offset(fresh2 as isize) =
                                                                *(*ref_0)
                                                                    .path
...
pub unsafe extern "C" fn xmlBuildRelativeURI(
    ...
    let mut nbslash: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut len: ::core::ffi::c_int = 0;
    let mut ref_0: xmlURIPtr = ::core::ptr::null_mut::<xmlURI>();
    let mut bas: xmlURIPtr = ::core::ptr::null_mut::<xmlURI>();
    let mut bptr: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut uptr: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut vptr: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut remove_path: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    if URI.is_null() || *URI as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
        return ::core::ptr::null_mut::<xmlChar>();
    }
    ref_0 = xmlCreateURI();
    if ref_0.is_null() {
    ...
    if *URI.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int != '.' as i32 {
        ret = xmlParseURIReference(ref_0, URI as *const ::core::ffi::c_char);
        if ret != 0 as ::core::ffi::c_int {
            current_block = 18221691387828887330;
        } else {
            current_block = 2868539653012386629;
        }
    } else {
        (*ref_0).path = xmlStrdup(URI) as *mut ::core::ffi::c_char;
        current_block = 2868539653012386629;
    }
    match current_block {
        2868539653012386629 => {
            if base.is_null() || *base as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                val = xmlStrdup(URI);
            } else {
                bas = xmlCreateURI();
                if !bas.is_null() {
                    if *base.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                        != '.' as i32
                    {
                        ret = xmlParseURIReference(bas, base as *const ::core::ffi::c_char);
                        if ret != 0 as ::core::ffi::c_int {
                        ...
                        (*bas).path = xmlStrdup(base) as *mut ::core::ffi::c_char;
                        current_block = 6009453772311597924;
                    }
                    match current_block {
                        18221691387828887330 => {}
                        _ => {
                            if !(*ref_0).scheme.is_null()
                                && ((*bas).scheme.is_null()
                                    || xmlStrcmp(
                            ...
                            ) != 0
                            {
                                ...
                                if (*ref_0).path.is_null() {
                                    (*ref_0).path = b"/\0" as *const u8
                                        as *const ::core::ffi::c_char
                                        as *mut ::core::ffi::c_char;
                                    remove_path = 1 as ::core::ffi::c_int;
                                }
                                ...
                                if *rptr as ::core::ffi::c_int == '.' as i32
                                    && *rptr.offset(1 as ::core::ffi::c_int as isize)
                                        as ::core::ffi::c_int
                                        == '/' as i32
                                {
                                    rptr = rptr.offset(2 as ::core::ffi::c_int as isize);
                                }
                                if *bptr as ::core::ffi::c_int == '.' as i32
                                    && *bptr.offset(1 as ::core::ffi::c_int as isize)
                                        as ::core::ffi::c_int
                                        == '/' as i32
                                {
                                    bptr = bptr.offset(2 as ::core::ffi::c_int as isize);
                                } else if *bptr as ::core::ffi::c_int == '/' as i32
                                    && *rptr as ::core::ffi::c_int != '/' as i32
                                {
                                    bptr = bptr.offset(1);
                                }
                                while *bptr.offset(pos as isize) as ::core::ffi::c_int
                                    == *rptr.offset(pos as isize) as ::core::ffi::c_int
                                    && *bptr.offset(pos as isize) as ::core::ffi::c_int
                                        != 0 as ::core::ffi::c_int
                                {
                                    pos += 1;
                                }
                                if *bptr.offset(pos as isize) as ::core::ffi::c_int
                                    == *rptr.offset(pos as isize) as ::core::ffi::c_int
                                {
                                    val = xmlStrdup(
                                        b"\0" as *const u8 as *const ::core::ffi::c_char
                                    ...
                                    while ix > 0 as ::core::ffi::c_int {
                                        if *rptr.offset((ix - 1 as ::core::ffi::c_int) as isize)
                                            as ::core::ffi::c_int
                                            == '/' as i32
                                        {
                                            break;
                                    ...
                                    uptr = rptr.offset(ix as isize) as *mut xmlChar;
                                    while *bptr.offset(ix as isize) as ::core::ffi::c_int
                                        != 0 as ::core::ffi::c_int
                                    {
                                        if *bptr.offset(ix as isize) as ::core::ffi::c_int
                                            == '/' as i32
                                        {
                                            nbslash += 1;
                                        }
                                    ...
                                    if nbslash == 0 as ::core::ffi::c_int
                                        && *uptr.offset(0 as ::core::ffi::c_int as isize) == 0
                                    {
                                        val = xmlStrdup(
                                            b"./\0" as *const u8 as *const ::core::ffi::c_char
                                                as *mut xmlChar,
                                        ...
                                        len = xmlStrlen(uptr) + 1 as ::core::ffi::c_int;
                                        if nbslash == 0 as ::core::ffi::c_int {
                                            if !uptr.is_null() {
                                                val = xmlURIEscapeStr(
                                                    uptr,
                                            ...
                                            val = xmlMalloc.expect("non-null function pointer")(
                                                (len + 3 as ::core::ffi::c_int * nbslash) as size_t,
                                            )
                                                as *mut xmlChar;
                                            if val.is_null() {
                                                xmlURIErrMemory(
                                                ...
                                                vptr = val;
                                                while nbslash > 0 as ::core::ffi::c_int {
                                                    let fresh71 = vptr;
                                                    vptr = vptr.offset(1);
                                                    *fresh71 = '.' as i32 as xmlChar;
                                                    let fresh72 = vptr;
                                                    vptr = vptr.offset(1);
                                                    *fresh72 = '.' as i32 as xmlChar;
                                                    let fresh73 = vptr;
                                                    vptr = vptr.offset(1);
    ...
    if remove_path != 0 as ::core::ffi::c_int {
        (*ref_0).path = ::core::ptr::null_mut::<::core::ffi::c_char>();
    }
    if !ref_0.is_null() {
        xmlFreeURI(ref_0);
    }
...
pub unsafe extern "C" fn xmlCanonicPath(mut path: *const xmlChar) -> *mut xmlChar {
    ...
    let mut uri: xmlURIPtr = ::core::ptr::null_mut::<xmlURI>();
    let mut ret: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut absuri: *const xmlChar = ::core::ptr::null::<xmlChar>();
    if path.is_null() {
        return ::core::ptr::null_mut::<xmlChar>();
    }
    if *path.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '/' as i32
        && *path.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '/' as i32
        && *path.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int != '/' as i32
    {
        path = path.offset(1);
    }
    uri = xmlParseURI(path as *const ::core::ffi::c_char);
    if !uri.is_null() {
        xmlFreeURI(uri);
    ...
    if !absuri.is_null() {
        ...
        let mut escURI: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
        l = absuri.offset_from(path) as ::core::ffi::c_long as ::core::ffi::c_int;
        if !(l <= 0 as ::core::ffi::c_int || l > 20 as ::core::ffi::c_int) {
            ...
            match current_block {
                ...
                _ => {
                    escURI = xmlURIEscapeStr(
                        path,
                        b":/?_.#&;=\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
                    );
                    if !escURI.is_null() {
                        uri = xmlParseURI(escURI as *const ::core::ffi::c_char);
                        if !uri.is_null() {
                            xmlFreeURI(uri);
                            return escURI;
                        }
                        xmlFree.expect("non-null function pointer")(
                            escURI as *mut ::core::ffi::c_void,
                        );
                    }
                }
            }
...
pub unsafe extern "C" fn xmlPathToURI(mut path: *const xmlChar) -> *mut xmlChar {
    ...
    let mut temp: xmlURI = _xmlURI {
        ...
        opaque: ::core::ptr::null_mut::<::core::ffi::c_char>(),
        authority: ::core::ptr::null_mut::<::core::ffi::c_char>(),
        server: ::core::ptr::null_mut::<::core::ffi::c_char>(),
        ...
        cleanup: 0,
        query_raw: ::core::ptr::null_mut::<::core::ffi::c_char>(),
    };
    let mut ret: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut cal: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    if path.is_null() {
        return ::core::ptr::null_mut::<xmlChar>();
    }
    uri = xmlParseURI(path as *const ::core::ffi::c_char);
    ...
    temp.path = cal as *mut ::core::ffi::c_char;
    ret = xmlSaveUri(&raw mut temp);
    xmlFree.expect("non-null function pointer")(cal as *mut ::core::ffi::c_void);
    return ret;
}
