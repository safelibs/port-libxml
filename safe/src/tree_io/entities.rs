...
extern "C" {
    ...
    fn xmlBufferCCat(buf: xmlBufferPtr, str: *const ::core::ffi::c_char) -> ::core::ffi::c_int;
...
static mut xmlEntityLt: xmlEntity = _xmlEntity {
    _private: NULL,
    type_0: XML_ENTITY_DECL,
    name: b"lt\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
    children: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    last: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    parent: ::core::ptr::null::<_xmlDtd>() as *mut _xmlDtd,
    next: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    prev: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    doc: ::core::ptr::null::<_xmlDoc>() as *mut _xmlDoc,
    orig: b"<\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
    content: b"<\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
    length: 1 as ::core::ffi::c_int,
    etype: XML_INTERNAL_PREDEFINED_ENTITY,
    ExternalID: ::core::ptr::null::<xmlChar>(),
    SystemID: ::core::ptr::null::<xmlChar>(),
    nexte: ::core::ptr::null::<_xmlEntity>() as *mut _xmlEntity,
    URI: ::core::ptr::null::<xmlChar>(),
    owner: 0 as ::core::ffi::c_int,
    checked: 1 as ::core::ffi::c_int,
};
static mut xmlEntityGt: xmlEntity = _xmlEntity {
    _private: NULL,
    type_0: XML_ENTITY_DECL,
    name: b"gt\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
    children: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    last: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    parent: ::core::ptr::null::<_xmlDtd>() as *mut _xmlDtd,
    next: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
...
static mut xmlEntityAmp: xmlEntity = _xmlEntity {
    _private: NULL,
    type_0: XML_ENTITY_DECL,
    name: b"amp\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
    children: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    last: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    parent: ::core::ptr::null::<_xmlDtd>() as *mut _xmlDtd,
    next: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
...
static mut xmlEntityQuot: xmlEntity = _xmlEntity {
    _private: NULL,
    type_0: XML_ENTITY_DECL,
    name: b"quot\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
    children: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    last: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    parent: ::core::ptr::null::<_xmlDtd>() as *mut _xmlDtd,
    next: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
...
static mut xmlEntityApos: xmlEntity = _xmlEntity {
    _private: NULL,
    type_0: XML_ENTITY_DECL,
    name: b"apos\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
    children: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    last: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
    parent: ::core::ptr::null::<_xmlDtd>() as *mut _xmlDtd,
    next: ::core::ptr::null::<_xmlNode>() as *mut _xmlNode,
...
unsafe extern "C" fn xmlEntitiesErrMemory(mut extra: *const ::core::ffi::c_char) {
    __xmlSimpleError(
...
unsafe extern "C" fn xmlFreeEntity(mut entity: xmlEntityPtr) {
    ...
    if !(*entity).doc.is_null() {
        dict = (*(*entity).doc).dict as xmlDictPtr;
    }
    if !(*entity).children.is_null()
        && (*entity).owner == 1 as ::core::ffi::c_int
        && entity == (*(*entity).children).parent as xmlEntityPtr
    {
        xmlFreeNodeList((*entity).children as xmlNodePtr);
    }
    if !(*entity).name.is_null() && (dict.is_null() || xmlDictOwns(dict, (*entity).name) == 0) {
        xmlFree.expect("non-null function pointer")(
            (*entity).name as *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
        );
    }
    if !(*entity).ExternalID.is_null() {
        xmlFree.expect("non-null function pointer")(
            (*entity).ExternalID as *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
        );
    }
    if !(*entity).SystemID.is_null() {
        xmlFree.expect("non-null function pointer")(
            (*entity).SystemID as *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
        );
    }
    if !(*entity).URI.is_null() {
        xmlFree.expect("non-null function pointer")(
            (*entity).URI as *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
        );
    }
    if !(*entity).content.is_null() {
        xmlFree.expect("non-null function pointer")(
            (*entity).content as *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
        );
    }
    if !(*entity).orig.is_null() {
        xmlFree.expect("non-null function pointer")(
            (*entity).orig as *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
        );
    }
    xmlFree.expect("non-null function pointer")(entity as *mut ::core::ffi::c_void);
}
unsafe extern "C" fn xmlCreateEntity(
    ...
    ret = xmlMalloc.expect("non-null function pointer")(
        ::core::mem::size_of::<xmlEntity>() as size_t
    ) as xmlEntityPtr;
    if ret.is_null() {
        xmlEntitiesErrMemory(
            b"xmlCreateEntity: malloc failed\0" as *const u8 as *const ::core::ffi::c_char,
        );
    ...
    (*ret).checked = 0 as ::core::ffi::c_int;
    ...
    if !content.is_null() {
        ...
        (*ret).length = 0 as ::core::ffi::c_int;
        (*ret).content = ::core::ptr::null_mut::<xmlChar>();
    }
    (*ret).URI = ::core::ptr::null::<xmlChar>();
    (*ret).orig = ::core::ptr::null_mut::<xmlChar>();
    (*ret).owner = 0 as ::core::ffi::c_int;
    return ret;
}
unsafe extern "C" fn xmlAddEntity(
    ...
    let mut ret: xmlEntityPtr = ::core::ptr::null_mut::<xmlEntity>();
    let mut predef: xmlEntityPtr = ::core::ptr::null_mut::<xmlEntity>();
    if name.is_null() {
        return ::core::ptr::null_mut::<xmlEntity>();
    }
    if dtd.is_null() {
    ...
    match type_0 {
        1 | 2 | 3 => {
            ...
            if !predef.is_null() {
                ...
                if type_0 == XML_INTERNAL_GENERAL_ENTITY as ::core::ffi::c_int && !content.is_null()
                {
                    let mut c: ::core::ffi::c_int =
                        *(*predef).content.offset(0 as ::core::ffi::c_int as isize)
                            as ::core::ffi::c_int;
                    if *content.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == c
                        && *content.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                            == 0 as ::core::ffi::c_int
                        && (c == '>' as i32 || c == '\'' as i32 || c == '"' as i32)
                    {
                        valid = 1 as ::core::ffi::c_int;
                    } else if *content.offset(0 as ::core::ffi::c_int as isize)
                        as ::core::ffi::c_int
                        == '&' as i32
                        && *content.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                            == '#' as i32
                    {
                        if *content.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                            == 'x' as i32
                        {
                            let mut hex: *mut xmlChar = b"0123456789ABCDEF\0" as *const u8
                                as *const ::core::ffi::c_char
                                as *mut xmlChar;
                            let mut ref_0: [xmlChar; 4] =
                                ::core::mem::transmute::<[u8; 4], [xmlChar; 4]>(*b"00;\0");
                            ref_0[0 as ::core::ffi::c_int as usize] = *hex.offset(
                                (c / 16 as ::core::ffi::c_int % 16 as ::core::ffi::c_int) as isize,
                            );
                            ref_0[1 as ::core::ffi::c_int as usize] =
                                *hex.offset((c % 16 as ::core::ffi::c_int) as isize);
                            if xmlStrcasecmp(
                                content.offset(3 as ::core::ffi::c_int as isize) as *const xmlChar,
                                &raw mut ref_0 as *mut xmlChar,
                            ) == 0 as ::core::ffi::c_int
                            {
                                valid = 1 as ::core::ffi::c_int;
                            }
                        } else {
                            let mut ref_1: [xmlChar; 4] =
                                ::core::mem::transmute::<[u8; 4], [xmlChar; 4]>(*b"00;\0");
                            ref_1[0 as ::core::ffi::c_int as usize] = ('0' as i32
                                + c / 10 as ::core::ffi::c_int % 10 as ::core::ffi::c_int)
                                as xmlChar;
                            ref_1[1 as ::core::ffi::c_int as usize] =
                                ('0' as i32 + c % 10 as ::core::ffi::c_int) as xmlChar;
                            if xmlStrEqual(
                                content.offset(2 as ::core::ffi::c_int as isize) as *const xmlChar,
                                &raw mut ref_1 as *mut xmlChar,
                            ) != 0
                            {
                                valid = 1 as ::core::ffi::c_int;
                            }
                ...
                if valid == 0 {
                    xmlEntitiesErr(
                        ...
                        b"xmlAddEntity: invalid redeclaration of predefined entity\0" as *const u8
                            as *const ::core::ffi::c_char,
                    );
                    return ::core::ptr::null_mut::<xmlEntity>();
                }
            ...
            if (*dtd).entities.is_null() {
                (*dtd).entities =
                    xmlHashCreateDict(0 as ::core::ffi::c_int, dict) as *mut ::core::ffi::c_void;
            }
        ...
        6 => return ::core::ptr::null_mut::<xmlEntity>(),
        _ => {}
    }
    if table.is_null() {
        return ::core::ptr::null_mut::<xmlEntity>();
...
#[no_mangle]
pub unsafe extern "C" fn xmlGetPredefinedEntity(mut name: *const xmlChar) -> xmlEntityPtr {
    if name.is_null() {
        return ::core::ptr::null_mut::<xmlEntity>();
    }
    match *name.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int {
        108 => {
            if xmlStrEqual(
                name,
                b"lt\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return &raw mut xmlEntityLt;
            }
        }
        103 => {
            if xmlStrEqual(
                name,
                b"gt\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return &raw mut xmlEntityGt;
            }
        }
        97 => {
            if xmlStrEqual(
                name,
                b"amp\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return &raw mut xmlEntityAmp;
            }
            if xmlStrEqual(
                name,
                b"apos\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return &raw mut xmlEntityApos;
            }
        }
        113 => {
            if xmlStrEqual(
                name,
                b"quot\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return &raw mut xmlEntityQuot;
            }
        }
        _ => {}
    }
...
pub unsafe extern "C" fn xmlAddDtdEntity(
    ...
    if doc.is_null() {
        xmlEntitiesErr(
            XML_DTD_NO_DOC,
            b"xmlAddDtdEntity: document is NULL\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return ::core::ptr::null_mut::<xmlEntity>();
    }
...
pub unsafe extern "C" fn xmlAddDocEntity(
    ...
    if doc.is_null() {
        xmlEntitiesErr(
            XML_DTD_NO_DOC,
            b"xmlAddDocEntity: document is NULL\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return ::core::ptr::null_mut::<xmlEntity>();
    }
...
unsafe extern "C" fn xmlEncodeEntitiesInternal(
    ...
    let mut html: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    if input.is_null() {
        return ::core::ptr::null_mut::<xmlChar>();
    }
    if !doc.is_null() {
        html = ((*doc).type_0 as ::core::ffi::c_uint
            == XML_HTML_DOCUMENT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint)
            as ::core::ffi::c_int;
    }
    buffer_size = 1000 as size_t;
    buffer = xmlMalloc.expect("non-null function pointer")(
        buffer_size.wrapping_mul(::core::mem::size_of::<xmlChar>() as size_t),
    ) as *mut xmlChar;
    if buffer.is_null() {
        xmlEntitiesErrMemory(
            b"xmlEncodeEntities: malloc failed\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return ::core::ptr::null_mut::<xmlChar>();
    }
    out = buffer;
    's_48: loop {
        ...
        let mut indx: size_t = out.offset_from(buffer) as ::core::ffi::c_long as size_t;
        if indx.wrapping_add(100 as size_t) > buffer_size {
            let mut tmp: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
            let mut new_size: size_t = buffer_size.wrapping_mul(2 as size_t);
            if new_size < buffer_size {
                current_block = 10426613377466673;
                break;
            }
        ...
        if *cur as ::core::ffi::c_int == '<' as i32 {
                ...
                }
            {
                while cur != end {
                    ...
                    out = out.offset(1);
                    *fresh1 = *fresh0;
                    indx = out.offset_from(buffer) as ::core::ffi::c_long as size_t;
                    if !(indx.wrapping_add(100 as size_t) > buffer_size) {
                        continue;
                    }
                    let mut tmp_0: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
                    let mut new_size_0: size_t = buffer_size.wrapping_mul(2 as size_t);
            ...
            *fresh15 = ';' as i32 as xmlChar;
            ...
            if html != 0
                && attr != 0
                && *cur.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == '{' as i32
                && !strchr(cur as *const ::core::ffi::c_char, '}' as i32).is_null()
            {
                while *cur as ::core::ffi::c_int != '}' as i32 {
                    ...
                    *fresh17 = *fresh16;
                    ...
                    let mut new_size_1: size_t = buffer_size.wrapping_mul(2 as size_t);
        ...
        } else if *cur as ::core::ffi::c_int >= 0x20 as ::core::ffi::c_int
            && (*cur as ::core::ffi::c_int) < 0x80 as ::core::ffi::c_int
            || *cur as ::core::ffi::c_int == '\n' as i32
            || *cur as ::core::ffi::c_int == '\t' as i32
            || html != 0 && *cur as ::core::ffi::c_int == '\r' as i32
        {
            let fresh25 = out;
            out = out.offset(1);
            *fresh25 = *cur;
        } else if *cur as ::core::ffi::c_int >= 0x80 as ::core::ffi::c_int {
            if !doc.is_null() && !(*doc).encoding.is_null() || html != 0 {
                let fresh26 = out;
                out = out.offset(1);
                *fresh26 = *cur;
            } else {
                let mut buf: [::core::ffi::c_char; 11] = [0; 11];
                        ...
                        == 0xf8 as ::core::ffi::c_int
                {
                    ...
                    buf[(::core::mem::size_of::<[::core::ffi::c_char; 11]>() as usize)
                        ...
                        || (if val < 0x100 as ::core::ffi::c_int {
                            ...
                            (0x100 as ::core::ffi::c_int <= val
                                ...
                                || 0x10000 as ::core::ffi::c_int <= val
                                    && val <= 0x10ffff as ::core::ffi::c_int)
                                as ::core::ffi::c_int
                        }) == 0
                    {
                        xmlEntitiesErr(
        ...
        } else if 0x9 as ::core::ffi::c_int <= *cur as ::core::ffi::c_int
        ...
        {
            let mut buf_0: [::core::ffi::c_char; 11] = [0; 11];
            ...
            buf_0[(::core::mem::size_of::<[::core::ffi::c_char; 11]>() as usize)
                .wrapping_sub(1 as usize) as usize] = 0 as ::core::ffi::c_char;
            ptr_0 = &raw mut buf_0 as *mut ::core::ffi::c_char;
            while *ptr_0 as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                let fresh33 = ptr_0;
    ...
    match current_block {
        10426613377466673 => {
            xmlEntitiesErrMemory(
                b"xmlEncodeEntities: realloc failed\0" as *const u8 as *const ::core::ffi::c_char,
            );
...
pub unsafe extern "C" fn xmlEncodeAttributeEntities(
    ...
    return xmlEncodeEntitiesInternal(doc, input, 1 as ::core::ffi::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn xmlEncodeEntitiesReentrant(
    ...
    return xmlEncodeEntitiesInternal(doc, input, 0 as ::core::ffi::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn xmlEncodeSpecialChars(
    ...
    if buffer.is_null() {
        xmlEntitiesErrMemory(
            b"xmlEncodeSpecialChars: malloc failed\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return ::core::ptr::null_mut::<xmlChar>();
    }
    out = buffer;
    loop {
        ...
        let mut indx: size_t = out.offset_from(buffer) as ::core::ffi::c_long as size_t;
        if indx.wrapping_add(10 as size_t) > buffer_size {
            let mut tmp: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
            let mut new_size: size_t = buffer_size.wrapping_mul(2 as size_t);
            if new_size < buffer_size {
                current_block = 5103034964674390864;
                break;
            }
            tmp = xmlRealloc.expect("non-null function pointer")(
                buffer as *mut ::core::ffi::c_void,
...
pub unsafe extern "C" fn xmlCreateEntitiesTable() -> xmlEntitiesTablePtr {
    return xmlHashCreate(0 as ::core::ffi::c_int) as xmlEntitiesTablePtr;
}
...
unsafe extern "C" fn xmlCopyEntity(
    ...
    if cur.is_null() {
        xmlEntitiesErrMemory(
            b"xmlCopyEntity:: malloc failed\0" as *const u8 as *const ::core::ffi::c_char,
        );
...
unsafe extern "C" fn xmlDumpEntityContent(mut buf: xmlBufferPtr, mut content: *const xmlChar) {
...
#[no_mangle]
pub unsafe extern "C" fn xmlDumpEntityDecl(mut buf: xmlBufferPtr, mut ent: xmlEntityPtr) {
    ...
    match (*ent).etype as ::core::ffi::c_uint {
        ...
        3 => {
            ...
            if !(*ent).content.is_null() {
                xmlBufferWriteChar(buf, b" NDATA \0" as *const u8 as *const ::core::ffi::c_char);
                if !(*ent).orig.is_null() {
