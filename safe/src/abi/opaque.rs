...
opaque_type!(_xmlSchemaFacet);
opaque_type!(_xmlSchemaParserCtxt);
opaque_type!(_xmlSchemaValidCtxt);
opaque_type!(_xmlSchemaSAXPlug);
opaque_type!(_xmlSchemaType);
opaque_type!(_xmlSchemaVal);
opaque_type!(_xmlSchemaWildcard);
opaque_type!(_xmlSchematron);
opaque_type!(_xmlSchematronParserCtxt);
opaque_type!(_xmlSchematronValidCtxt);
