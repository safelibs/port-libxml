...
pub unsafe extern "C" fn htmlDecodeEntities(
    ...
    if deprecated == 0 {
        ...
        deprecated = 1 as ::core::ffi::c_int;
    }
...
static mut xmlFeaturesList: [*const ::core::ffi::c_char; 42] = [
    b"validate\0" as *const u8 as *const ::core::ffi::c_char,
    b"load subset\0" as *const u8 as *const ::core::ffi::c_char,
    b"keep blanks\0" as *const u8 as *const ::core::ffi::c_char,
    b"disable SAX\0" as *const u8 as *const ::core::ffi::c_char,
    b"fetch external entities\0" as *const u8 as *const ::core::ffi::c_char,
    b"substitute entities\0" as *const u8 as *const ::core::ffi::c_char,
    b"gather line info\0" as *const u8 as *const ::core::ffi::c_char,
    ...
    b"stop parser\0" as *const u8 as *const ::core::ffi::c_char,
    b"document\0" as *const u8 as *const ::core::ffi::c_char,
    b"is well formed\0" as *const u8 as *const ::core::ffi::c_char,
    b"is valid\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX block\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function internalSubset\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function isStandalone\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function hasInternalSubset\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function hasExternalSubset\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function resolveEntity\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function getEntity\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function entityDecl\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function notationDecl\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function attributeDecl\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function elementDecl\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function unparsedEntityDecl\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function setDocumentLocator\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function startDocument\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function endDocument\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function startElement\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function endElement\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function reference\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function characters\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function ignorableWhitespace\0" as *const u8 as *const ::core::ffi::c_char,
    ...
    b"SAX function warning\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function error\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function fatalError\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function getParameterEntity\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function cdataBlock\0" as *const u8 as *const ::core::ffi::c_char,
    b"SAX function externalSubset\0" as *const u8 as *const ::core::ffi::c_char,
];
#[no_mangle]
pub unsafe extern "C" fn xmlGetFeaturesList(
    ...
    ret = (::core::mem::size_of::<[*const ::core::ffi::c_char; 42]>() as usize)
        .wrapping_div(::core::mem::size_of::<*const ::core::ffi::c_char>() as usize)
        as ::core::ffi::c_int;
    if len.is_null() || result.is_null() {
        return ret;
    }
    if *len < 0 as ::core::ffi::c_int || *len >= 1000 as ::core::ffi::c_int {
...
pub unsafe extern "C" fn xmlGetFeature(
    ...
    {
        *(result as *mut ::core::ffi::c_int) = (*ctxt).loadsubset;
    } else if strcmp(
        name,
        b"substitute entities\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
        *(result as *mut ::core::ffi::c_int) = (*ctxt).replaceEntities;
    } else if strcmp(
        name,
        b"gather line info\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
...
pub unsafe extern "C" fn xmlSetFeature(
    ...
    {
        (*ctxt).loadsubset = *(value as *mut ::core::ffi::c_int);
    } else if strcmp(
        name,
        b"substitute entities\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
    {
        (*ctxt).replaceEntities = *(value as *mut ::core::ffi::c_int);
    } else if strcmp(
        name,
        b"gather line info\0" as *const u8 as *const ::core::ffi::c_char,
    ) == 0
...
#[no_mangle]
pub unsafe extern "C" fn hasInternalSubset(
    mut ctx: *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    if deprecated_v1_msg == 0 as ::core::ffi::c_int {
        (*__xmlGenericError())
...
#[no_mangle]
pub unsafe extern "C" fn hasExternalSubset(
    mut ctx: *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    if deprecated_v1_msg == 0 as ::core::ffi::c_int {
        (*__xmlGenericError())
