...
extern "C" {
    ...
    fn __xmlTreeIndentString() -> *mut *const ::core::ffi::c_char;
    fn __xmlSaveNoEmptyTags() -> *mut ::core::ffi::c_int;
    ...
    fn htmlIsBooleanAttr(name: *const xmlChar) -> ::core::ffi::c_int;
...
pub struct _xmlSaveCtxt {
    ...
    pub indent: [::core::ffi::c_char; 61],
    pub indent_nr: ::core::ffi::c_int,
...
unsafe extern "C" fn xmlSaveErrMemory(mut extra: *const ::core::ffi::c_char) {
    __xmlSimpleError(
...
unsafe extern "C" fn xmlSerializeHexCharRef(
    ...
    *fresh0 = '&' as i32 as ::core::ffi::c_uchar;
    let fresh1 = out;
    out = out.offset(1);
    *fresh1 = '#' as i32 as ::core::ffi::c_uchar;
    let fresh2 = out;
    out = out.offset(1);
    *fresh2 = 'x' as i32 as ::core::ffi::c_uchar;
    if val < 0x10 as ::core::ffi::c_int {
        ptr = out;
    } else if val < 0x100 as ::core::ffi::c_int {
        ptr = out.offset(1 as ::core::ffi::c_int as isize);
    } else if val < 0x1000 as ::core::ffi::c_int {
        ptr = out.offset(2 as ::core::ffi::c_int as isize);
    } else if val < 0x10000 as ::core::ffi::c_int {
        ptr = out.offset(3 as ::core::ffi::c_int as isize);
    } else if val < 0x100000 as ::core::ffi::c_int {
        ptr = out.offset(4 as ::core::ffi::c_int as isize);
    } else {
        ptr = out.offset(5 as ::core::ffi::c_int as isize);
    }
    out = ptr.offset(1 as ::core::ffi::c_int as isize);
    while val > 0 as ::core::ffi::c_int {
        match val & 0xf as ::core::ffi::c_int {
            0 => {
                let fresh3 = ptr;
                ptr = ptr.offset(-1);
                *fresh3 = '0' as i32 as ::core::ffi::c_uchar;
            }
            1 => {
                let fresh4 = ptr;
                ptr = ptr.offset(-1);
                *fresh4 = '1' as i32 as ::core::ffi::c_uchar;
            }
            2 => {
                let fresh5 = ptr;
                ptr = ptr.offset(-1);
                *fresh5 = '2' as i32 as ::core::ffi::c_uchar;
            }
            3 => {
                let fresh6 = ptr;
                ptr = ptr.offset(-1);
                *fresh6 = '3' as i32 as ::core::ffi::c_uchar;
            }
            4 => {
                let fresh7 = ptr;
                ptr = ptr.offset(-1);
                *fresh7 = '4' as i32 as ::core::ffi::c_uchar;
            }
            5 => {
                let fresh8 = ptr;
                ptr = ptr.offset(-1);
                *fresh8 = '5' as i32 as ::core::ffi::c_uchar;
            }
            6 => {
                let fresh9 = ptr;
                ptr = ptr.offset(-1);
                *fresh9 = '6' as i32 as ::core::ffi::c_uchar;
            }
            7 => {
                let fresh10 = ptr;
                ptr = ptr.offset(-1);
                *fresh10 = '7' as i32 as ::core::ffi::c_uchar;
            }
            8 => {
                let fresh11 = ptr;
                ptr = ptr.offset(-1);
                *fresh11 = '8' as i32 as ::core::ffi::c_uchar;
            }
            9 => {
                let fresh12 = ptr;
                ptr = ptr.offset(-1);
                *fresh12 = '9' as i32 as ::core::ffi::c_uchar;
            }
            10 => {
                let fresh13 = ptr;
                ptr = ptr.offset(-1);
                *fresh13 = 'A' as i32 as ::core::ffi::c_uchar;
            }
            11 => {
                let fresh14 = ptr;
                ptr = ptr.offset(-1);
                *fresh14 = 'B' as i32 as ::core::ffi::c_uchar;
            }
            12 => {
                let fresh15 = ptr;
                ptr = ptr.offset(-1);
                *fresh15 = 'C' as i32 as ::core::ffi::c_uchar;
            }
            13 => {
                let fresh16 = ptr;
                ptr = ptr.offset(-1);
                *fresh16 = 'D' as i32 as ::core::ffi::c_uchar;
            }
            14 => {
                let fresh17 = ptr;
                ptr = ptr.offset(-1);
                *fresh17 = 'E' as i32 as ::core::ffi::c_uchar;
            }
            15 => {
                let fresh18 = ptr;
                ptr = ptr.offset(-1);
                *fresh18 = 'F' as i32 as ::core::ffi::c_uchar;
            }
            _ => {
                let fresh19 = ptr;
                ptr = ptr.offset(-1);
                *fresh19 = '0' as i32 as ::core::ffi::c_uchar;
            }
        }
    ...
    loop {
        ...
        if *in_0 as ::core::ffi::c_int == '<' as i32 {
            ...
            *fresh21 = '&' as i32 as ::core::ffi::c_uchar;
            let fresh22 = out;
            out = out.offset(1);
            *fresh22 = 'l' as i32 as ::core::ffi::c_uchar;
            let fresh23 = out;
            out = out.offset(1);
            *fresh23 = 't' as i32 as ::core::ffi::c_uchar;
            let fresh24 = out;
            out = out.offset(1);
            *fresh24 = ';' as i32 as ::core::ffi::c_uchar;
            ...
            let fresh25 = out;
            out = out.offset(1);
            *fresh25 = '&' as i32 as ::core::ffi::c_uchar;
            let fresh26 = out;
            out = out.offset(1);
            *fresh26 = 'g' as i32 as ::core::ffi::c_uchar;
            let fresh27 = out;
            out = out.offset(1);
            *fresh27 = 't' as i32 as ::core::ffi::c_uchar;
            let fresh28 = out;
            out = out.offset(1);
            *fresh28 = ';' as i32 as ::core::ffi::c_uchar;
            ...
            let fresh29 = out;
            out = out.offset(1);
            *fresh29 = '&' as i32 as ::core::ffi::c_uchar;
            let fresh30 = out;
            out = out.offset(1);
            *fresh30 = 'a' as i32 as ::core::ffi::c_uchar;
            let fresh31 = out;
            out = out.offset(1);
            *fresh31 = 'm' as i32 as ::core::ffi::c_uchar;
            let fresh32 = out;
            out = out.offset(1);
            *fresh32 = 'p' as i32 as ::core::ffi::c_uchar;
            let fresh33 = out;
            out = out.offset(1);
            *fresh33 = ';' as i32 as ::core::ffi::c_uchar;
            in_0 = in_0.offset(1);
        } else if *in_0 as ::core::ffi::c_int >= 0x20 as ::core::ffi::c_int
            ...
            || *in_0 as ::core::ffi::c_int == '\t' as i32
        {
            ...
            *fresh35 = *fresh34 as ::core::ffi::c_uchar;
            ...
            if (*in_0 as ::core::ffi::c_int) < 0xc0 as ::core::ffi::c_int {
                xmlSaveErr(
                    XML_SAVE_NOT_UTF8 as ::core::ffi::c_int,
                    ::core::ptr::null_mut::<xmlNode>(),
                    ::core::ptr::null::<::core::ffi::c_char>(),
                );
                in_0 = in_0.offset(1);
                current_block = 12785598087081333342;
                break;
            } else {
                if (*in_0 as ::core::ffi::c_int) < 0xe0 as ::core::ffi::c_int {
                    ...
                    xmlSaveErr(
                        XML_SAVE_CHAR_INVALID as ::core::ffi::c_int,
                        ::core::ptr::null_mut::<xmlNode>(),
                        ::core::ptr::null::<::core::ffi::c_char>(),
                    );
                    in_0 = in_0.offset(1);
        ...
        } else if 0x9 as ::core::ffi::c_int <= *in_0 as ::core::ffi::c_int
...
unsafe extern "C" fn xmlSaveCtxtInit(mut ctxt: xmlSaveCtxtPtr) {
    ...
    if (*__xmlTreeIndentString()).is_null() || len == 0 as ::core::ffi::c_int {
        memset(
            (&raw mut (*ctxt).indent as *mut ::core::ffi::c_char)
                .offset(0 as ::core::ffi::c_int as isize) as *mut ::core::ffi::c_char
                as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            (MAX_INDENT + 1 as ::core::ffi::c_int) as size_t,
        );
    } else {
        ...
        while i < (*ctxt).indent_nr {
            memcpy(
                ...
                *__xmlTreeIndentString() as *const ::core::ffi::c_void,
...
unsafe extern "C" fn xmlNewSaveCtxt(
    ...
    if !encoding.is_null() {
        ...
        if (*ret).handler.is_null() {
            xmlSaveErr(
                XML_SAVE_UNKNOWN_ENCODING as ::core::ffi::c_int,
                ::core::ptr::null_mut::<xmlNode>(),
                encoding,
            );
            xmlFreeSaveCtxt(ret);
    ...
    xmlSaveCtxtInit(ret);
    if (*ret).options & XML_SAVE_NO_EMPTY as ::core::ffi::c_int != 0
        && options & XML_SAVE_NO_EMPTY as ::core::ffi::c_int == 0
    {
        options |= XML_SAVE_NO_EMPTY as ::core::ffi::c_int;
    }
    (*ret).options = options;
    if options & XML_SAVE_FORMAT as ::core::ffi::c_int != 0 {
        (*ret).format = 1 as ::core::ffi::c_int;
    } else if options & XML_SAVE_WSNONSIG as ::core::ffi::c_int != 0 {
        (*ret).format = 2 as ::core::ffi::c_int;
    }
    return ret;
}
unsafe extern "C" fn xmlAttrSerializeContent(
    ...
    while !children.is_null() {
        match (*children).type_0 as ::core::ffi::c_uint {
            3 => {
...
unsafe extern "C" fn xmlSaveSwitchEncoding(
    ...
    if !encoding.is_null() && (*buf).encoder.is_null() && (*buf).conv.is_null() {
        ...
        if (*buf).conv.is_null() {
            ...
            xmlSaveErrMemory(
                b"creating encoding buffer\0" as *const u8 as *const ::core::ffi::c_char,
            );
            return -(1 as ::core::ffi::c_int);
        }
        xmlCharEncOutput(buf, 1 as ::core::ffi::c_int);
    }
    return 0 as ::core::ffi::c_int;
}
...
unsafe extern "C" fn xmlNsDumpOutput(
        ...
        && !(*cur).href.is_null()
    {
        ...
        if !ctxt.is_null() && (*ctxt).format == 2 as ::core::ffi::c_int {
            xmlOutputBufferWriteWSNonSig(ctxt, 2 as ::core::ffi::c_int);
        } else {
            xmlOutputBufferWrite(
                buf,
                1 as ::core::ffi::c_int,
        ...
        if !(*cur).prefix.is_null() {
            ...
            xmlOutputBufferWriteString(buf, (*cur).prefix as *const ::core::ffi::c_char);
        } else {
            xmlOutputBufferWrite(
                buf,
                5 as ::core::ffi::c_int,
...
unsafe extern "C" fn xmlDtdDumpOutput(mut ctxt: xmlSaveCtxtPtr, mut dtd: xmlDtdPtr) {
    ...
    xmlOutputBufferWriteString(buf, (*dtd).name as *const ::core::ffi::c_char);
    ...
    format = (*ctxt).format;
    level = (*ctxt).level;
    (*ctxt).format = 0 as ::core::ffi::c_int;
    (*ctxt).level = -(1 as ::core::ffi::c_int);
...
unsafe extern "C" fn htmlNodeDumpOutputInternal(
    ...
    let mut buf: xmlOutputBufferPtr = (*ctxt).buf;
    let mut switched_encoding: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        ...
        && (*buf).conv.is_null()
    {
        ...
        switched_encoding = 1 as ::core::ffi::c_int;
    }
    if (*ctxt).options & XML_SAVE_FORMAT as ::core::ffi::c_int != 0 {
            ...
            1 => {
                ...
                if (*cur).parent != parent && !(*cur).children.is_null() {
                    ...
                    if (*cur).children.is_null() {
                        if (*ctxt).options & XML_SAVE_NO_EMPTY as ::core::ffi::c_int
                            == 0 as ::core::ffi::c_int
                        {
                            if (*ctxt).format == 2 as ::core::ffi::c_int {
                            ...
                            if (*ctxt).format == 2 as ::core::ffi::c_int {
                                xmlOutputBufferWriteWSNonSig(ctxt, 1 as ::core::ffi::c_int);
                            }
                            xmlOutputBufferWrite(
                                buf,
                                3 as ::core::ffi::c_int,
                        ...
                        if (*ctxt).format == 1 as ::core::ffi::c_int {
...
unsafe extern "C" fn xmlDocContentDumpOutput(
    ...
    let mut is_xhtml: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        ...
        || (*ctxt).options & XML_SAVE_AS_HTML as ::core::ffi::c_int != 0
    {
        ...
        == XML_DOCUMENT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
        || (*ctxt).options & XML_SAVE_AS_XML as ::core::ffi::c_int != 0
        || (*ctxt).options & XML_SAVE_XHTML as ::core::ffi::c_int != 0
    {
            ...
            == 0 as ::core::ffi::c_int
        {
            xmlOutputBufferWrite(
                ...
                b"<?xml version=\0" as *const u8 as *const ::core::ffi::c_char,
            );
            if !(*cur).version.is_null() {
                ...
                xmlOutputBufferWrite(
                    buf,
                    5 as ::core::ffi::c_int,
                    b"\"1.0\"\0" as *const u8 as *const ::core::ffi::c_char,
                );
            }
            if !encoding.is_null() {
                xmlOutputBufferWrite(
            ...
            == 0 as ::core::ffi::c_int
        {
            ...
            if !dtd.is_null() {
                ...
                if is_xhtml < 0 as ::core::ffi::c_int {
                    is_xhtml = 0 as ::core::ffi::c_int;
                }
            }
        }
        if !(*cur).children.is_null() {
            ...
            while !child.is_null() {
                (*ctxt).level = 0 as ::core::ffi::c_int;
                if is_xhtml != 0 {
...
unsafe extern "C" fn xhtmlIsEmpty(mut node: xmlNodePtr) -> ::core::ffi::c_int {
    if node.is_null() {
        return -(1 as ::core::ffi::c_int);
    }
    ...
    if !(*node).ns.is_null()
        && xmlStrEqual(
            (*(*node).ns).href,
            b"http://www.w3.org/1999/xhtml\0" as *const u8 as *const ::core::ffi::c_char
                as *mut xmlChar,
        ) == 0
    {
        return 0 as ::core::ffi::c_int;
    ...
    match *(*node).name.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int {
        97 => {
            if xmlStrEqual(
                (*node).name,
                b"area\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return 1 as ::core::ffi::c_int;
            }
        ...
        98 => {
            if xmlStrEqual(
                (*node).name,
                b"br\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return 1 as ::core::ffi::c_int;
            }
            ...
            if xmlStrEqual(
                (*node).name,
                b"basefont\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return 1 as ::core::ffi::c_int;
            }
        ...
        99 => {
            if xmlStrEqual(
                (*node).name,
                b"col\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return 1 as ::core::ffi::c_int;
            }
        ...
        104 => {
            if xmlStrEqual(
                (*node).name,
                b"hr\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return 1 as ::core::ffi::c_int;
            }
        ...
        105 => {
            if xmlStrEqual(
                (*node).name,
                b"img\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return 1 as ::core::ffi::c_int;
            }
            if xmlStrEqual(
                (*node).name,
                b"input\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return 1 as ::core::ffi::c_int;
            }
            if xmlStrEqual(
                (*node).name,
                b"isindex\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            ) != 0
            {
                return 1 as ::core::ffi::c_int;
            }
...
unsafe extern "C" fn xhtmlAttrListDumpOutput(
    ...
    while !cur.is_null() {
            ...
            && htmlIsBooleanAttr((*cur).name) != 0
        {
            ...
            (*cur).children = xmlNewText((*cur).name) as *mut _xmlNode;
            if !(*cur).children.is_null() {
    ...
    if !name.is_null() && id.is_null() {
        if !parent.is_null() && !(*parent).name.is_null()
            && (xmlStrEqual(
                ...
                || xmlStrEqual(
                    (*parent).name,
                    b"map\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
                ) != 0
                || xmlStrEqual(
                    (*parent).name,
                ...
                || xmlStrEqual(
                    (*parent).name,
                    b"form\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
                ) != 0
                || xmlStrEqual(
                    (*parent).name,
                    b"frame\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
...
unsafe extern "C" fn xhtmlNodeDumpOutput(mut ctxt: xmlSaveCtxtPtr, mut cur: xmlNodePtr) {
    let mut format: ::core::ffi::c_int = (*ctxt).format;
    let mut addmeta: ::core::ffi::c_int = 0;
    let mut tmp: xmlNodePtr = ::core::ptr::null_mut::<xmlNode>();
    let mut root: xmlNodePtr = ::core::ptr::null_mut::<xmlNode>();
    let mut unformattedNode: xmlNodePtr = ::core::ptr::null_mut::<xmlNode>();
    let mut start: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
        ...
        match (*cur).type_0 as ::core::ffi::c_uint {
            ...
            1 => {
                    ...
                    ) != 0
                {
                    ...
                    if tmp.is_null() {
                        addmeta = 1 as ::core::ffi::c_int;
                    }
                }
                if (*cur).children.is_null() {
                    if ((*cur).ns.is_null() || (*(*cur).ns).prefix.is_null())
                        && (xhtmlIsEmpty(cur) == 1 as ::core::ffi::c_int
                            && addmeta == 0 as ::core::ffi::c_int)
                    {
                        xmlOutputBufferWrite(
                            buf,
                        ...
                        if addmeta == 1 as ::core::ffi::c_int {
                            xmlOutputBufferWrite(
                                buf,
                                1 as ::core::ffi::c_int,
                                b">\0" as *const u8 as *const ::core::ffi::c_char,
                            ...
                            if (*ctxt).format == 1 as ::core::ffi::c_int {
                                ...
                                if *__xmlIndentTreeOutput() != 0 {
                                    xmlOutputBufferWrite(
                                        buf,
                                        (*ctxt).indent_size
                                            * (if (*ctxt).level + 1 as ::core::ffi::c_int
                                                > (*ctxt).indent_nr
                                            {
                                                (*ctxt).indent_nr
                                            } else {
                            ...
                            if !(*ctxt).encoding.is_null() {
                                xmlOutputBufferWriteString(
                                    buf,
                                    (*ctxt).encoding as *const ::core::ffi::c_char,
                                );
                            } else {
                                xmlOutputBufferWrite(
                                    buf,
...
pub unsafe extern "C" fn xmlSaveToFilename(
    ...
    let mut ret: xmlSaveCtxtPtr = ::core::ptr::null_mut::<xmlSaveCtxt>();
    let mut compression: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    ret = xmlNewSaveCtxt(encoding, options);
    if ret.is_null() {
        return ::core::ptr::null_mut::<xmlSaveCtxt>();
    }
...
pub unsafe extern "C" fn xmlSaveDoc(
    ...
    let mut ret: ::core::ffi::c_long = 0 as ::core::ffi::c_long;
    if ctxt.is_null() || doc.is_null() {
        return -(1 as ::core::ffi::c_int) as ::core::ffi::c_long;
    }
    if xmlDocContentDumpOutput(ctxt, doc) < 0 as ::core::ffi::c_int {
        return -(1 as ::core::ffi::c_int) as ::core::ffi::c_long;
    }
    return ret;
}
...
#[no_mangle]
pub unsafe extern "C" fn xmlSaveFlush(mut ctxt: xmlSaveCtxtPtr) -> ::core::ffi::c_int {
    if ctxt.is_null() {
        return -(1 as ::core::ffi::c_int);
    }
    if (*ctxt).buf.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn xmlSaveClose(mut ctxt: xmlSaveCtxtPtr) -> ::core::ffi::c_int {
...
pub unsafe extern "C" fn xmlBufAttrSerializeTxtContent(
    ...
    while *cur as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
        if *cur as ::core::ffi::c_int == '\n' as i32 {
            ...
            xmlBufAdd(
                buf,
                b"&#10;\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
                5 as ::core::ffi::c_int,
            );
            cur = cur.offset(1);
            base = cur;
        ...
        {
            let mut tmp: [::core::ffi::c_uchar; 12] = [0; 12];
            ...
            if (*cur as ::core::ffi::c_int) < 0xc0 as ::core::ffi::c_int {
                xmlSaveErr(
                    XML_SAVE_NOT_UTF8 as ::core::ffi::c_int,
                    attr as xmlNodePtr,
                    ::core::ptr::null::<::core::ffi::c_char>(),
...
pub unsafe extern "C" fn xmlBufNodeDump(
    ...
    let mut oldalloc: ::core::ffi::c_int = 0;
    xmlInitParser();
    if cur.is_null() {
    ...
    (*outbuf).context = NULL;
    (*outbuf).written = 0 as ::core::ffi::c_int;
    use_0 = xmlBufUse(buf);
    ...
    xmlFree.expect("non-null function pointer")(outbuf as *mut ::core::ffi::c_void);
    ret = xmlBufUse(buf).wrapping_sub(use_0) as ::core::ffi::c_int;
...
pub unsafe extern "C" fn xmlElemDump(
    ...
    if !doc.is_null()
        && (*doc).type_0 as ::core::ffi::c_uint
            == XML_HTML_DOCUMENT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        htmlNodeDumpOutput(outbuf, doc, cur, ::core::ptr::null::<::core::ffi::c_char>());
    } else {
        xmlNodeDumpOutput(
            outbuf,
            doc,
...
pub unsafe extern "C" fn xmlNodeDumpOutput(
    ...
    if encoding.is_null() {
        encoding = b"UTF-8\0" as *const u8 as *const ::core::ffi::c_char;
    }
    memset(
...
pub unsafe extern "C" fn xmlDocDumpFormatMemoryEnc(
    ...
    mut doc_txt_len: *mut ::core::ffi::c_int,
    mut txt_encoding: *const ::core::ffi::c_char,
    mut format: ::core::ffi::c_int,
) {
    let mut ctxt: xmlSaveCtxt = _xmlSaveCtxt {
        _private: ::core::ptr::null_mut::<::core::ffi::c_void>(),
    ...
    *doc_txt_len = 0 as ::core::ffi::c_int;
    ...
    if txt_encoding.is_null() {
        txt_encoding = (*out_doc).encoding as *const ::core::ffi::c_char;
    }
    if !txt_encoding.is_null() {
    ...
    if !(*out_buff).conv.is_null() {
        *doc_txt_len = xmlBufUse((*out_buff).conv) as ::core::ffi::c_int;
        *doc_txt_ptr = xmlStrndup(
            xmlBufContent((*out_buff).conv as *const xmlBuf),
            *doc_txt_len,
        );
    } else {
        *doc_txt_len = xmlBufUse((*out_buff).buffer) as ::core::ffi::c_int;
        *doc_txt_ptr = xmlStrndup(
...
pub unsafe extern "C" fn xmlDocFormatDump(
    ...
    encoding = (*cur).encoding as *const ::core::ffi::c_char;
    if !encoding.is_null() {
        ...
        if handler.is_null() {
            ...
            encoding = ::core::ptr::null::<::core::ffi::c_char>();
        }
    }
...
pub unsafe extern "C" fn xmlSaveFormatFileEnc(
    ...
    if (*cur).compression < 0 as ::core::ffi::c_int {
...
pub unsafe extern "C" fn xmlSaveFileEnc(
    ...
    return xmlSaveFormatFileEnc(filename, cur, encoding, 0 as ::core::ffi::c_int);
}
#[no_mangle]
