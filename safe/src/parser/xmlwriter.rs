...
extern "C" {
    ...
    fn xmlSetDocCompressMode(doc: xmlDocPtr, mode: ::core::ffi::c_int);
    fn __xmlRaiseError(
...
pub struct _xmlTextWriter {
    ...
    pub doindent: ::core::ffi::c_int,
    pub ichar: *mut xmlChar,
    pub qchar: ::core::ffi::c_char,
    pub ctxt: xmlParserCtxtPtr,
    pub no_doc_free: ::core::ffi::c_int,
    pub doc: xmlDocPtr,
}
...
pub type xmlTextWriterState = ::core::ffi::c_uint;
...
unsafe extern "C" fn xmlWriterErrMsg(
    ...
    if !ctxt.is_null() {
        __xmlRaiseError(
            ...
            None,
            NULL,
            (*ctxt).ctxt as *mut ::core::ffi::c_void,
            NULL,
            XML_FROM_WRITER as ::core::ffi::c_int,
...
pub unsafe extern "C" fn xmlNewTextWriter(mut out: xmlOutputBufferPtr) -> xmlTextWriterPtr {
    ...
    memset(
        ...
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<xmlTextWriter>(),
    );
    ...
    (*ret).doc = xmlNewDoc(::core::ptr::null::<xmlChar>());
    (*ret).no_doc_free = 0 as ::core::ffi::c_int;
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn xmlNewTextWriterFilename(
    ...
    (*ret).indent = 0 as ::core::ffi::c_int;
    (*ret).doindent = 0 as ::core::ffi::c_int;
    return ret;
}
#[no_mangle]
...
pub unsafe extern "C" fn xmlNewTextWriterDoc(
    ...
    memset(
        &raw mut saxHandler as *mut ::core::ffi::c_void,
        '\0' as i32,
    ...
    (*ctxt).myDoc = xmlNewDoc(XML_DEFAULT_VERSION.as_ptr() as *mut xmlChar);
    ...
    if !doc.is_null() {
        *doc = (*ctxt).myDoc;
        (*ret).no_doc_free = 1 as ::core::ffi::c_int;
    }
    return ret;
}
#[no_mangle]
...
pub unsafe extern "C" fn xmlTextWriterStartDocument(
    ...
    mut standalone: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    ...
    encoder = ::core::ptr::null_mut::<xmlCharEncodingHandler>();
    if !encoding.is_null() {
    ...
    if !encoder.is_null() {
        if (*(*writer).out).conv.is_null() {
            (*(*writer).out).conv = xmlBufCreateSize(4000 as size_t);
        }
    ...
    if !standalone.is_null() {
        count = xmlOutputBufferWriteString(
            (*writer).out,
            b" standalone=\0" as *const u8 as *const ::core::ffi::c_char,
        );
        if count < 0 as ::core::ffi::c_int {
            return -(1 as ::core::ffi::c_int);
        }
...
pub unsafe extern "C" fn xmlTextWriterEndDocument(
    ...
    loop {
        ...
        match (*p).state as ::core::ffi::c_uint {
            1 | 2 | 3 => {
...
pub unsafe extern "C" fn xmlTextWriterStartComment(
    ...
    (*p).name = ::core::ptr::null_mut::<xmlChar>();
    (*p).state = XML_TEXTWRITER_COMMENT;
    xmlListPushFront((*writer).nodes, p as *mut ::core::ffi::c_void);
    if (*writer).indent != 0 {
        ...
        if !p.is_null() {
            ...
            match (*p).state as ::core::ffi::c_uint {
                ...
                2 => {
                    ...
                    sum += count;
                    current_block_20 = 9235358400188215594;
                }
                1 => {
                    current_block_20 = 9235358400188215594;
                }
...
pub unsafe extern "C" fn xmlTextWriterStartElementNS(
    ...
    if !namespaceURI.is_null() {
        ...
        xmlListPushFront((*writer).nsstack, p as *mut ::core::ffi::c_void);
    }
    return sum;
}
#[no_mangle]
pub unsafe extern "C" fn xmlTextWriterEndElement(
    ...
    match (*p).state as ::core::ffi::c_uint {
        2 => {
            ...
            sum += count;
            current_block_50 = 15066782448046541784;
        }
        1 => {
            current_block_50 = 15066782448046541784;
        }
        3 => {
            if (*writer).indent != 0 && (*writer).doindent != 0 {
                count = xmlTextWriterWriteIndent(writer);
                sum += count;
                (*writer).doindent = 1 as ::core::ffi::c_int;
            } else {
                (*writer).doindent = 1 as ::core::ffi::c_int;
            }
            count = xmlOutputBufferWriteString(
...
pub unsafe extern "C" fn xmlTextWriterFullEndElement(
    ...
    match (*p).state as ::core::ffi::c_uint {
        2 => {
            ...
            sum += count;
            current_block_41 = 12230821112472800926;
        }
        1 => {
            current_block_41 = 12230821112472800926;
        }
        3 => {
            current_block_41 = 14839349357298093710;
        }
        _ => return -(1 as ::core::ffi::c_int),
    }
    match current_block_41 {
        12230821112472800926 => {
            count = xmlTextWriterOutputNSDecl(writer);
            if count < 0 as ::core::ffi::c_int {
                return -(1 as ::core::ffi::c_int);
            }
...
pub unsafe extern "C" fn xmlTextWriterWriteRawLen(
    ...
    if content.is_null() || len < 0 as ::core::ffi::c_int {
        xmlWriterErrMsg(
            writer,
            XML_ERR_INTERNAL_ERROR,
...
pub unsafe extern "C" fn xmlTextWriterWriteString(
    ...
    if !lk.is_null() {
        ...
        if !p.is_null() {
            match (*p).state as ::core::ffi::c_uint {
                1 | 3 => {
                    buf = xmlEncodeSpecialChars(::core::ptr::null::<xmlDoc>(), content);
                }
                2 => {
                    buf = ::core::ptr::null_mut::<xmlChar>();
...
unsafe extern "C" fn xmlOutputBufferWriteBase64(
    ...
    static mut dtable: [::core::ffi::c_uchar; 64] = [
    ...
    let mut count: ::core::ffi::c_int = 0;
    let mut sum: ::core::ffi::c_int = 0;
    if out.is_null() || len < 0 as ::core::ffi::c_int || data.is_null() {
        return -(1 as ::core::ffi::c_int);
    }
    linelen = 0 as ::core::ffi::c_int;
    sum = 0 as ::core::ffi::c_int;
    i = 0 as ::core::ffi::c_int;
    loop {
        let mut igroup: [::core::ffi::c_uchar; 3] = [0; 3];
        let mut ogroup: [::core::ffi::c_uchar; 4] = [0; 4];
        ...
        while n < 3 as ::core::ffi::c_int && i < len {
            ...
            igroup[n as usize] = c as ::core::ffi::c_uchar;
            n += 1;
            i += 1;
        }
...
pub unsafe extern "C" fn xmlTextWriterWriteBase64(
    ...
    count = xmlOutputBufferWriteBase64(
        (*writer).out,
        len,
        (data as *mut ::core::ffi::c_uchar).offset(start as isize),
    );
    if count < 0 as ::core::ffi::c_int {
        return -(1 as ::core::ffi::c_int);
    }
...
unsafe extern "C" fn xmlOutputBufferWriteBinHex(
    ...
    let mut count: ::core::ffi::c_int = 0;
    let mut sum: ::core::ffi::c_int = 0;
    static mut hex: [::core::ffi::c_char; 16] = [
    ...
    let mut i: ::core::ffi::c_int = 0;
    if out.is_null() || data.is_null() || len < 0 as ::core::ffi::c_int {
        return -(1 as ::core::ffi::c_int);
    }
    sum = 0 as ::core::ffi::c_int;
    i = 0 as ::core::ffi::c_int;
...
pub unsafe extern "C" fn xmlTextWriterStartAttributeNS(
    ...
    if !namespaceURI.is_null() {
        ...
        curns = xmlListSearch(
            (*writer).nsstack,
            &raw mut nsentry as *mut ::core::ffi::c_void,
        ...
        if !p.is_null() {
            ...
            match (*p).state as ::core::ffi::c_uint {
                2 => {
                    ...
                    sum += count;
                    current_block_24 = 17569885494259572192;
                }
                1 => {
                    current_block_24 = 17569885494259572192;
                }
        ...
        if !p.is_null() {
            ...
            match (*p).state as ::core::ffi::c_uint {
                ...
                2 => {
                    ...
                    sum += count;
                    current_block_20 = 17653221518020618601;
                }
                1 => {
                    current_block_20 = 17653221518020618601;
                }
    ...
    while loop_0 != 0 {
        ...
        match (*p).state as ::core::ffi::c_uint {
            8 => {
                ...
                sum += count;
                current_block_25 = 4345463811031626593;
            }
            7 => {
                current_block_25 = 4345463811031626593;
            }
...
pub unsafe extern "C" fn xmlTextWriterWriteDTDEntity(
    ...
    if pe != 0 as ::core::ffi::c_int && !ndataid.is_null() {
        return -(1 as ::core::ffi::c_int);
    }
...
pub unsafe extern "C" fn xmlTextWriterWriteDTDExternalEntityContents(
    ...
    if !ndataid.is_null() {
        count = xmlOutputBufferWriteString(
            (*writer).out,
            b" NDATA \0" as *const u8 as *const ::core::ffi::c_char,
        );
        if count < 0 as ::core::ffi::c_int {
            return -(1 as ::core::ffi::c_int);
        }
...
unsafe extern "C" fn xmlTextWriterOutputNSDecl(mut writer: xmlTextWriterPtr) -> ::core::ffi::c_int {
    ...
    while xmlListEmpty((*writer).nsstack) == 0 {
        let mut namespaceURI: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
...
unsafe extern "C" fn xmlCmpTextWriterNsStackEntry(
    ...
    if rc != 0 as ::core::ffi::c_int || (*p0).elem != (*p1).elem {
...
unsafe extern "C" fn xmlTextWriterWriteDocCallback(
    ...
    let mut rc: ::core::ffi::c_int = 0;
    rc = xmlParseChunk(ctxt, str, len, 0 as ::core::ffi::c_int);
...
pub unsafe extern "C" fn xmlTextWriterSetIndent(
    ...
    if writer.is_null() || indent < 0 as ::core::ffi::c_int {
        return -(1 as ::core::ffi::c_int);
    }
...
pub unsafe extern "C" fn xmlTextWriterSetQuoteChar(
    ...
    if writer.is_null()
        || quotechar as ::core::ffi::c_int != '\'' as i32
            && quotechar as ::core::ffi::c_int != '"' as i32
    {
        return -(1 as ::core::ffi::c_int);
    }
...
unsafe extern "C" fn xmlTextWriterWriteIndent(mut writer: xmlTextWriterPtr) -> ::core::ffi::c_int {
    ...
    if lksize < 1 as ::core::ffi::c_int {
        return -(1 as ::core::ffi::c_int);
    }
    i = 0 as ::core::ffi::c_int;
    while i < lksize - 1 as ::core::ffi::c_int {
        ret = xmlOutputBufferWriteString(
            (*writer).out,
            (*writer).ichar as *const ::core::ffi::c_char,
        );
    ...
    return lksize - 1 as ::core::ffi::c_int;
}
unsafe extern "C" fn xmlTextWriterHandleStateDependencies(
    ...
    let mut count: ::core::ffi::c_int = 0;
    let mut sum: ::core::ffi::c_int = 0;
    let mut extra: [::core::ffi::c_char; 3] = [0; 3];
    if writer.is_null() {
        return -(1 as ::core::ffi::c_int);
    }
    if p.is_null() {
    ...
    sum = 0 as ::core::ffi::c_int;
    extra[2 as ::core::ffi::c_int as usize] = '\0' as i32 as ::core::ffi::c_char;
    extra[1 as ::core::ffi::c_int as usize] = extra[2 as ::core::ffi::c_int as usize];
    extra[0 as ::core::ffi::c_int as usize] = extra[1 as ::core::ffi::c_int as usize];
    if !p.is_null() {
        sum = 0 as ::core::ffi::c_int;
        match (*p).state as ::core::ffi::c_uint {
            1 => {
