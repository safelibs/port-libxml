use crate::abi::opaque::{
    _xmlAutomata, _xmlAutomataState, _xmlBuf, _xmlDict, _xmlHashTable, _xmlRegexp, _xmlStartTag,
    _xmlValidState,
};
...
extern "C" {
    ...
    fn xmlValidateDtdFinal(ctxt: xmlValidCtxtPtr, doc: xmlDocPtr) -> ::core::ffi::c_int;
    ...
    fn nodePush(ctxt: xmlParserCtxtPtr, value: xmlNodePtr) -> ::core::ffi::c_int;
...
pub const SIZE_T_MAX: size_t = -(1 as ::core::ffi::c_int) as size_t;
...
#[no_mangle]
pub unsafe extern "C" fn xmlSAX2IsStandalone(
    mut ctx: *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    let mut ctxt: xmlParserCtxtPtr = ctx as xmlParserCtxtPtr;
...
pub unsafe extern "C" fn xmlSAX2HasInternalSubset(
    ...
    return ((*(*ctxt).myDoc).intSubset != NULL as *mut _xmlDtd) as ::core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn xmlSAX2HasExternalSubset(
    ...
    return ((*(*ctxt).myDoc).extSubset != NULL as *mut _xmlDtd) as ::core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn xmlSAX2InternalSubset(
    ...
    if (*(*ctxt).myDoc).intSubset.is_null() {
        xmlSAX2ErrMemory(
            ctxt,
            b"xmlSAX2InternalSubset\0" as *const u8 as *const ::core::ffi::c_char,
        );
    }
}
#[no_mangle]
pub unsafe extern "C" fn xmlSAX2ExternalSubset(
    ...
    if (!ExternalID.is_null() || !SystemID.is_null())
        && (((*ctxt).validate != 0 || (*ctxt).loadsubset != 0 as ::core::ffi::c_int)
            && ((*ctxt).wellFormed != 0 && !(*ctxt).myDoc.is_null()))
    {
        ...
        if (*ctxt).inputTab.is_null() {
            xmlSAX2ErrMemory(
                ctxt,
                b"xmlSAX2ExternalSubset\0" as *const u8 as *const ::core::ffi::c_char,
            );
            (*ctxt).input = oldinput;
        ...
        if (*(*ctxt).input).length >= 4 as ::core::ffi::c_int {
        ...
        if (*input).filename.is_null() {
            (*input).filename = xmlCanonicPath(SystemID) as *mut ::core::ffi::c_char;
        }
...
pub unsafe extern "C" fn xmlSAX2GetEntity(
    ...
    if !(*ctxt).myDoc.is_null() && (*(*ctxt).myDoc).standalone == 1 as ::core::ffi::c_int {
        if (*ctxt).inSubset == 2 as ::core::ffi::c_int {
            ...
            (*(*ctxt).myDoc).standalone = 1 as ::core::ffi::c_int;
        } else {
            ret = xmlGetDocEntity((*ctxt).myDoc as *const xmlDoc, name);
            if ret.is_null() {
                (*(*ctxt).myDoc).standalone = 0 as ::core::ffi::c_int;
...
pub unsafe extern "C" fn xmlSAX2EntityDecl(
    ...
    if (*ctxt).inSubset == 1 as ::core::ffi::c_int {
...
pub unsafe extern "C" fn xmlSAX2AttributeDecl(
    ...
    name = xmlSplitQName(ctxt, fullname, &raw mut prefix);
    (*ctxt).vctxt.valid = 1 as ::core::ffi::c_int;
    if (*ctxt).inSubset == 1 as ::core::ffi::c_int {
...
pub unsafe extern "C" fn xmlSAX2NotationDecl(
    ...
    if publicId.is_null() && systemId.is_null() {
        ...
        return;
    } else if (*ctxt).inSubset == 1 as ::core::ffi::c_int {
...
pub unsafe extern "C" fn xmlSAX2StartDocument(mut ctx: *mut ::core::ffi::c_void) {
    ...
    if (*ctxt).html != 0 {
        ...
        if (*ctxt).myDoc.is_null() {
            xmlSAX2ErrMemory(
                ctxt,
                b"xmlSAX2StartDocument\0" as *const u8 as *const ::core::ffi::c_char,
            );
            return;
        }
        (*(*ctxt).myDoc).properties = ((*(*ctxt).myDoc).properties as ::core::ffi::c_uint
            & (15 as ::core::ffi::c_uint) << 27 as ::core::ffi::c_int
            | XML_DOC_HTML as ::core::ffi::c_int as ::core::ffi::c_uint
                & !((15 as ::core::ffi::c_uint) << 27 as ::core::ffi::c_int))
            as ::core::ffi::c_int;
        ...
        doc = (*ctxt).myDoc;
        if !doc.is_null() {
            (*doc).properties = 0 as ::core::ffi::c_int;
            if (*ctxt).options & XML_PARSE_OLD10 as ::core::ffi::c_int != 0 {
                (*doc).properties = ((*doc).properties as ::core::ffi::c_uint
            ...
            if !(*ctxt).encoding.is_null() {
                ...
                (*doc).encoding = ::core::ptr::null::<xmlChar>();
            }
        ...
        if (*ctxt).dictNames != 0 && !doc.is_null() {
            (*doc).dict = (*ctxt).dict as *mut _xmlDict;
...
pub unsafe extern "C" fn xmlSAX2EndDocument(mut ctx: *mut ::core::ffi::c_void) {
    ...
    if (*ctxt).charset != XML_CHAR_ENCODING_NONE as ::core::ffi::c_int
        && !(*ctxt).myDoc.is_null()
        && (*(*ctxt).myDoc).charset == XML_CHAR_ENCODING_NONE as ::core::ffi::c_int
    {
...
unsafe extern "C" fn xmlSAX2AttributeInternal(
    ...
    let mut namespace: xmlNsPtr = ::core::ptr::null_mut::<xmlNs>();
    if (*ctxt).html != 0 {
        name = xmlStrdup(fullname);
        ns = ::core::ptr::null_mut::<xmlChar>();
        namespace = ::core::ptr::null_mut::<xmlNs>();
    } else {
        name = xmlSplitQName(ctxt, fullname, &raw mut ns);
        if !name.is_null()
    ...
    if (*ctxt).html != 0 && value.is_null() && htmlIsBooleanAttr(fullname) != 0 {
        ...
        if (*ctxt).vctxt.valid != 1 as ::core::ffi::c_int {
            (*ctxt).valid = 0 as ::core::ffi::c_int;
        }
        if !nval.is_null() {
            value = nval;
    ...
    if (*ctxt).html == 0
        ...
        && *name.offset(5 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
            == 0 as ::core::ffi::c_int
    {
        let mut nsret: xmlNsPtr = ::core::ptr::null_mut::<xmlNs>();
    ...
    if (*ctxt).html == 0
        ...
        && *ns.offset(5 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
            == 0 as ::core::ffi::c_int
    {
        let mut nsret_0: xmlNsPtr = ::core::ptr::null_mut::<xmlNs>();
        let mut val_0: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
        if (*ctxt).replaceEntities == 0 {
            (*ctxt).depth += 1;
        ...
        if *val_0.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
            == 0 as ::core::ffi::c_int
        {
            xmlNsErrMsg(
                ctxt,
        ...
        if (*ctxt).pedantic != 0 as ::core::ffi::c_int
            && *val_0.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                != 0 as ::core::ffi::c_int
        {
            let mut uri_0: xmlURIPtr = ::core::ptr::null_mut::<xmlURI>();
            uri_0 = xmlParseURI(val_0 as *const ::core::ffi::c_char);
            if uri_0.is_null() {
                xmlNsWarnMsg(
                    ctxt,
                    XML_WAR_NS_URI,
    ...
    if !ns.is_null() {
        ...
        if namespace.is_null() {
            ...
            prop = (*(*ctxt).node).properties as xmlAttrPtr;
            loop {
                if prop.is_null() {
                    current_block = 900943123863005455;
                    break;
        ...
        900943123863005455 => {
                        ...
                        && (*ctxt).inSubset == 0 as ::core::ffi::c_int)
            {
                ...
                ) != 0
                {
                    ...
                    xmlAddID(&raw mut (*ctxt).vctxt, (*ctxt).myDoc, value, ret);
                } else if xmlIsID((*ctxt).myDoc, (*ctxt).node, ret) != 0 {
                    xmlAddID(&raw mut (*ctxt).vctxt, (*ctxt).myDoc, value, ret);
                } else if xmlIsRef((*ctxt).myDoc, (*ctxt).node, ret) != 0 {
                    xmlAddRef(&raw mut (*ctxt).vctxt, (*ctxt).myDoc, value, ret);
                }
            }
        }
        _ => {}
...
pub unsafe extern "C" fn xmlSAX2StartElement(
    ...
    if (*(*ctxt).myDoc).children.is_null() {
        ...
        parent = (*(*ctxt).myDoc).children as xmlNodePtr;
    }
    (*ctxt).nodemem = -(1 as ::core::ffi::c_int);
    if (*ctxt).linenumbers != 0 {
        if !(*ctxt).input.is_null() {
            if (*(*ctxt).input).line < USHRT_MAX {
                (*ret).line = (*(*ctxt).input).line as ::core::ffi::c_ushort;
            } else {
                (*ret).line = USHRT_MAX as ::core::ffi::c_ushort;
            }
        }
    }
    if nodePush(ctxt, ret) < 0 as ::core::ffi::c_int {
        xmlUnlinkNode(ret);
        xmlFreeNode(ret);
        if !prefix.is_null() {
            xmlFree.expect("non-null function pointer")(prefix as *mut ::core::ffi::c_void);
    ...
    if (*ctxt).html == 0 {
        ...
        if !prefix.is_null() && ns.is_null() {
            ns = xmlNewNs(ret, ::core::ptr::null::<xmlChar>(), prefix);
            xmlNsWarnMsg(
                ctxt,
                XML_NS_ERR_UNDEFINED_NAMESPACE,
    ...
    if (*ctxt).validate != 0 && (*ctxt).vctxt.finishDtd == XML_CTXT_FINISH_DTD_0 {
        let mut chk: ::core::ffi::c_int = 0;
        chk = xmlValidateDtdFinal(&raw mut (*ctxt).vctxt, (*ctxt).myDoc);
        if chk <= 0 as ::core::ffi::c_int {
            (*ctxt).valid = 0 as ::core::ffi::c_int;
        }
        if chk < 0 as ::core::ffi::c_int {
            (*ctxt).wellFormed = 0 as ::core::ffi::c_int;
...
unsafe extern "C" fn xmlSAX2TextNode(
    ...
    let mut current_block: u64;
    let mut ret: xmlNodePtr = ::core::ptr::null_mut::<xmlNode>();
    let mut intern: *const xmlChar = ::core::ptr::null::<xmlChar>();
    ...
    if ret.is_null() {
        xmlErrMemory(
            ctxt,
            b"xmlSAX2Characters\0" as *const u8 as *const ::core::ffi::c_char,
        );
    ...
    if (*ctxt).dictNames != 0 {
            ...
            && (*ctxt).options & XML_PARSE_COMPACT as ::core::ffi::c_int != 0
        {
            ...
            *tmp.offset(len as isize) = 0 as xmlChar;
            intern = tmp;
    ...
    if intern.is_null() {
        ...
        if (*ret).content.is_null() {
            xmlSAX2ErrMemory(
                ctxt,
                b"xmlSAX2TextNode\0" as *const u8 as *const ::core::ffi::c_char,
            );
...
unsafe extern "C" fn xmlSAX2DecodeAttrEntities(
    ...
    loop {
        ...
        if *fresh12 as ::core::ffi::c_int == '&' as i32 {
            current_block = 15557260538923206789;
            break;
        }
    }
    match current_block {
        12675440807659640239 => return ::core::ptr::null_mut::<xmlChar>(),
        _ => {
            (*ctxt).depth += 1;
            ret = xmlStringLenDecodeEntities(
                ctxt,
                str,
                end.offset_from(str) as ::core::ffi::c_long as ::core::ffi::c_int,
                XML_SUBSTITUTE_REF,
                0 as xmlChar,
                0 as xmlChar,
                0 as xmlChar,
...
unsafe extern "C" fn xmlSAX2AttributeNs(
    ...
    if !(*ctxt).freeAttrs.is_null() {
        ret = (*ctxt).freeAttrs;
        (*ctxt).freeAttrs = (*ret).next as xmlAttrPtr;
        (*ctxt).freeAttrsNr -= 1;
        memset(
            ret as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
        ...
        (*ret).parent = (*ctxt).node as *mut _xmlNode;
        (*ret).doc = (*ctxt).myDoc as *mut _xmlDoc;
        (*ret).ns = namespace as *mut xmlNs;
        if (*ctxt).dictNames != 0 {
            (*ret).name = localname;
        } else {
        ...
        if (*(*ctxt).node).properties.is_null() {
            (*(*ctxt).node).properties = ret as *mut _xmlAttr;
        } else {
            let mut prev: xmlAttrPtr = (*(*ctxt).node).properties as xmlAttrPtr;
            while !(*prev).next.is_null() {
                prev = (*prev).next as xmlAttrPtr;
            }
            (*prev).next = ret as *mut _xmlAttr;
        ...
        if ret.is_null() {
            xmlErrMemory(
                ctxt,
                b"xmlSAX2AttributeNs\0" as *const u8 as *const ::core::ffi::c_char,
            );
            return;
        }
    }
    if (*ctxt).replaceEntities == 0 as ::core::ffi::c_int && (*ctxt).html == 0 {
        ...
        if *valueend as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
            ...
            (*ret).children = tmp as *mut _xmlNode;
            (*ret).last = tmp as *mut _xmlNode;
            if !tmp.is_null() {
                (*tmp).doc = (*ret).doc;
                (*tmp).parent = ret as xmlNodePtr as *mut _xmlNode;
            ...
            (*ret).children = xmlStringLenGetNodeList(
        ...
        (*ret).children = tmp_0 as *mut _xmlNode;
        (*ret).last = tmp_0 as *mut _xmlNode;
        if !tmp_0.is_null() {
            (*tmp_0).doc = (*ret).doc;
                ...
                && (*ctxt).inSubset == 0 as ::core::ffi::c_int)
    {
        if prefix == (*ctxt).str_xml
            && *localname.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                == 'i' as i32
            && *localname.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                == 'd' as i32
            && *localname.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                == 0 as ::core::ffi::c_int
        {
            if dup.is_null() {
                dup = xmlStrndup(
...
pub unsafe extern "C" fn xmlSAX2StartElementNs(
    ...
    let mut ret: xmlNodePtr = ::core::ptr::null_mut::<xmlNode>();
    let mut parent: xmlNodePtr = ::core::ptr::null_mut::<xmlNode>();
    let mut last: xmlNsPtr = ::core::ptr::null_mut::<xmlNs>();
    let mut ns: xmlNsPtr = ::core::ptr::null_mut::<xmlNs>();
    let mut uri: *const xmlChar = ::core::ptr::null::<xmlChar>();
    let mut pref: *const xmlChar = ::core::ptr::null::<xmlChar>();
    let mut lname: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut i: ::core::ffi::c_int = 0;
    ...
    if !prefix.is_null() && URI.is_null() {
        if (*ctxt).dictNames != 0 {
            let mut fullname: *const xmlChar = ::core::ptr::null::<xmlChar>();
    ...
    if !(*ctxt).freeElems.is_null() {
        ...
        if (*ctxt).dictNames != 0 {
            ...
            if (*ret).name.is_null() {
                xmlSAX2ErrMemory(
                    ctxt,
                    b"xmlSAX2StartElementNs\0" as *const u8 as *const ::core::ffi::c_char,
                );
                return;
            }
        }
    ...
    while j < nb_namespaces {
        let fresh10 = i;
        i = i + 1;
        pref = *namespaces.offset(fresh10 as isize);
        let fresh11 = i;
        i = i + 1;
        uri = *namespaces.offset(fresh11 as isize);
        ns = xmlNewNs(::core::ptr::null_mut::<xmlNode>(), uri, pref);
        if !ns.is_null() {
            if last.is_null() {
                last = ns;
                (*ret).nsDef = last as *mut xmlNs;
            } else {
                (*last).next = ns as *mut _xmlNs;
                last = ns;
            }
    ...
    if nb_defaulted != 0 as ::core::ffi::c_int
        && (*ctxt).loadsubset & XML_COMPLETE_ATTRS == 0 as ::core::ffi::c_int
    {
        nb_attributes -= nb_defaulted;
    }
    if !URI.is_null() && (*ret).ns.is_null() {
        (*ret).ns = xmlSearchNs((*ctxt).myDoc, parent, prefix) as *mut xmlNs;
        if (*ret).ns.is_null()
            && xmlStrEqual(
                prefix,
        ...
        {
            (*ret).ns = xmlSearchNs((*ctxt).myDoc, ret, prefix) as *mut xmlNs;
        }
        if (*ret).ns.is_null() {
            ns = xmlNewNs(ret, ::core::ptr::null::<xmlChar>(), prefix);
            if ns.is_null() {
    ...
    if nb_attributes > 0 as ::core::ffi::c_int {
        let mut current_block_110: u64;
        j = 0 as ::core::ffi::c_int;
        i = 0 as ::core::ffi::c_int;
        while i < nb_attributes {
            if !(*attributes.offset((j + 1 as ::core::ffi::c_int) as isize)).is_null()
                && (*attributes.offset((j + 2 as ::core::ffi::c_int) as isize)).is_null()
            {
                if (*ctxt).dictNames != 0 {
                    let mut fullname_0: *const xmlChar = ::core::ptr::null::<xmlChar>();
                    fullname_0 = xmlDictQLookup(
                        (*ctxt).dict,
                        *attributes.offset((j + 1 as ::core::ffi::c_int) as isize),
...
pub unsafe extern "C" fn xmlSAX2EndElementNs(
    ...
    if (*ctxt).record_info != 0 && !cur.is_null() {
        node_info.end_pos = (*(*ctxt).input).cur.offset_from((*(*ctxt).input).base)
            as ::core::ffi::c_long as ::core::ffi::c_ulong;
...
unsafe extern "C" fn xmlSAX2Text(
    ...
    lastChild = (*(*ctxt).node).last as xmlNodePtr;
    if lastChild.is_null() {
        ...
        if !lastChild.is_null() {
            (*(*ctxt).node).children = lastChild as *mut _xmlNode;
            (*(*ctxt).node).last = lastChild as *mut _xmlNode;
            (*lastChild).parent = (*ctxt).node as *mut _xmlNode;
            (*lastChild).doc = (*(*ctxt).node).doc;
            (*ctxt).nodelen = len;
            (*ctxt).nodemem = len + 1 as ::core::ffi::c_int;
        } else {
            xmlSAX2ErrMemory(
                ctxt,
                b"xmlSAX2Characters\0" as *const u8 as *const ::core::ffi::c_char,
        ...
        let mut coalesceText: ::core::ffi::c_int = (!lastChild.is_null()
            ...
            as ::core::ffi::c_int;
        if coalesceText != 0 && (*ctxt).nodemem != 0 as ::core::ffi::c_int {
            if (*lastChild).content == &raw mut (*lastChild).properties as *mut xmlChar {
                (*lastChild).content = xmlStrdup((*lastChild).content);
                (*lastChild).properties = ::core::ptr::null_mut::<_xmlAttr>();
            } else if (*ctxt).nodemem == (*ctxt).nodelen + 1 as ::core::ffi::c_int
            ...
            if (*ctxt).nodelen as size_t > SIZE_T_MAX.wrapping_sub(len as size_t)
                || ((*ctxt).nodemem as size_t).wrapping_add(len as size_t)
                    > SIZE_T_MAX.wrapping_div(2 as size_t)
            {
                xmlSAX2ErrMemory(
                    ctxt,
            ...
            if (*ctxt).nodelen + len >= (*ctxt).nodemem {
                ...
                (*ctxt).nodemem = size as ::core::ffi::c_int;
                (*lastChild).content = newbuf;
            }
            memcpy(
                (*lastChild).content.offset((*ctxt).nodelen as isize) as *mut xmlChar
                    as *mut ::core::ffi::c_void,
                ch as *const ::core::ffi::c_void,
                len as size_t,
            );
            (*ctxt).nodelen += len;
            *(*lastChild).content.offset((*ctxt).nodelen as isize) = 0 as xmlChar;
            ...
            if !(*(*ctxt).node).children.is_null() {
                ...
                (*ctxt).nodemem = (*ctxt).nodelen + 1 as ::core::ffi::c_int;
            }
        } else {
            if type_0 as ::core::ffi::c_uint
                == XML_TEXT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
...
static mut xmlSAX2DefaultVersionValue: ::core::ffi::c_int = 2 as ::core::ffi::c_int;
#[no_mangle]
pub unsafe extern "C" fn xmlSAXDefaultVersion(
    mut version: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = xmlSAX2DefaultVersionValue;
    if version != 1 as ::core::ffi::c_int && version != 2 as ::core::ffi::c_int {
...
pub unsafe extern "C" fn xmlSAXVersion(
    ...
    } else if version == 1 as ::core::ffi::c_int {
...
pub unsafe extern "C" fn xmlSAX2InitDefaultSAXHandler(
    ...
    if hdlr.is_null() || (*hdlr).initialized != 0 as ::core::ffi::c_uint {
        return;
    }
...
pub unsafe extern "C" fn xmlDefaultSAXHandlerInit() {
    xmlSAXVersion(
        __xmlDefaultSAXHandler() as *mut xmlSAXHandler,
        1 as ::core::ffi::c_int,
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn htmlDefaultSAXHandlerInit() {
    xmlSAX2InitHtmlDefaultSAXHandler(__htmlDefaultSAXHandler() as *mut xmlSAXHandler);
}
#[no_mangle]
...
pub unsafe extern "C" fn docbDefaultSAXHandlerInit() {
    xmlSAX2InitDocbDefaultSAXHandler(__docbDefaultSAXHandler() as *mut xmlSAXHandler);
}
