...
extern "C" {
    ...
    fn xmlCopyError(from: xmlErrorPtr, to: xmlErrorPtr) -> ::core::ffi::c_int;
    fn __xmlRaiseError(
...
unsafe extern "C" fn xmlParserEntityCheck(
    ...
    let budget_bytes = if replacement != 0 {
        ...
        size
    } else if !ent.is_null() && (*ent).checked > 0 as ::core::ffi::c_int {
        ((*ent).checked / 2 as ::core::ffi::c_int) as size_t
    } else {
        0 as size_t
    };
    if budget_bytes != 0 {
        ...
        && (*ctxt).errNo != XML_ERR_ENTITY_LOOP as ::core::ffi::c_int
    {
        ...
        (*ctxt).depth -= 1;
        if rep.is_null() || (*ctxt).errNo == XML_ERR_ENTITY_LOOP as ::core::ffi::c_int {
    ...
    if replacement != 0 as size_t {
        if replacement < XML_MAX_TEXT_LENGTH as size_t {
            return 0 as ::core::ffi::c_int;
        }
        ...
        if size < XML_PARSER_BIG_ENTITY as size_t {
            return 0 as ::core::ffi::c_int;
        }
        if !(*ctxt).input.is_null() {
            consumed = (*(*ctxt).input)
        ...
        size = ((*ent).checked / 2 as ::core::ffi::c_int) as size_t;
        if !(*ctxt).input.is_null() {
            consumed = (*(*ctxt).input)
                .consumed
                .wrapping_add(
...
pub const XML_PARSER_CHUNK_SIZE: ::core::ffi::c_int = 100 as ::core::ffi::c_int;
...
unsafe extern "C" fn xmlFatalErr(
    ...
    match error as ::core::ffi::c_uint {
        ...
        4 => {
            errmsg = b"Document is empty\0" as *const u8 as *const ::core::ffi::c_char;
        }
        5 => {
...
pub unsafe extern "C" fn xmlHasFeature(mut feature: xmlFeature) -> ::core::ffi::c_int {
    match feature as ::core::ffi::c_uint {
        ...
        31 => return 1 as ::core::ffi::c_int,
        33 => return 1 as ::core::ffi::c_int,
...
unsafe extern "C" fn xmlAddDefAttrs(
    ...
    match current_block {
        7815301370352969686 => {
            name = xmlSplitQName3(fullname, &raw mut len);
            if name.is_null() {
                name = xmlDictLookup((*ctxt).dict, fullname, -(1 as ::core::ffi::c_int));
            ...
            if defaults.is_null() {
                ...
                if defaults.is_null() {
                    ...
                    (*defaults).nbAttrs = 0 as ::core::ffi::c_int;
                    (*defaults).maxAttrs = 4 as ::core::ffi::c_int;
                ...
                if temp.is_null() {
                    ...
                    defaults = temp;
                    (*defaults).maxAttrs *= 2 as ::core::ffi::c_int;
                    if xmlHashUpdateEntry2(
                        (*ctxt).attsDefault,
                        name,
                        prefix,
...
pub unsafe extern "C" fn xmlCheckLanguageID(
            ...
            <= '9' as i32
    {
        ...
        match current_block {
            17370781984402970873 => {}
            10231984505866708765 => {}
...
unsafe extern "C" fn nsPush(
    ...
    if (*ctxt).options & XML_PARSE_NSCLEAN as ::core::ffi::c_int != 0 {
        let mut i: ::core::ffi::c_int = 0;
        i = (*ctxt).nsNr - 2 as ::core::ffi::c_int;
        while i >= 0 as ::core::ffi::c_int {
            if *(*ctxt).nsTab.offset(i as isize) == prefix {
                if *(*ctxt).nsTab.offset((i + 1 as ::core::ffi::c_int) as isize) == URL {
    ...
    if (*ctxt).nsMax == 0 as ::core::ffi::c_int || (*ctxt).nsTab.is_null() {
        ...
        if (*ctxt).nsTab.is_null() {
            xmlErrMemory(ctxt, ::core::ptr::null::<::core::ffi::c_char>());
            (*ctxt).nsMax = 0 as ::core::ffi::c_int;
            return -(1 as ::core::ffi::c_int);
        }
    ...
    let fresh38 = (*ctxt).nsNr;
    (*ctxt).nsNr = (*ctxt).nsNr + 1;
    let ref mut fresh39 = *(*ctxt).nsTab.offset(fresh38 as isize);
    *fresh39 = prefix;
    let fresh40 = (*ctxt).nsNr;
    (*ctxt).nsNr = (*ctxt).nsNr + 1;
    let ref mut fresh41 = *(*ctxt).nsTab.offset(fresh40 as isize);
    *fresh41 = URL;
    return (*ctxt).nsNr;
}
unsafe extern "C" fn nsPop(
    ...
    while i < nr {
        (*ctxt).nsNr -= 1;
        let ref mut fresh28 = *(*ctxt).nsTab.offset((*ctxt).nsNr as isize);
...
pub unsafe extern "C" fn inputPush(
    ...
    if (*ctxt).inputNr >= (*ctxt).inputMax {
        ...
        if (*ctxt).inputTab.is_null() {
            ...
            (*ctxt).inputMax /= 2 as ::core::ffi::c_int;
            value = ::core::ptr::null_mut::<xmlParserInput>();
            return -(1 as ::core::ffi::c_int);
        }
    }
...
pub unsafe extern "C" fn inputPop(mut ctxt: xmlParserCtxtPtr) -> xmlParserInputPtr {
    ...
    let ref mut fresh1 = *(*ctxt).inputTab.offset((*ctxt).inputNr as isize);
    *fresh1 = ::core::ptr::null_mut::<xmlParserInput>();
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn nodePush(
    ...
    let ref mut fresh36 = *(*ctxt).nodeTab.offset((*ctxt).nodeNr as isize);
    *fresh36 = value;
    (*ctxt).node = value;
    let fresh37 = (*ctxt).nodeNr;
...
pub unsafe extern "C" fn nodePop(mut ctxt: xmlParserCtxtPtr) -> xmlNodePtr {
    ...
    let ref mut fresh44 = *(*ctxt).nodeTab.offset((*ctxt).nodeNr as isize);
    *fresh44 = ::core::ptr::null_mut::<xmlNode>();
    return ret;
}
unsafe extern "C" fn nameNsPush(
    ...
    match current_block {
        13752906306826530033 => {
            xmlErrMemory(ctxt, ::core::ptr::null::<::core::ffi::c_char>());
            return -(1 as ::core::ffi::c_int);
        }
        _ => {
            let ref mut fresh45 = *(*ctxt).nameTab.offset((*ctxt).nameNr as isize);
            *fresh45 = value;
            (*ctxt).name = value;
...
unsafe extern "C" fn nameNsPop(mut ctxt: xmlParserCtxtPtr) -> *const xmlChar {
    ...
    let ref mut fresh120 = *(*ctxt).nameTab.offset((*ctxt).nameNr as isize);
    *fresh120 = ::core::ptr::null::<xmlChar>();
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn namePush(
    ...
    let ref mut fresh130 = *(*ctxt).nameTab.offset((*ctxt).nameNr as isize);
    *fresh130 = value;
    (*ctxt).name = value;
    let fresh131 = (*ctxt).nameNr;
    (*ctxt).nameNr = (*ctxt).nameNr + 1;
    return fresh131;
}
#[no_mangle]
pub unsafe extern "C" fn namePop(mut ctxt: xmlParserCtxtPtr) -> *const xmlChar {
    ...
    ret = *(*ctxt).nameTab.offset((*ctxt).nameNr as isize);
    let ref mut fresh27 = *(*ctxt).nameTab.offset((*ctxt).nameNr as isize);
    *fresh27 = ::core::ptr::null::<xmlChar>();
    return ret;
}
...
unsafe extern "C" fn xmlGROW(mut ctxt: xmlParserCtxtPtr) {
        ...
        || (*(*ctxt).input).cur < (*(*ctxt).input).base
    {
        ...
        xmlFatalErr(
            ctxt,
            XML_ERR_INTERNAL_ERROR,
            b"cur index out of bound\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return;
    }
...
pub unsafe extern "C" fn xmlParseCharRef(
            ...
            as ::core::ffi::c_int == 'x' as i32
    {
        ...
        while *(*(*ctxt).input).cur as ::core::ffi::c_int != ';' as i32 {
            let fresh42 = count;
            count = count + 1;
            if fresh42 > 20 as ::core::ffi::c_int {
            ...
            as ::core::ffi::c_int == '#' as i32
    {
        ...
        while *(*(*ctxt).input).cur as ::core::ffi::c_int != ';' as i32 {
            let fresh43 = count;
            count = count + 1;
            if fresh43 > 20 as ::core::ffi::c_int {
                count = 0 as ::core::ffi::c_int;
                if (*ctxt).progressive == 0 as ::core::ffi::c_int
                    && ((*(*ctxt).input).end.offset_from((*(*ctxt).input).cur)
                        as ::core::ffi::c_long) < INPUT_CHUNK as ::core::ffi::c_long
                            ...
                            as ::core::ffi::c_uint
                {
                    ...
                    if rep.is_null() {
                        *(*ent).content.offset(0 as ::core::ffi::c_int as isize) = 0
                        ...
                        while *current as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                            ...
                            let fresh13 = nbchars;
                            nbchars = nbchars.wrapping_add(1);
                            *buffer.offset(fresh13 as isize) = *fresh12;
                            if !(nbchars.wrapping_add(XML_PARSER_BUFFER_SIZE as size_t)
                                > buffer_size)
                            {
                                continue;
                    ...
                    *buffer.offset(fresh14 as isize) = '&' as i32 as xmlChar;
                    ...
                    while i > 0 as ::core::ffi::c_int {
                        ...
                        let fresh16 = nbchars;
                        nbchars = nbchars.wrapping_add(1);
                        *buffer.offset(fresh16 as isize) = *fresh15;
                        i -= 1;
                    }
                    let fresh17 = nbchars;
                    nbchars = nbchars.wrapping_add(1);
                    *buffer.offset(fresh17 as isize) = ';' as i32 as xmlChar;
                }
...
pub unsafe extern "C" fn xmlSplitQName(
    ...
    *prefix = ::core::ptr::null_mut::<xmlChar>();
    ...
    let fresh121 = cur;
    cur = cur.offset(1);
    c = *fresh121 as ::core::ffi::c_int;
    while c != 0 as ::core::ffi::c_int && c != ':' as i32 && len < max {
        let fresh122 = len;
        len = len + 1;
        buf[fresh122 as usize] = c as xmlChar;
        let fresh123 = cur;
        cur = cur.offset(1);
        c = *fresh123 as ::core::ffi::c_int;
    }
    if len >= max {
        ...
        while c != 0 as ::core::ffi::c_int && c != ':' as i32 {
            ...
            let fresh124 = len;
            len = len + 1;
            *buffer.offset(fresh124 as isize) = c as xmlChar;
            let fresh125 = cur;
            cur = cur.offset(1);
            c = *fresh125 as ::core::ffi::c_int;
        }
    ...
    if c == ':' as i32 {
        ...
        *prefix = ret;
        ...
        while c != 0 as ::core::ffi::c_int && len < max {
            let fresh126 = len;
            len = len + 1;
            buf[fresh126 as usize] = c as xmlChar;
            let fresh127 = cur;
            cur = cur.offset(1);
            c = *fresh127 as ::core::ffi::c_int;
        }
        if len >= max {
            max = len * 2 as ::core::ffi::c_int;
            buffer = xmlMallocAtomic
            ...
            while c != 0 as ::core::ffi::c_int {
                ...
                let fresh128 = len;
                len = len + 1;
                *buffer.offset(fresh128 as isize) = c as xmlChar;
                let fresh129 = cur;
                cur = cur.offset(1);
                c = *fresh129 as ::core::ffi::c_int;
            }
            *buffer.offset(len as isize) = 0 as xmlChar;
        }
        if buffer.is_null() {
...
unsafe extern "C" fn xmlParseNameComplex(mut ctxt: xmlParserCtxtPtr) -> *const xmlChar {
    ...
    if (*ctxt).options & XML_PARSE_OLD10 as ::core::ffi::c_int == 0 as ::core::ffi::c_int
    {
                    ...
                    && c <= 0xeffff as ::core::ffi::c_int)
        {
            let fresh25 = count;
            count = count + 1;
            if fresh25 > XML_PARSER_CHUNK_SIZE {
                count = 0 as ::core::ffi::c_int;
                if (*ctxt).progressive == 0 as ::core::ffi::c_int
                    && ((*(*ctxt).input).end.offset_from((*(*ctxt).input).cur)
                        as ::core::ffi::c_long) < INPUT_CHUNK as ::core::ffi::c_long
                ...
                }) != 0)
        {
            let fresh26 = count;
            count = count + 1;
            if fresh26 > XML_PARSER_CHUNK_SIZE {
                count = 0 as ::core::ffi::c_int;
                if (*ctxt).progressive == 0 as ::core::ffi::c_int
                    && ((*(*ctxt).input).end.offset_from((*(*ctxt).input).cur)
                        as ::core::ffi::c_long) < INPUT_CHUNK as ::core::ffi::c_long
    ...
    while xmlIsNameChar(ctxt, c) != 0 {
        ...
        if len >= XML_MAX_NAMELEN {
            ...
            while xmlIsNameChar(ctxt, c) != 0 {
                let fresh31 = count;
                count = count + 1;
                if fresh31 > XML_PARSER_CHUNK_SIZE {
                    count = 0 as ::core::ffi::c_int;
                    if (*ctxt).progressive == 0 as ::core::ffi::c_int
                        && ((*(*ctxt).input).end.offset_from((*(*ctxt).input).cur)
                            as ::core::ffi::c_long) < INPUT_CHUNK as ::core::ffi::c_long
    ...
    if !((*ctxt).instate as ::core::ffi::c_int == XML_PARSER_EOF as ::core::ffi::c_int) {
        ...
        loop {
            ...
            if l == 1 as ::core::ffi::c_int {
                let fresh119 = len;
                len = len + 1;
                *buf.offset(fresh119 as isize) = c as xmlChar;
            } else {
            ...
            if c == '&' as i32 {
                    ...
                    as ::core::ffi::c_int == '#' as i32
                {
                    ...
                    if val == '&' as i32 {
                        if (*ctxt).replaceEntities != 0 {
                            ...
                            *buf.offset(fresh55 as isize) = '&' as i32 as xmlChar;
                            ...
                            let fresh56 = len;
                            len = len.wrapping_add(1);
                            *buf.offset(fresh56 as isize) = '&' as i32 as xmlChar;
                            let fresh57 = len;
                            len = len.wrapping_add(1);
                            *buf.offset(fresh57 as isize) = '#' as i32 as xmlChar;
                            let fresh58 = len;
                            len = len.wrapping_add(1);
                            *buf.offset(fresh58 as isize) = '3' as i32 as xmlChar;
                            let fresh59 = len;
                            len = len.wrapping_add(1);
                            *buf.offset(fresh59 as isize) = '8' as i32 as xmlChar;
                            let fresh60 = len;
                            len = len.wrapping_add(1);
                            *buf.offset(fresh60 as isize) = ';' as i32 as xmlChar;
                        }
                    ...
                    if !ent.is_null() {
                        (*ctxt).nbentities = (*ctxt)
                            .nbentities
                            .wrapping_add((*ent).owner as ::core::ffi::c_ulong);
                    }
                    if !ent.is_null()
                        && (*ent).etype as ::core::ffi::c_uint
                            == XML_INTERNAL_PREDEFINED_ENTITY as ::core::ffi::c_int
                        ...
                        && (*ctxt).replaceEntities != 0 as ::core::ffi::c_int
                    {
                            ...
                            if !rep.is_null() {
                                    ...
                                    != 0 as ::core::ffi::c_int
                                {
                                            ...
                                            == 0x9 as ::core::ffi::c_int
                                    {
                                        let fresh67 = len;
                                        len = len.wrapping_add(1);
                                        *buf.offset(fresh67 as isize) = 0x20 as xmlChar;
                                        current = current.offset(1);
                                    } else {
                                        let fresh68 = current;
                                        current = current.offset(1);
                                        let fresh69 = len;
                                        len = len.wrapping_add(1);
                                        *buf.offset(fresh69 as isize) = *fresh68;
                                    }
                                    if !(len.wrapping_add(10 as size_t) > buf_size) {
                                        continue;
                                    }
                        ...
                        *buf.offset(fresh71 as isize) = '&' as i32 as xmlChar;
                        ...
                        while i > 0 as ::core::ffi::c_int {
                            ...
                            let fresh73 = len;
                            len = len.wrapping_add(1);
                            *buf.offset(fresh73 as isize) = *fresh72;
                            i -= 1;
                        }
                        let fresh74 = len;
                        len = len.wrapping_add(1);
                        *buf.offset(fresh74 as isize) = ';' as i32 as xmlChar;
                    }
                }
            } else {
...
pub unsafe extern "C" fn xmlParseSystemLiteral(
    ...
    }) != 0 && cur != stop as ::core::ffi::c_int
    {
        ...
        if l == 1 as ::core::ffi::c_int {
            let fresh111 = len;
            len = len + 1;
            *buf.offset(fresh111 as isize) = cur as xmlChar;
        } else {
...
pub unsafe extern "C" fn xmlParsePubidLiteral(
        ...
        && cur as ::core::ffi::c_int != stop as ::core::ffi::c_int
    {
        ...
        let fresh112 = len;
        len = len + 1;
        *buf.offset(fresh112 as isize) = cur;
        count += 1;
        if count > 50 as ::core::ffi::c_int {
            if (*ctxt).progressive == 0 as ::core::ffi::c_int
                && (*(*ctxt).input).cur.offset_from((*(*ctxt).input).base)
...
pub unsafe extern "C" fn xmlParseTextDecl(mut ctxt: xmlParserCtxtPtr) {
    ...
    if encoding.is_null() && (*ctxt).errNo == XML_ERR_OK as ::core::ffi::c_int {
        xmlFatalErrMsg(
            ctxt,
            ...
            as ::core::ffi::c_int == '>' as i32
    {
        ...
        while *(*(*ctxt).input).cur as ::core::ffi::c_int != 0
            && *(*(*ctxt).input).cur as ::core::ffi::c_int != '>' as i32
        {
            (*(*ctxt).input).cur = (*(*ctxt).input).cur.offset(1);
        }
...
pub unsafe extern "C" fn xmlParseExternalSubset(
    ...
    if (*ctxt).myDoc.is_null() {
        ...
        (*(*ctxt).myDoc).properties = ((*(*ctxt).myDoc).properties as ::core::ffi::c_uint
            & (15 as ::core::ffi::c_uint) << 27 as ::core::ffi::c_int
            | XML_DOC_INTERNAL as ::core::ffi::c_int as ::core::ffi::c_uint
                & !((15 as ::core::ffi::c_uint) << 27 as ::core::ffi::c_int))
            as ::core::ffi::c_int;
...
pub unsafe extern "C" fn xmlParseReference(mut ctxt: xmlParserCtxtPtr) {
        ...
        if (*ctxt).charset != XML_CHAR_ENCODING_UTF8 as ::core::ffi::c_int {
            if value <= 0xff as ::core::ffi::c_int {
                ...
                if hex == 'x' as i32 || hex == 'X' as i32 {
                    snprintf(
                        &raw mut out as *mut xmlChar as *mut ::core::ffi::c_char,
                        ::core::mem::size_of::<[xmlChar; 16]>() as size_t,
                        b"#x%X\0" as *const u8 as *const ::core::ffi::c_char,
                        value,
                    );
                } else {
                    snprintf(
    ...
    if ((*ent).checked == 0 as ::core::ffi::c_int
...
unsafe extern "C" fn xmlLoadEntityContent(
    ...
    let mut input: xmlParserInputPtr = ::core::ptr::null_mut::<xmlParserInput>();
    let mut buf: xmlBufferPtr = ::core::ptr::null_mut::<xmlBuffer>();
    let mut l: ::core::ffi::c_int = 0;
    let mut c: ::core::ffi::c_int = 0;
    let mut count: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
                ...
                _ => {
                    ...
                    match current_block {
                        ...
                        _ => {
                            let fresh47 = nbatts;
                            nbatts = nbatts + 1;
                            let ref mut fresh48 = *atts.offset(fresh47 as isize);
                            *fresh48 = attname;
                            let fresh49 = nbatts;
                            nbatts = nbatts + 1;
                            let ref mut fresh50 = *atts.offset(fresh49 as isize);
                            *fresh50 = attvalue;
...
unsafe extern "C" fn xmlGetNamespace(
    ...
    while i >= 0 as ::core::ffi::c_int {
        if *(*ctxt).nsTab.offset(i as isize) == prefix {
            ...
            return *(*ctxt).nsTab.offset((i + 1 as ::core::ffi::c_int) as isize);
        }
        i -= 2 as ::core::ffi::c_int;
    }
    return ::core::ptr::null::<xmlChar>();
...
unsafe extern "C" fn xmlParseAttValueInternal(
    ...
    if normalize != 0 {
            ...
            && *in_0 as ::core::ffi::c_int != '<' as i32
        {
            ...
            let fresh54 = in_0;
            in_0 = in_0.offset(1);
            if *fresh54 as ::core::ffi::c_int == 0x20 as ::core::ffi::c_int
                && *in_0 as ::core::ffi::c_int == 0x20 as ::core::ffi::c_int
            {
                break;
            }
        ...
        if *in_0 as ::core::ffi::c_int != limit as ::core::ffi::c_int {
            current_block = 11660007094047712107;
        } else {
...
unsafe extern "C" fn xmlParseStartTag2(
    ...
    let mut nsname: *const xmlChar = ::core::ptr::null::<xmlChar>();
    let mut attvalue: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut atts: *mut *const xmlChar = (*ctxt).atts;
    let mut maxatts: ::core::ffi::c_int = (*ctxt).maxatts;
    ...
    let mut cur: ::core::ffi::c_ulong = 0;
    ...
    cur = (*(*ctxt).input).cur.offset_from((*(*ctxt).input).base) as ::core::ffi::c_long
        as ::core::ffi::c_ulong;
    inputid = (*(*ctxt).input).id;
    ...
    (*ctxt).nsNr = nsNr;
    localname = xmlParseQName(ctxt, &raw mut prefix);
        ...
        if !(attname.is_null() || attvalue.is_null()) {
            ...
            if attname == (*ctxt).str_xmlns && aprefix.is_null() {
                ...
                if URL.is_null() {
                    ...
                    if *URL as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                        ...
                        if URL == (*ctxt).str_xml_ns {
                            ...
                            current_block = 6190141405243351806;
                        ...
                        as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                {
                    ...
                    uri_0 = xmlParseURI(URL_0 as *const ::core::ffi::c_char);
                    if uri_0.is_null() {
                        xmlNsErr(
                            ctxt,
                            XML_WAR_NS_URI,
                    ...
                    } else if nsPush(ctxt, attname, URL_0) > 0 as ::core::ffi::c_int {
                        nbNs += 1;
                    }
                }
            } else {
                ...
                match current_block {
                    ...
                    _ => {
                        let fresh77 = nratts;
                        nratts = nratts + 1;
                        *(*ctxt).attallocs.offset(fresh77 as isize) = alloc;
                        let fresh78 = nbatts;
                        nbatts = nbatts + 1;
                        let ref mut fresh79 = *atts.offset(fresh78 as isize);
                        *fresh79 = attname;
                        let fresh80 = nbatts;
                        nbatts = nbatts + 1;
                        let ref mut fresh81 = *atts.offset(fresh80 as isize);
                        *fresh81 = aprefix;
                        if alloc != 0 {
                            let fresh82 = nbatts;
                            nbatts = nbatts + 1;
                            let ref mut fresh83 = *atts.offset(fresh82 as isize);
                            *fresh83 = ::core::ptr::null::<xmlChar>();
                        } else {
                            let fresh84 = nbatts;
                            nbatts = nbatts + 1;
                            let ref mut fresh85 = *atts.offset(fresh84 as isize);
                            *fresh85 = (*(*ctxt).input).base;
                        }
                        let fresh86 = nbatts;
                        nbatts = nbatts + 1;
                            ...
                            if attname == (*ctxt).str_xmlns && aprefix.is_null() {
                                ...
                                while j < nbatts {
                                    if attname == *atts.offset(j as isize)
                                        && aprefix
                                            == *atts.offset((j + 1 as ::core::ffi::c_int) as isize)
                                    {
                                        break;
                                    }
                                ...
                                if !(j < nbatts) {
                                    ...
                                    let fresh93 = nbatts;
                                    nbatts = nbatts + 1;
                                    let ref mut fresh94 = *atts.offset(fresh93 as isize);
                                    *fresh94 = attname;
                                    let fresh95 = nbatts;
                                    nbatts = nbatts + 1;
                                    let ref mut fresh96 = *atts.offset(fresh95 as isize);
                                    *fresh96 = aprefix;
                                    if aprefix.is_null() {
                                        let fresh97 = nbatts;
                                        nbatts = nbatts + 1;
                                        let ref mut fresh98 = *atts.offset(fresh97 as isize);
                                        *fresh98 = ::core::ptr::null::<xmlChar>();
                                    } else {
                                        let fresh99 = nbatts;
                                        nbatts = nbatts + 1;
                                        let ref mut fresh100 = *atts.offset(fresh99 as isize);
                                        *fresh100 = xmlGetNamespace(ctxt, aprefix);
                                    }
                                    let fresh101 = nbatts;
                                    nbatts = nbatts + 1;
                                    let ref mut fresh102 = *atts.offset(fresh101 as isize);
                                    *fresh102 = *(&raw mut (*defaults).values
                                        as *mut *const xmlChar)
                                        .offset(
                                            (5 as ::core::ffi::c_int * i + 2 as ::core::ffi::c_int)
                                                as isize,
                                    ...
                                    *fresh104 = *(&raw mut (*defaults).values
                                        as *mut *const xmlChar)
                                        .offset(
                                            (5 as ::core::ffi::c_int * i + 3 as ::core::ffi::c_int)
                                                as isize,
                                        );
                                    if (*ctxt).standalone == 1 as ::core::ffi::c_int
                                        && !(*(&raw mut (*defaults).values as *mut *const xmlChar)
                            ...
                            while j < i {
                                if *atts.offset(i as isize) == *atts.offset(j as isize) {
                                        ...
                                        == *atts.offset((j + 1 as ::core::ffi::c_int) as isize)
                                    {
                                        ...
                                        && *atts.offset((j + 2 as ::core::ffi::c_int) as isize)
                                            == nsname
                                    {
                                        xmlNsErr(
                                            ctxt,
...
pub unsafe extern "C" fn xmlParseCDSect(mut ctxt: xmlParserCtxtPtr) {
    ...
    }) != 0 && (r != ']' as i32 || s != ']' as i32 || cur != '>' as i32)
    {
        ...
        if rl == 1 as ::core::ffi::c_int {
            let fresh110 = len;
            len = len + 1;
            *buf.offset(fresh110 as isize) = r as xmlChar;
        } else {
...
unsafe extern "C" fn xmlParseElementStart(
    ...
    line = (*(*ctxt).input).line;
    if (*ctxt).sax2 != 0 {
        name = xmlParseStartTag2(ctxt, &raw mut prefix, &raw mut URI, &raw mut tlen);
    } else {
            ...
            .offset(7 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == 'g' as i32
    {
                ...
                ) == 0)
        {
            ...
            && (xmlStrcasecmp(
                ...
                || xmlStrcasecmp(
                    encoding,
                    b"UTF8\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
                ) == 0)
        {
            if !(*ctxt).encoding.is_null() {
                xmlFree
            ...
            if !handler.is_null() {
                if xmlSwitchToEncoding(ctxt, handler) < 0 as ::core::ffi::c_int {
                    (*ctxt).errNo = XML_ERR_UNSUPPORTED_ENCODING as ::core::ffi::c_int;
                    return ::core::ptr::null::<xmlChar>();
                }
            } else {
                xmlFatalErrMsgStr(
...
unsafe extern "C" fn xmlParseGetLasts(
        ...
        && (*ctxt).inputNr == 1 as ::core::ffi::c_int
    {
        ...
        if tmp < (*(*ctxt).input).base {
            *lastlt = ::core::ptr::null::<xmlChar>();
            *lastgt = ::core::ptr::null::<xmlChar>();
        } else {
            *lastlt = tmp;
            tmp = tmp.offset(1);
...
unsafe extern "C" fn xmlParseTryOrFinish(
    ...
    let mut tlen: ::core::ffi::c_int = 0;
    let mut cur: xmlChar = 0;
    let mut next: xmlChar = 0;
    let mut lastlt: *const xmlChar = ::core::ptr::null::<xmlChar>();
    let mut lastgt: *const xmlChar = ::core::ptr::null::<xmlChar>();
    if (*ctxt).input.is_null() {
        return 0 as ::core::ffi::c_int;
    }
    if !(*ctxt).input.is_null()
    ...
    loop {
        ...
        match (*ctxt).instate as ::core::ffi::c_int {
            ...
            7 => {
                    ...
                    && next as ::core::ffi::c_int == '/' as i32
                {
                        ...
                        && next as ::core::ffi::c_int == '?' as i32
                    {
                        ...
                        {
                            (*ctxt).progressive = XML_PARSER_PI as ::core::ffi::c_int;
                            current_block = 12068350383858712162;
                            break;
                        } else {
                            xmlParsePI(ctxt);
            ...
            8 => {
                ...
                if base_0 < 0 as ::core::ffi::c_int {
                    if !(avail >= XML_PARSER_BIG_BUFFER_SIZE + 2 as ::core::ffi::c_int) {
                        current_block = 12068350383858712162;
                        break;
                    }
            ...
            1 => {
                        ...
                        as ::core::ffi::c_int == 'E' as i32
                {
                    ...
                    {
                        (*ctxt).progressive = XML_PARSER_DTD as ::core::ffi::c_int;
                        current_block = 12068350383858712162;
                        break;
                    } else {
                        (*ctxt).inSubset = 1 as ::core::ffi::c_int;
                    ...
                    (*ctxt).instate = XML_PARSER_START_TAG;
                    (*ctxt).progressive = XML_PARSER_START_TAG as ::core::ffi::c_int;
                    xmlParseGetLasts(ctxt, &raw mut lastlt, &raw mut lastgt);
                }
            }
            4 => {
            ...
            3 => {
                ...
                base_1 = (*(*ctxt).input).cur.offset_from((*(*ctxt).input).base)
                    as ::core::ffi::c_long as ::core::ffi::c_int;
                if base_1 < 0 as ::core::ffi::c_int {
                    return 0 as ::core::ffi::c_int;
                }
                if (*ctxt).checkIndex > base_1 as ::core::ffi::c_long {
                    base_1 = (*ctxt).checkIndex as ::core::ffi::c_int;
                }
                buf = xmlBufContent((*(*(*ctxt).input).buf).buffer as *const xmlBuf);
                use_0 = xmlBufUse((*(*(*ctxt).input).buf).buffer);
                's_1627: loop {
                    if !((base_1 as ::core::ffi::c_uint as size_t) < use_0) {
                    ...
                    if quote as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                                ...
                                == '<' as i32
                        {
                                    ...
                                    as ::core::ffi::c_int == '-' as i32
                            {
                                ...
                                current_block = 16810214600302297821;
                            } else {
                ...
                match current_block {
                    7235894238071384538 => {
                        if quote as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                            (*ctxt).checkIndex = base_1 as ::core::ffi::c_long;
                        } else {
                            (*ctxt).checkIndex = 0 as ::core::ffi::c_long;
                        }
                        current_block = 12068350383858712162;
    ...
    match current_block {
        12068350383858712162 => return ret,
        _ => {
...
pub unsafe extern "C" fn xmlParseChunk(
    ...
    let mut remain: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    ...
    loop {
                ...
                != XML_PARSER_EOF as ::core::ffi::c_int
        {
                ...
                && !(*(*(*ctxt).input).buf).encoder.is_null()
            {
                ...
                if (*(*(*ctxt).input).buf).rawconsumed < len as ::core::ffi::c_ulong {
        ...
        if remain != 0 as ::core::ffi::c_int {
            xmlParseTryOrFinish(ctxt, 0 as ::core::ffi::c_int);
        } else {
            if !(*ctxt).input.is_null() && !(*(*ctxt).input).buf.is_null() {
                avail = xmlBufUse((*(*(*ctxt).input).buf).buffer);
            }
            if terminate != 0 || avail > XML_MAX_TEXT_LENGTH as size_t
                ...
                || xmlParseCheckTransition(
                    ...
                    (*(*ctxt).input).base.offset(old_avail as isize) as *const xmlChar
                        as *const ::core::ffi::c_char,
                    avail.wrapping_sub(old_avail) as ::core::ffi::c_int,
                ) != 0
            {
    ...
    if terminate != 0 {
        let mut cur_avail: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        if !(*ctxt).input.is_null() {
            if (*(*ctxt).input).buf.is_null() {
                cur_avail = ((*(*ctxt).input).length as ::core::ffi::c_long
                    - (*(*ctxt).input).cur.offset_from((*(*ctxt).input).base)
                        as ::core::ffi::c_long) as ::core::ffi::c_int;
            } else {
...
pub unsafe extern "C" fn xmlIOParseDTD(
    ...
    (*pinput).filename = ::core::ptr::null::<::core::ffi::c_char>();
    (*pinput).line = 1 as ::core::ffi::c_int;
    (*pinput).col = 1 as ::core::ffi::c_int;
...
pub unsafe extern "C" fn xmlSAXParseDTD(
    ...
    {
        enc = xmlDetectCharEncoding(
            (*(*ctxt).input).cur as *const ::core::ffi::c_uchar,
            4 as ::core::ffi::c_int,
        );
        xmlSwitchEncoding(ctxt, enc);
    }
...
unsafe extern "C" fn xmlParseBalancedChunkMemoryInternal(
    ...
    ctxt = xmlCreateMemoryParserCtxt(string as *mut ::core::ffi::c_char, size);
    if ctxt.is_null() {
        return XML_WAR_UNDECLARED_ENTITY;
    }
    ...
    (*ctxt).dict = (*oldctxt).dict;
    (*ctxt).input_id = (*oldctxt).input_id + 1 as ::core::ffi::c_int;
    (*ctxt).str_xml = xmlDictLookup(
        (*ctxt).dict,
        b"xml\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
        3 as ::core::ffi::c_int,
...
pub unsafe extern "C" fn xmlParseInNodeContext(
    ...
    (*ctxt).instate = XML_PARSER_CONTENT;
    fake = xmlNewComment(::core::ptr::null::<xmlChar>());
    if fake.is_null() {
        xmlFreeParserCtxt(ctxt);
        return XML_ERR_NO_MEMORY;
    }
        ...
        == XML_ELEMENT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
    {
                ...
                == XML_ELEMENT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
        {
            ...
            let mut iprefix: *const xmlChar = ::core::ptr::null::<xmlChar>();
...
pub unsafe extern "C" fn xmlParseBalancedChunkMemoryRecover(
    ...
    if !doc.is_null() && !(*doc).dict.is_null() {
        ...
        xmlCtxtUseOptionsInternal(
            ctxt,
            XML_PARSE_NODICT as ::core::ffi::c_int,
            ::core::ptr::null::<::core::ffi::c_char>(),
        );
    }
    if !doc.is_null() {
    ...
    if doc.is_null() {
        ...
        (*ctxt).myDoc = newDoc;
        (*(*newDoc).children).doc = doc as *mut _xmlDoc;
...
pub unsafe extern "C" fn xmlCreateDocParserCtxt(
    ...
    len = xmlStrlen(cur);
    return xmlCreateMemoryParserCtxt(cur as *const ::core::ffi::c_char, len);
}
#[no_mangle]
...
pub unsafe extern "C" fn xmlCtxtResetPush(
    ...
    if encoding.is_null() && !chunk.is_null() && size >= 4 as ::core::ffi::c_int {
        enc = xmlDetectCharEncoding(chunk as *const ::core::ffi::c_uchar, size);
    }
    buf = xmlAllocParserInputBuffer(enc);
    if buf.is_null() {
    ...
    } else if enc as ::core::ffi::c_int != XML_CHAR_ENCODING_NONE as ::core::ffi::c_int {
        xmlSwitchEncoding(ctxt, enc);
    }
    return 0 as ::core::ffi::c_int;
}
