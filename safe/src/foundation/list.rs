...
#[no_mangle]
pub unsafe extern "C" fn xmlListDup(old: xmlListPtr) -> xmlListPtr { unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn xmlListCopy(mut cur: xmlListPtr, old: xmlListPtr) -> ::core::ffi::c_int { unsafe {
    let mut lk: xmlLinkPtr = ::core::ptr::null_mut::<xmlLink>();
