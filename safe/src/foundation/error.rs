...
extern "C" {
    ...
    fn __xmlStructuredErrorContext() -> *mut *mut ::core::ffi::c_void;
...
unsafe extern "C" fn xmlReportError(
    ...
    if !ctxt.is_null() {
        ...
        && (domain == XML_FROM_PARSER as ::core::ffi::c_int
            || domain == XML_FROM_SCHEMASV as ::core::ffi::c_int
            || domain == XML_FROM_SCHEMASP as ::core::ffi::c_int
            || domain == XML_FROM_DTD as ::core::ffi::c_int
...
pub unsafe extern "C" fn xmlCopyError(
    ...
    let mut str2: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
    let mut str3: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
