...
pub struct _xmlSchematron {
    ...
    pub nbNs: ::core::ffi::c_int,
    pub nbPattern: ::core::ffi::c_int,
    pub patterns: xmlSchematronPatternPtr,
    pub rules: xmlSchematronRulePtr,
    pub nbNamespaces: ::core::ffi::c_int,
    pub maxNamespaces: ::core::ffi::c_int,
...
pub type xmlSchematronTestType = ::core::ffi::c_uint;
...
pub struct _xmlSchematronParserCtxt {
    ...
    pub maxNamespaces: ::core::ffi::c_int,
    pub namespaces: *mut *const xmlChar,
    pub nbIncludes: ::core::ffi::c_int,
    pub maxIncludes: ::core::ffi::c_int,
...
static mut xmlSchematronNs: *const xmlChar = b"http://purl.oclc.org/dsdl/schematron\0" as *const u8
    as *const ::core::ffi::c_char as *mut xmlChar;
static mut xmlOldSchematronNs: *const xmlChar = b"http://www.ascc.net/xml/schematron\0" as *const u8
    as *const ::core::ffi::c_char as *mut xmlChar;
pub const XML_STRON_CTXT_PARSER: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
pub const XML_STRON_CTXT_VALIDATOR: ::core::ffi::c_int = 2 as ::core::ffi::c_int;
unsafe extern "C" fn xmlSchematronPErrMemory(
    ...
    __xmlSimpleError(
        XML_FROM_SCHEMASP as ::core::ffi::c_int,
...
unsafe extern "C" fn xmlSchematronVErrMemory(
    ...
    if !ctxt.is_null() {
        (*ctxt).nberrors += 1;
        (*ctxt).err = XML_SCHEMAV_INTERNAL as ::core::ffi::c_int;
    }
    __xmlSimpleError(
        XML_FROM_SCHEMASV as ::core::ffi::c_int,
        XML_ERR_NO_MEMORY as ::core::ffi::c_int,
        node,
        ::core::ptr::null::<::core::ffi::c_char>(),
        extra,
...
unsafe extern "C" fn xmlSchematronAddTest(
    ...
    let mut ret: xmlSchematronTestPtr = ::core::ptr::null_mut::<xmlSchematronTest>();
    ...
    if ctxt.is_null() || rule.is_null() || node.is_null() || test.is_null() {
        return ::core::ptr::null_mut::<xmlSchematronTest>();
    }
    ...
    if comp.is_null() {
        xmlSchematronPErr(
            ctxt,
            node,
            XML_SCHEMAP_NOROOT as ::core::ffi::c_int,
            b"Failed to compile test expression %s\0" as *const u8 as *const ::core::ffi::c_char,
            test,
    ...
    ret = xmlMalloc.expect("non-null function pointer")(
        ::core::mem::size_of::<xmlSchematronTest>() as size_t
    ) as xmlSchematronTestPtr;
    if ret.is_null() {
        xmlSchematronPErrMemory(
            ctxt,
            b"allocating schema test\0" as *const u8 as *const ::core::ffi::c_char,
            node,
        );
        return ::core::ptr::null_mut::<xmlSchematronTest>();
    }
    ...
    (*ret).comp = comp;
    (*ret).report = report;
    (*ret).next = ::core::ptr::null_mut::<xmlSchematronTest>();
...
unsafe extern "C" fn xmlSchematronFreeTests(mut tests: xmlSchematronTestPtr) {
    let mut next: xmlSchematronTestPtr = ::core::ptr::null_mut::<xmlSchematronTest>();
    while !tests.is_null() {
        next = (*tests).next;
        if !(*tests).test.is_null() {
            xmlFree.expect("non-null function pointer")((*tests).test as *mut ::core::ffi::c_void);
        }
        ...
        if !(*tests).report.is_null() {
            xmlFree.expect("non-null function pointer")(
                (*tests).report as *mut ::core::ffi::c_void,
            );
        }
        xmlFree.expect("non-null function pointer")(tests as *mut ::core::ffi::c_void);
        tests = next;
    }
}
unsafe extern "C" fn xmlSchematronAddRule(
    ...
    let mut ret: xmlSchematronRulePtr = ::core::ptr::null_mut::<xmlSchematronRule>();
    let mut pattern: xmlPatternPtr = ::core::ptr::null_mut::<xmlPattern>();
    if ctxt.is_null() || schema.is_null() || node.is_null() || context.is_null() {
        return ::core::ptr::null_mut::<xmlSchematronRule>();
    }
    pattern = xmlPatterncompile(
        context,
        (*ctxt).dict as *mut xmlDict,
    ...
    if pattern.is_null() {
        xmlSchematronPErr(
            ...
            node,
            XML_SCHEMAP_NOROOT as ::core::ffi::c_int,
            b"Failed to compile context expression %s\0" as *const u8 as *const ::core::ffi::c_char,
            context,
            ::core::ptr::null::<xmlChar>(),
        );
    }
    ret = xmlMalloc.expect("non-null function pointer")(
        ::core::mem::size_of::<xmlSchematronRule>() as size_t
    ) as xmlSchematronRulePtr;
    if ret.is_null() {
        xmlSchematronPErrMemory(
            ctxt,
            b"allocating schema rule\0" as *const u8 as *const ::core::ffi::c_char,
            node,
        );
        return ::core::ptr::null_mut::<xmlSchematronRule>();
    }
    ...
    (*ret).pattern = pattern;
    (*ret).report = report;
    (*ret).next = ::core::ptr::null_mut::<xmlSchematronRule>();
    ...
    (*ret).patnext = ::core::ptr::null_mut::<xmlSchematronRule>();
...
unsafe extern "C" fn xmlSchematronFreeRules(mut rules: xmlSchematronRulePtr) {
    let mut next: xmlSchematronRulePtr = ::core::ptr::null_mut::<xmlSchematronRule>();
    while !rules.is_null() {
        next = (*rules).next;
        ...
        if !(*rules).context.is_null() {
            xmlFree.expect("non-null function pointer")(
                (*rules).context as *mut ::core::ffi::c_void,
            );
        }
        ...
        if !(*rules).report.is_null() {
            xmlFree.expect("non-null function pointer")(
                (*rules).report as *mut ::core::ffi::c_void,
            );
        }
        xmlFree.expect("non-null function pointer")(rules as *mut ::core::ffi::c_void);
        rules = next;
    }
}
unsafe extern "C" fn xmlSchematronAddPattern(
    ...
    let mut ret: xmlSchematronPatternPtr = ::core::ptr::null_mut::<xmlSchematronPattern>();
    if ctxt.is_null() || schema.is_null() || node.is_null() || name.is_null() {
        return ::core::ptr::null_mut::<xmlSchematronPattern>();
    }
    ret = xmlMalloc.expect("non-null function pointer")(
        ::core::mem::size_of::<xmlSchematronPattern>() as size_t,
    ) as xmlSchematronPatternPtr;
    if ret.is_null() {
        xmlSchematronPErrMemory(
            ctxt,
            b"allocating schema pattern\0" as *const u8 as *const ::core::ffi::c_char,
            node,
        );
        return ::core::ptr::null_mut::<xmlSchematronPattern>();
    }
    ...
    (*ret).name = name;
    (*ret).next = ::core::ptr::null_mut::<xmlSchematronPattern>();
...
unsafe extern "C" fn xmlSchematronFreePatterns(mut patterns: xmlSchematronPatternPtr) {
    let mut next: xmlSchematronPatternPtr = ::core::ptr::null_mut::<xmlSchematronPattern>();
    while !patterns.is_null() {
        next = (*patterns).next;
        if !(*patterns).name.is_null() {
            xmlFree.expect("non-null function pointer")(
                (*patterns).name as *mut ::core::ffi::c_void,
            );
        }
        xmlFree.expect("non-null function pointer")(patterns as *mut ::core::ffi::c_void);
        patterns = next;
    }
}
unsafe extern "C" fn xmlSchematronNewSchematron(
    ...
    let mut ret: xmlSchematronPtr = ::core::ptr::null_mut::<xmlSchematron>();
    ret = xmlMalloc.expect("non-null function pointer")(
        ::core::mem::size_of::<xmlSchematron>() as size_t
    ) as xmlSchematronPtr;
    if ret.is_null() {
        xmlSchematronPErrMemory(
            ctxt,
            b"allocating schema\0" as *const u8 as *const ::core::ffi::c_char,
            ::core::ptr::null_mut::<xmlNode>(),
        );
        return ::core::ptr::null_mut::<xmlSchematron>();
    }
    memset(
        ret as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
...
pub unsafe extern "C" fn xmlSchematronFree(mut schema: xmlSchematronPtr) {
    ...
    if !(*schema).namespaces.is_null() {
        xmlFree.expect("non-null function pointer")(
            (*schema).namespaces as *mut *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
        );
    }
...
pub unsafe extern "C" fn xmlSchematronNewParserCtxt(
    ...
    let mut ret: xmlSchematronParserCtxtPtr = ::core::ptr::null_mut::<xmlSchematronParserCtxt>();
    if URL.is_null() {
        return ::core::ptr::null_mut::<xmlSchematronParserCtxt>();
    }
    ret = xmlMalloc.expect("non-null function pointer")(::core::mem::size_of::<
        xmlSchematronParserCtxt,
    >() as size_t) as xmlSchematronParserCtxtPtr;
    if ret.is_null() {
        xmlSchematronPErrMemory(
            ::core::ptr::null_mut::<xmlSchematronParserCtxt>(),
            b"allocating schema parser context\0" as *const u8 as *const ::core::ffi::c_char,
            ::core::ptr::null_mut::<xmlNode>(),
        );
        return ::core::ptr::null_mut::<xmlSchematronParserCtxt>();
    }
    memset(
        ret as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<xmlSchematronParserCtxt>() as size_t,
    );
    (*ret).type_0 = XML_STRON_CTXT_PARSER;
    (*ret).dict = xmlDictCreate();
    (*ret).URL = xmlDictLookup(
        (*ret).dict,
        URL as *const xmlChar,
        -(1 as ::core::ffi::c_int),
    );
    (*ret).includes = ::core::ptr::null_mut::<xmlNodePtr>();
    (*ret).xctxt = xmlXPathNewContext(::core::ptr::null_mut::<xmlDoc>());
    if (*ret).xctxt.is_null() {
        xmlSchematronPErrMemory(
            ::core::ptr::null_mut::<xmlSchematronParserCtxt>(),
            b"allocating schema parser XPath context\0" as *const u8 as *const ::core::ffi::c_char,
            ::core::ptr::null_mut::<xmlNode>(),
        );
...
pub unsafe extern "C" fn xmlSchematronNewDocParserCtxt(
    ...
    (*ret).doc = doc;
    (*ret).dict = xmlDictCreate();
    (*ret).preserve = 1 as ::core::ffi::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchematronFreeParserCtxt(mut ctxt: xmlSchematronParserCtxtPtr) {
    if ctxt.is_null() {
        return;
    }
    ...
    if !(*ctxt).namespaces.is_null() {
        xmlFree.expect("non-null function pointer")(
            (*ctxt).namespaces as *mut *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
        );
    }
...
unsafe extern "C" fn xmlSchematronAddNamespace(
    ...
    if (*ctxt).namespaces.is_null() {
        (*ctxt).maxNamespaces = 10 as ::core::ffi::c_int;
        (*ctxt).namespaces = xmlMalloc.expect("non-null function pointer")(
            (((*ctxt).maxNamespaces * 2 as ::core::ffi::c_int) as size_t)
                .wrapping_mul(::core::mem::size_of::<*const xmlChar>() as size_t),
        ) as *mut *const xmlChar;
        if (*ctxt).namespaces.is_null() {
            xmlSchematronPErrMemory(
                ::core::ptr::null_mut::<xmlSchematronParserCtxt>(),
                b"allocating parser namespaces\0" as *const u8 as *const ::core::ffi::c_char,
                ::core::ptr::null_mut::<xmlNode>(),
            );
            return;
        }
        (*ctxt).nbNamespaces = 0 as ::core::ffi::c_int;
    } else if (*ctxt).nbNamespaces + 2 as ::core::ffi::c_int >= (*ctxt).maxNamespaces {
        let mut tmp: *mut *const xmlChar = ::core::ptr::null_mut::<*const xmlChar>();
        tmp = xmlRealloc.expect("non-null function pointer")(
            (*ctxt).namespaces as *mut *mut xmlChar as *mut ::core::ffi::c_void,
            (((*ctxt).maxNamespaces * 4 as ::core::ffi::c_int) as size_t)
                .wrapping_mul(::core::mem::size_of::<*const xmlChar>() as size_t),
        ) as *mut *const xmlChar;
        if tmp.is_null() {
            xmlSchematronPErrMemory(
        ...
        (*ctxt).namespaces = tmp;
        (*ctxt).maxNamespaces *= 2 as ::core::ffi::c_int;
    }
    let ref mut fresh0 = *(*ctxt)
        .namespaces
        .offset((2 as ::core::ffi::c_int * (*ctxt).nbNamespaces) as isize);
    *fresh0 = xmlDictLookup((*ctxt).dict, ns, -(1 as ::core::ffi::c_int));
    let ref mut fresh1 = *(*ctxt).namespaces.offset(
        (2 as ::core::ffi::c_int * (*ctxt).nbNamespaces + 1 as ::core::ffi::c_int) as isize,
    );
    *fresh1 = xmlDictLookup((*ctxt).dict, prefix, -(1 as ::core::ffi::c_int));
    (*ctxt).nbNamespaces += 1;
    let ref mut fresh2 = *(*ctxt)
        .namespaces
        .offset((2 as ::core::ffi::c_int * (*ctxt).nbNamespaces) as isize);
    *fresh2 = ::core::ptr::null::<xmlChar>();
    let ref mut fresh3 = *(*ctxt).namespaces.offset(
        (2 as ::core::ffi::c_int * (*ctxt).nbNamespaces + 1 as ::core::ffi::c_int) as isize,
    );
    *fresh3 = ::core::ptr::null::<xmlChar>();
}
unsafe extern "C" fn xmlSchematronParseRule(
    ...
    let mut nbChecks: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut test: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut context: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut report: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
    let mut ruleptr: xmlSchematronRulePtr = ::core::ptr::null_mut::<xmlSchematronRule>();
    let mut testptr: xmlSchematronTestPtr = ::core::ptr::null_mut::<xmlSchematronTest>();
    if ctxt.is_null() || rule.is_null() {
        return;
    }
    context = xmlGetNoNsProp(
        rule as *const xmlNode,
        b"context\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
    );
    if context.is_null() {
        xmlSchematronPErr(
            ctxt,
            rule,
            XML_SCHEMAP_NOROOT as ::core::ffi::c_int,
            b"rule has no context attribute\0" as *const u8 as *const ::core::ffi::c_char,
            ::core::ptr::null::<xmlChar>(),
            ::core::ptr::null::<xmlChar>(),
        );
        return;
    } else if *context.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
        == 0 as ::core::ffi::c_int
    {
        xmlSchematronPErr(
            ctxt,
            rule,
            XML_SCHEMAP_NOROOT as ::core::ffi::c_int,
            b"rule has an empty context attribute\0" as *const u8 as *const ::core::ffi::c_char,
            ::core::ptr::null::<xmlChar>(),
            ::core::ptr::null::<xmlChar>(),
        );
        xmlFree.expect("non-null function pointer")(context as *mut ::core::ffi::c_void);
        return;
    } else {
    ...
    cur = (*rule).children as xmlNodePtr;
    while !cur.is_null() {
    ...
    while !cur.is_null() {
        if !cur.is_null()
            ...
            && xmlStrEqual(
                (*cur).name,
                b"assert\0" as *const u8 as *const ::core::ffi::c_char as *const xmlChar,
            ) != 0
            && (xmlStrEqual((*(*cur).ns).href, xmlSchematronNs) != 0
                || xmlStrEqual((*(*cur).ns).href, xmlOldSchematronNs) != 0)
        {
            ...
            test = xmlGetNoNsProp(
                ...
                b"test\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            );
            if test.is_null() {
                xmlSchematronPErr(
                    ctxt,
                    cur,
                    XML_SCHEMAP_NOROOT as ::core::ffi::c_int,
                    b"assert has no test attribute\0" as *const u8 as *const ::core::ffi::c_char,
                    ::core::ptr::null::<xmlChar>(),
                    ::core::ptr::null::<xmlChar>(),
                );
            } else if *test.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                == 0 as ::core::ffi::c_int
            {
                xmlSchematronPErr(
                    ctxt,
                ...
                xmlFree.expect("non-null function pointer")(test as *mut ::core::ffi::c_void);
            } else {
            ...
            && xmlStrEqual(
                (*cur).name,
                b"report\0" as *const u8 as *const ::core::ffi::c_char as *const xmlChar,
            ) != 0
            && (xmlStrEqual((*(*cur).ns).href, xmlSchematronNs) != 0
                || xmlStrEqual((*(*cur).ns).href, xmlOldSchematronNs) != 0)
        {
    ...
    if nbChecks == 0 as ::core::ffi::c_int {
        xmlSchematronPErr(
            ctxt,
            rule,
            XML_SCHEMAP_NOROOT as ::core::ffi::c_int,
            b"rule has no assert nor report element\0" as *const u8 as *const ::core::ffi::c_char,
            ::core::ptr::null::<xmlChar>(),
            ::core::ptr::null::<xmlChar>(),
        );
    }
...
unsafe extern "C" fn xmlSchematronParsePattern(
    ...
    let mut cur: xmlNodePtr = ::core::ptr::null_mut::<xmlNode>();
    let mut pattern: xmlSchematronPatternPtr = ::core::ptr::null_mut::<xmlSchematronPattern>();
    let mut nbRules: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    ...
    cur = (*pat).children as xmlNodePtr;
    while !cur.is_null() {
        if (*cur).type_0 as ::core::ffi::c_uint
            == XML_ELEMENT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
            && !(*cur).ns.is_null()
    ...
    while !cur.is_null() {
        if !cur.is_null()
            ...
            && xmlStrEqual(
                (*cur).name,
                b"rule\0" as *const u8 as *const ::core::ffi::c_char as *const xmlChar,
            ) != 0
            && (xmlStrEqual((*(*cur).ns).href, xmlSchematronNs) != 0
                || xmlStrEqual((*(*cur).ns).href, xmlOldSchematronNs) != 0)
        {
    ...
    if nbRules == 0 as ::core::ffi::c_int {
        xmlSchematronPErr(
            ctxt,
            pat,
            XML_SCHEMAP_NOROOT as ::core::ffi::c_int,
            b"Pattern has no rule element\0" as *const u8 as *const ::core::ffi::c_char,
            ::core::ptr::null::<xmlChar>(),
            ::core::ptr::null::<xmlChar>(),
        );
    }
...
pub unsafe extern "C" fn xmlSchematronParse(
    ...
    let mut cur: xmlNodePtr = ::core::ptr::null_mut::<xmlNode>();
    let mut preserve: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    if ctxt.is_null() {
        return ::core::ptr::null_mut::<xmlSchematron>();
    }
    (*ctxt).nberrors = 0 as ::core::ffi::c_int;
    if !(*ctxt).URL.is_null() {
        doc = xmlReadFile(
        ...
        if doc.is_null() {
            xmlSchematronPErr(
                ctxt,
                ::core::ptr::null_mut::<xmlNode>(),
                XML_SCHEMAP_FAILED_LOAD as ::core::ffi::c_int,
        ...
        (*ctxt).preserve = 0 as ::core::ffi::c_int;
        ...
        if doc.is_null() {
            xmlSchematronPErr(
                ctxt,
                ::core::ptr::null_mut::<xmlNode>(),
                XML_SCHEMAP_FAILED_PARSE as ::core::ffi::c_int,
        ...
        doc = (*ctxt).doc;
        preserve = 1 as ::core::ffi::c_int;
        (*ctxt).preserve = 1 as ::core::ffi::c_int;
    } else {
        xmlSchematronPErr(
            ctxt,
            ::core::ptr::null_mut::<xmlNode>(),
            XML_SCHEMAP_NOTHING_TO_PARSE as ::core::ffi::c_int,
    ...
    if !(!root.is_null()
        ...
        && xmlStrEqual(
            (*root).name,
            b"schema\0" as *const u8 as *const ::core::ffi::c_char as *const xmlChar,
        ) != 0
            ...
            || xmlStrEqual((*(*root).ns).href, xmlOldSchematronNs) != 0))
    {
        ...
        if !ret.is_null() {
            (*ctxt).schema = ret;
            cur = (*root).children as xmlNodePtr;
            while !cur.is_null() {
                if (*cur).type_0 as ::core::ffi::c_uint
                    == XML_ELEMENT_NODE as ::core::ffi::c_int as ::core::ffi::c_uint
                    && !(*cur).ns.is_null()
            ...
            if !cur.is_null()
                ...
                && xmlStrEqual(
                    (*cur).name,
                    b"title\0" as *const u8 as *const ::core::ffi::c_char as *const xmlChar,
                ) != 0
                && (xmlStrEqual((*(*cur).ns).href, xmlSchematronNs) != 0
                    || xmlStrEqual((*(*cur).ns).href, xmlOldSchematronNs) != 0)
            {
                ...
                if !title.is_null() {
                    (*ret).title = xmlDictLookup((*ret).dict, title, -(1 as ::core::ffi::c_int));
                    xmlFree.expect("non-null function pointer")(title as *mut ::core::ffi::c_void);
                }
                cur = (*cur).next as xmlNodePtr;
                while !cur.is_null() {
                    if (*cur).type_0 as ::core::ffi::c_uint
            ...
            while !cur.is_null()
                ...
                && xmlStrEqual(
                    (*cur).name,
                    b"ns\0" as *const u8 as *const ::core::ffi::c_char as *const xmlChar,
                ) != 0
                && (xmlStrEqual((*(*cur).ns).href, xmlSchematronNs) != 0
                    || xmlStrEqual((*(*cur).ns).href, xmlOldSchematronNs) != 0)
            {
                let mut prefix: *mut xmlChar = xmlGetNoNsProp(
                    cur as *const xmlNode,
                    b"prefix\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
                );
                        ...
                        == 0 as ::core::ffi::c_int
                {
                    xmlSchematronPErr(
                        ...
                        cur,
                        XML_SCHEMAP_NOROOT as ::core::ffi::c_int,
                        b"ns element has no uri\0" as *const u8 as *const ::core::ffi::c_char,
                        ::core::ptr::null::<xmlChar>(),
                        ::core::ptr::null::<xmlChar>(),
                    );
                }
                if prefix.is_null()
                    || *prefix.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                        == 0 as ::core::ffi::c_int
                {
                    xmlSchematronPErr(
                        ctxt,
                        cur,
                        XML_SCHEMAP_NOROOT as ::core::ffi::c_int,
                        b"ns element has no prefix\0" as *const u8 as *const ::core::ffi::c_char,
                        ::core::ptr::null::<xmlChar>(),
                        ::core::ptr::null::<xmlChar>(),
                    );
                }
            ...
            while !cur.is_null() {
                if !cur.is_null()
                    ...
                    && xmlStrEqual(
                        (*cur).name,
                        b"pattern\0" as *const u8 as *const ::core::ffi::c_char as *const xmlChar,
                    ) != 0
                    && (xmlStrEqual((*(*cur).ns).href, xmlSchematronNs) != 0
                        || xmlStrEqual((*(*cur).ns).href, xmlOldSchematronNs) != 0)
                {
            ...
            if (*ret).nbPattern == 0 as ::core::ffi::c_int {
                xmlSchematronPErr(
                    ctxt,
                    root,
                    XML_SCHEMAP_NOROOT as ::core::ffi::c_int,
    ...
    if !ret.is_null() {
        if (*ctxt).nberrors != 0 as ::core::ffi::c_int {
            ...
            ret = ::core::ptr::null_mut::<xmlSchematron>();
        } else {
            (*ret).namespaces = (*ctxt).namespaces;
            (*ret).nbNamespaces = (*ctxt).nbNamespaces;
            (*ctxt).namespaces = ::core::ptr::null_mut::<*const xmlChar>();
        }
    }
    return ret;
}
unsafe extern "C" fn xmlSchematronGetNode(
    ...
    (*(*ctxt).xctxt).doc = (*cur).doc as xmlDocPtr;
    (*(*ctxt).xctxt).node = cur;
...
unsafe extern "C" fn xmlSchematronFormatReport(
    ...
    child = (*test).children as xmlNodePtr;
    while !child.is_null() {
        ...
        {
            let mut obj: *mut xmlXPathObject = ::core::ptr::null_mut::<xmlXPathObject>();
            let mut path: *mut xmlChar = ::core::ptr::null_mut::<xmlChar>();
            path = xmlGetNoNsProp(
                child as *const xmlNode,
                b"path\0" as *const u8 as *const ::core::ffi::c_char as *mut xmlChar,
            );
            node = cur;
            if !path.is_null() {
                obj = xmlSchematronGetNode(ctxt, cur, path) as *mut xmlXPathObject;
                if !obj.is_null()
                    && (*obj).type_0 as ::core::ffi::c_uint
                        == XPATH_NODESET as ::core::ffi::c_int as ::core::ffi::c_uint
                    && !(*obj).nodesetval.is_null()
                    && (*(*obj).nodesetval).nodeNr > 0 as ::core::ffi::c_int
                {
                    node = *(*(*obj).nodesetval)
                        .nodeTab
        ...
        if !ret.is_null() {
            let mut len: ::core::ffi::c_int = xmlStrlen(ret);
            let mut c: xmlChar = 0;
            if len > 0 as ::core::ffi::c_int {
                c = *ret.offset((len - 1 as ::core::ffi::c_int) as isize);
                    ...
                    || c as ::core::ffi::c_int == '\t' as i32
                {
                    ...
                    *ret.offset((len + 1 as ::core::ffi::c_int) as isize) = 0 as xmlChar;
                }
            }
        }
        child = (*child).next as xmlNodePtr;
...
unsafe extern "C" fn xmlSchematronReportSuccess(
    ...
    if (*ctxt).flags & XML_SCHEMATRON_OUT_QUIET as ::core::ffi::c_int != 0
        && (*ctxt).flags & XML_SCHEMATRON_OUT_XML as ::core::ffi::c_int == 0 as ::core::ffi::c_int
        && (*test).type_0 as ::core::ffi::c_uint
            == XML_SCHEMATRON_REPORT as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        return;
    }
    if (*ctxt).flags & XML_SCHEMATRON_OUT_XML as ::core::ffi::c_int != 0 {
        (*__xmlGenericError()).expect("non-null function pointer")(
            *__xmlGenericErrorContext(),
            b"Unimplemented block at %s:%d\n\0" as *const u8 as *const ::core::ffi::c_char,
            b"/home/yans/code/safelibs/ported/libxml/original/schematron.c\0" as *const u8
                as *const ::core::ffi::c_char,
        ...
        let mut line: ::core::ffi::c_long = 0;
        let mut report: *const xmlChar = ::core::ptr::null::<xmlChar>();
        if ((*test).type_0 as ::core::ffi::c_uint
            == XML_SCHEMATRON_REPORT as ::core::ffi::c_int as ::core::ffi::c_uint)
            as ::core::ffi::c_int
            & (success == 0) as ::core::ffi::c_int
            != 0
            || ((*test).type_0 as ::core::ffi::c_uint
                == XML_SCHEMATRON_ASSERT as ::core::ffi::c_int as ::core::ffi::c_uint)
                as ::core::ffi::c_int
                & success
                != 0
        {
        ...
        if report.is_null() {
            ...
            {
                report = xmlStrdup(
                    b"node failed assert\0" as *const u8 as *const ::core::ffi::c_char
                        as *const xmlChar,
                );
            } else {
                report = xmlStrdup(
                    b"node failed report\0" as *const u8 as *const ::core::ffi::c_char
                        as *const xmlChar,
                );
            }
        }
        snprintf(
            ...
            line,
            report as *const ::core::ffi::c_char,
        );
        if (*ctxt).flags & XML_SCHEMATRON_OUT_ERROR as ::core::ffi::c_int != 0 {
            let mut schannel: xmlStructuredErrorFunc = None;
            let mut channel: xmlGenericErrorFunc = None;
            let mut data: *mut ::core::ffi::c_void = NULL;
            if !ctxt.is_null() {
            ...
            __xmlRaiseError(
                ...
                XML_FROM_SCHEMATRONV as ::core::ffi::c_int,
                if (*test).type_0 as ::core::ffi::c_uint
                    == XML_SCHEMATRON_ASSERT as ::core::ffi::c_int as ::core::ffi::c_uint
                {
                    XML_SCHEMATRONV_ASSERT as ::core::ffi::c_int
                } else {
                    XML_SCHEMATRONV_REPORT as ::core::ffi::c_int
                },
                XML_ERR_ERROR,
                ::core::ptr::null::<::core::ffi::c_char>(),
                ...
                if pattern.is_null() {
                    ...
                    (*pattern).name as *const ::core::ffi::c_char
                },
                path as *const ::core::ffi::c_char,
                report as *const ::core::ffi::c_char,
                0 as ::core::ffi::c_int,
        ...
        xmlFree.expect("non-null function pointer")(
            report as *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
        );
...
unsafe extern "C" fn xmlSchematronReportPattern(
    ...
    if (*ctxt).flags & XML_SCHEMATRON_OUT_QUIET as ::core::ffi::c_int != 0
        || (*ctxt).flags & XML_SCHEMATRON_OUT_ERROR as ::core::ffi::c_int != 0
    {
        return;
    }
    if (*ctxt).flags & XML_SCHEMATRON_OUT_XML as ::core::ffi::c_int != 0 {
...
pub unsafe extern "C" fn xmlSchematronNewValidCtxt(
    ...
    let mut ret: xmlSchematronValidCtxtPtr = ::core::ptr::null_mut::<xmlSchematronValidCtxt>();
    ret = xmlMalloc.expect("non-null function pointer")(
        ::core::mem::size_of::<xmlSchematronValidCtxt>() as size_t,
    ) as xmlSchematronValidCtxtPtr;
    if ret.is_null() {
        xmlSchematronVErrMemory(
            ::core::ptr::null_mut::<xmlSchematronValidCtxt>(),
            b"allocating validation context\0" as *const u8 as *const ::core::ffi::c_char,
            ::core::ptr::null_mut::<xmlNode>(),
        );
        return ::core::ptr::null_mut::<xmlSchematronValidCtxt>();
    }
    memset(
        ret as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
    ...
    (*ret).type_0 = XML_STRON_CTXT_VALIDATOR;
    (*ret).schema = schema;
    (*ret).xctxt = xmlXPathNewContext(::core::ptr::null_mut::<xmlDoc>());
    (*ret).flags = options;
    if (*ret).xctxt.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchematronFreeValidCtxt(mut ctxt: xmlSchematronValidCtxtPtr) {
    if ctxt.is_null() {
        return;
    }
    if !(*ctxt).xctxt.is_null() {
...
unsafe extern "C" fn xmlSchematronRunTest(
    ...
    if ret.is_null() {
        ...
        match (*ret).type_0 as ::core::ffi::c_uint {
            9 | 1 => {
                if (*ret).nodesetval.is_null()
                    || (*(*ret).nodesetval).nodeNr == 0 as ::core::ffi::c_int
                {
                    failed = 1 as ::core::ffi::c_int;
                }
            }
            2 => {
                failed = ((*ret).boolval == 0) as ::core::ffi::c_int;
            }
            3 => {
            ...
            4 => {
                if (*ret).stringval.is_null()
                    || *(*ret).stringval.offset(0 as ::core::ffi::c_int as isize)
                        as ::core::ffi::c_int
                        == 0 as ::core::ffi::c_int
                {
                    failed = 1 as ::core::ffi::c_int;
    ...
    return (failed == 0) as ::core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn xmlSchematronValidateDoc(
    ...
    let mut root: xmlNodePtr = ::core::ptr::null_mut::<xmlNode>();
    let mut pattern: xmlSchematronPatternPtr = ::core::ptr::null_mut::<xmlSchematronPattern>();
    let mut rule: xmlSchematronRulePtr = ::core::ptr::null_mut::<xmlSchematronRule>();
    let mut test: xmlSchematronTestPtr = ::core::ptr::null_mut::<xmlSchematronTest>();
    if ctxt.is_null()
        || (*ctxt).schema.is_null()
        ...
        || (*ctxt).flags == 0 as ::core::ffi::c_int
    {
        ...
        while !cur.is_null() {
            ...
            while !rule.is_null() {
                if xmlPatternMatch((*rule).pattern, cur) == 1 as ::core::ffi::c_int {
                    test = (*rule).tests;
                    while !test.is_null() {
